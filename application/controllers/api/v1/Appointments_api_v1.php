    ...
    public function index(): void
    {
        try {
            ...
            if (!empty($date)) {
                ...
                $where['DATE(start_datetime)'] = $date_obj->format('Y-m-d');
            }
            ...
            if (!empty($from)) {
                ...
                $where['DATE(start_datetime) >='] = $from_obj->format('Y-m-d');
            }
            ...
            if (!empty($till)) {
                $till_obj = new DateTime($till);
                $where['DATE(end_datetime) <='] = $till_obj->format('Y-m-d');
            }
