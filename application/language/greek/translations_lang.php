...
$lang['about_app'] = 'Σχετικά με το Car2dude';
...
$lang['about_app_info'] = 'Το Car2dude είναι μια εξαιρετικά προσαρμόσιμη διαδικτυακή εφαρμογή η οποία επιτρέπει στους πελάτες σας να κλείνουν ραντεβού με εσάς μέσω του διαδικτύου. Επιπλέον παρέχει την δυνατότητα να συγχρονίσετε τα δεδομένα σας με το Google Calendar έτσι ώστε να μπορέσετε να τα χρησιμοποιήσετε με άλλες υπηρεσίες.';
$lang['current_version'] = 'Τρέχουσα Έκδοση';
$lang['support'] = 'Υποστήριξη';
$lang['about_app_support'] = 'Αν αντιμετωπίσετε προβλήματα κατά την χρήση του Car2dude μπορείτε να ψάξετε το επίσημο Google Group για απαντήσεις. Μπορείτε επίσης να δημιουργήσετε ένα νέο θέμα στην σελίδα Google Code έτσι ώστε να βοηθήσετε την πρόοδο της ανάπτυξης.';
...
$lang['about_app_license'] = 'Το Car2dude έχει αδειοδοτηθεί υπό την άδεια χρήσης GPLv3. Χρησιμοποιώντας τον κώδικα του Easy!Appointents με οποιονδήποτε τρόπο συμφωνείτε με τους όρους που περιγράφονται στον ακόλουθο σύνδεσμο:';
...
$lang['ea_update_success'] = 'Το Car2dude ενημερώθηκε με επιτυχία.';
...
$lang['api_token_hint'] = 'Καταχωρήστε εναν μυστικό κωδικό για να μπορέσετε να ενεργοποιήσετε την token-based πιστοποίηση του Car2dude API.';
