...
$lang['απαιτείται_captcha_hint'] = 'Όταν ενεργοποιηθεί, οι πελάτες θα πρέπει να αντιμετωπίσουν μια πρόκληση CAPTCHA πριν κάνουν κράτηση / ενημέρωση ενός ραντεβού για να αποδείξουν ότι δεν είναι ρομπότ.';
$lang['none'] = 'Κανένα';
$lang['recaptcha_server_token'] = 'κουπόνι διακομιστή reCAPTCHA';
$lang['recaptcha_client_token'] = 'reCAPTCHA Κουπόνι πελάτη';
$lang['recaptcha_hint'] = 'Μεταβείτε στον ιστότοπο διαχειριστή google recaptcha για να ρυθμίσετε έναν τομέα reCAPTCHA v2 και λάβετε τα διακριτικά διακομιστή και πελάτη.';
$lang['recaptcha_warning'] = 'Είστε υπεύθυνοι για την κατάλληλη ενημέρωση της πολιτικής απορρήτου σας για συμμόρφωση με τους τοπικούς νόμους κατά τη χρήση του reCAPTCHA!';
