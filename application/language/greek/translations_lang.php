...
$lang['cancel_appointment_hint'] = 'Πιέστε το κουμπί "Ακύρωση Ραντεβού" για να διαγράψετε το ραντεβού από το πλάνο της εταιρείας.';
$lang['cancel'] = 'Άκυρο';
...
$lang['enter_password_here'] = 'Εισάγετε τον κωδικό εδώ ...';
$lang['login'] = 'Σύνδεση';
...
$lang['unexpected_issues_message'] = 'Η λειτουργία δεν ολοκληρώθηκε.';
$lang['close'] = 'Κλείσιμο';
...
$lang['enter_captcha_here'] = 'Εισάγετε CAPTCHA εδώ...';
...
$lang['fixed'] = 'Σταθερός';
$lang['attendants_number'] = 'Αριθμός Παραστατών (Ταυτόχρονες κρατήσεις)';
...
$lang['customer_is_already_booked'] = 'Αυτός ο πελάτης έχει ήδη ραντεβού κατά τη ζητούμενη περίοδο κράτησης.';
$lang['fields'] = 'Πεδία';
$lang['invalid_credentials_provided'] = 'Μη έγκυρα διαπιστευτήρια, παρακαλώ δοκιμάστε ξανά.';
$lang['calendar_url'] = 'URL ημερολογίου';
$lang['please_select'] = 'Παρακαλώ Επιλέξτε';
$lang['secret_header'] = 'Μυστική κεφαλίδα';
$lang['search'] = 'Αναζήτηση';
$lang['slot_interval'] = 'Διάστημα χρονοθυρίδας (λεπτά)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Ενεργοποιήστε την αυτόματη δημιουργία συνδέσμων συνάντησης Jitsi για τα ραντεβού. Όταν είναι ενεργοποιημένο, θα δημιουργείται ένας μοναδικός σύνδεσμος βιντεοκλήσης Jitsi και θα αποθηκεύεται ως σύνδεσμος συνάντησης.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'Το ALTCHA είναι μια εναλλακτική λύση CAPTCHA εστιασμένη στην ιδιωτικότητα, ανοιχτού κώδικα, που χρησιμοποιεί απόδειξη εργασίας για την επαλήθευση ανθρώπινων χρηστών χωρίς παρακολούθηση.';
$lang['altcha_enabled_hint'] = 'Όταν είναι ενεργοποιημένο, το ALTCHA θα χρησιμοποιείται αντί του παραδοσιακού CAPTCHA εικόνας για την επαλήθευση φορμών.';
$lang['altcha_hmac_key'] = 'Κλειδί HMAC';
$lang['altcha_hmac_key_hint'] = 'Ένα μυστικό κλειδί για την υπογραφή και επαλήθευση προκλήσεων ALTCHA. Κάντε κλικ στο Δημιουργία για να δημιουργήσετε ένα νέο ασφαλές κλειδί.';
$lang['altcha_max_number'] = 'Μέγιστος αριθμός';
$lang['altcha_max_number_hint'] = 'Ο μέγιστος αριθμός για την πρόκληση απόδειξης εργασίας. Υψηλότερες τιμές αυξάνουν τη δυσκολία (προεπιλογή: 100000).';
$lang['altcha_expires'] = 'Λήξη (δευτερόλεπτα)';
...
$lang['google_calendar_info'] = 'Ενεργοποιήστε τον συγχρονισμό Google Calendar για να συγχρονίσετε τα ραντεβού με τους λογαριασμούς Google Calendar των παρόχων.';
$lang['google_client_id'] = 'Αναγνωριστικό πελάτη';
$lang['google_client_id_info'] = 'Το Αναγνωριστικό πελάτη από το έργο σας στο Google Cloud Console.';
$lang['google_client_secret'] = 'Μυστικό πελάτη';
$lang['google_client_secret_info'] = 'Το Μυστικό πελάτη από το έργο σας στο Google Cloud Console.';
$lang['google_calendar_setup_info'] = 'Για να ενεργοποιήσετε τον συγχρονισμό Google Calendar, πρέπει να δημιουργήσετε ένα έργο στο Google Cloud Console, να ενεργοποιήσετε το Google Calendar API και να δημιουργήσετε διαπιστευτήρια OAuth 2.0. Επισκεφθείτε:';
$lang['google_meet_link_generation'] = 'Δημιουργία συνδέσμων Google Meet';
$lang['google_meet_link_generation_info'] = 'Αυτόματη δημιουργία συνδέσμου βιντεοδιάσκεψης Google Meet για συγχρονισμένα ραντεβού. Ο σύνδεσμος συνάντησης θα αποθηκευτεί στο πεδίο συνδέσμου συνάντησης του ραντεβού.';
$lang['display_add_to_google_calendar'] = 'Εμφάνιση κουμπιού "Προσθήκη στο Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Εμφανίστε το κουμπί "Προσθήκη στο Google Calendar" στη σελίδα επιβεβαίωσης κράτησης, επιτρέποντας στους πελάτες να προσθέσουν εύκολα το ραντεβού τους στο προσωπικό τους Google Calendar.';
$lang['select_all'] = 'Επιλογή όλων';
$lang['select_none'] = 'Αποεπιλογή όλων';
$lang['appointment_update'] = 'Ενημέρωση ραντεβού';
$lang['notify_users_on_update_question'] = 'Θέλετε να στείλετε μια ειδοποίηση για αυτή την αλλαγή;';
$lang['yes'] = 'Ναι';
$lang['no'] = 'Όχι';
$lang['latest_blog_posts'] = 'Τελευταίες αναρτήσεις ιστολογίου';
$lang['loading'] = 'Φόρτωση';
$lang['blog_posts_load_error'] = 'Δεν είναι δυνατή η φόρτωση των αναρτήσεων του ιστολογίου. Επισκεφθείτε την επίσημη ιστοσελίδα για ενημερώσεις.';
...
$lang['would_you_like_to_proceed'] = 'Θέλετε να συνεχίσετε παρόλα αυτά;';
$lang['proceed'] = 'Συνέχεια';
$lang['no_available_service_providers'] = 'Δεν υπάρχουν διαθέσιμες υπηρεσίες';
$lang['no_available_service_providers_message'] = 'Δεν υπάρχουν διαθέσιμες υπηρεσίες ή πάροχοι για κράτηση αυτή τη στιγμή. Ελέγξτε αργότερα ή επικοινωνήστε μαζί μας για βοήθεια.';
$lang['reset_password'] = 'Επαναφορά κωδικού';
$lang['new_password'] = 'Νέος κωδικός';
$lang['enter_new_password'] = 'Εισάγετε τον νέο σας κωδικό παρακάτω.';
$lang['password_reset_request'] = 'Αίτημα επαναφοράς κωδικού';
$lang['password_reset_email_message'] = 'Ζητήσατε να επαναφέρετε τον κωδικό πρόσβασής σας. Κάντε κλικ στο παρακάτω κουμπί για να ορίσετε νέο κωδικό για τον λογαριασμό σας.';
$lang['password_reset_link_expires'] = 'Αυτός ο σύνδεσμος θα λήξει σε 1 ώρα.';
$lang['password_reset_ignore_message'] = 'Αν δεν ζητήσατε επαναφορά κωδικού, παρακαλώ αγνοήστε αυτό το email.';
$lang['invalid_reset_token'] = 'Ο σύνδεσμος επαναφοράς κωδικού πρόσβασης είναι άκυρος.';
$lang['invalid_or_expired_token'] = 'Ο σύνδεσμος επαναφοράς κωδικού πρόσβασης είναι άκυρος ή έχει λήξει. Παρακαλώ ζητήστε νέο.';
$lang['password_reset_success'] = 'Ο κωδικός πρόσβασής σας επαναφέρθηκε με επιτυχία. Θα ανακατευθυνθείτε στη σελίδα σύνδεσης.';
$lang['password_reset_failed'] = 'Η επαναφορά κωδικού πρόσβασης απέτυχε. Παρακαλώ δοκιμάστε ξανά.';
$lang['no_password_provided'] = 'Παρακαλώ εισάγετε έναν κωδικό πρόσβασης.';
$lang['type_username_and_email_for_reset_link'] = 'Πληκτρολογήστε το όνομα χρήστη και τη διεύθυνση email σας για να λάβετε σύνδεσμο επαναφοράς κωδικού.';
$lang['send_reset_link'] = 'Αποστολή συνδέσμου επαναφοράς';
...
$lang['working_plan_validation_failed'] = 'Βρέθηκε μη έγκυρη διαμόρφωση προγράμματος εργασίας.';
$lang['start_date'] = 'Ημερομηνία έναρξης';
$lang['end_date'] = 'Ημερομηνία λήξης';
$lang['remember_me'] = 'Απομνημόνευση στοιχείων μου';
$lang['remember_me_hint'] = 'Αποθηκεύστε τα στοιχεία σας για ταχύτερη κράτηση την επόμενη φορά.';
$lang['legal_notice'] = 'Νομική ειδοποίηση';
$lang['legal_notice_url'] = 'URL νομικής ειδοποίησης';
$lang['legal_notice_url_hint'] = 'Εισάγετε το URL της σελίδας νομικής ειδοποίησης.';
$lang['imprint'] = 'Αποτύπωμα';
$lang['imprint_url'] = 'URL αποτυπώματος';
$lang['imprint_url_hint'] = 'Εισάγετε το URL της σελίδας αποτυπώματος.';
$lang['data_retention'] = 'Διατήρηση δεδομένων';
$lang['data_retention_days'] = 'Ημέρες διατήρησης δεδομένων';
$lang['data_retention_days_hint'] = 'Ορίστε τον αριθμό ημερών μετά τις οποίες τα δεδομένα πελατών θα διαγράφονται αυτόματα. Ορίστε 0 για απενεργοποίηση της αυτόματης διαγραφής.';
$lang['manage_privacy'] = 'Διαχείριση απορρήτου';
$lang['manage_privacy_hint'] = 'Κάντε κλικ στον παρακάτω σύνδεσμο για να δείτε, ενημερώσετε ή διαγράψετε τα προσωπικά σας στοιχεία.';
$lang['personal_information_updated'] = 'Τα προσωπικά σας στοιχεία ενημερώθηκαν επιτυχώς.';
$lang['verify'] = 'Επαλήθευση';
$lang['verifying'] = 'Γίνεται επαλήθευση';
$lang['verified'] = 'Επαληθεύτηκε';
$lang['verification_complete'] = 'Η επαλήθευση ολοκληρώθηκε';
$lang['verification_failed'] = 'Η επαλήθευση απέτυχε. Κάντε κλικ για επανάληψη.';
$lang['click_to_verify'] = 'Κάντε κλικ για να επαληθεύσετε ότι είστε άνθρωπος';
$lang['altcha_verification_failed'] = 'Η επαλήθευση ALTCHA απέτυχε. Παρακαλώ δοκιμάστε ξανά.';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = 'Προσφέρουμε ολοκληρωμένες υπηρεσίες για αυτο-φιλοξενούμενο λογισμικό, συμπεριλαμβανομένης προσαρμοσμένης ανάπτυξης, διαχειριζόμενης φιλοξενίας, συμβάσεων υποστήριξης, αλλαγής επωνυμίας και συνεχών βελτιώσεων — ώστε να μπορείτε να εστιάσετε στην επιχείρησή σας ενώ εμείς φροντίζουμε τα υπόλοιπα.';
...
$lang['caldav'] = 'CalDAV';
$lang['caldav_info'] = 'Συγχρονίστε τα ραντεβού των παρόχων σας με έναν διακομιστή ημερολογίου CalDAV και ελέγξτε σε ποιους κεντρικούς υπολογιστές επιτρέπεται να συνδεθεί ο συγχρονισμός.';
$lang['caldav_allowed_hosts'] = 'Επιτρεπόμενες διευθύνσεις σύνδεσης';
$lang['caldav_allowed_hosts_info'] = 'Οι διευθύνσεις CalDAV που δείχνουν σε ιδιωτική ή δεσμευμένη διεύθυνση δικτύου απορρίπτονται, ώστε μια διεύθυνση που καταχωρείται στη διαχείριση να μην μπορεί να φτάσει στο εσωτερικό δίκτυο αυτής της εγκατάστασης. Προσθέστε μία διεύθυνση σύνδεσης ή ένα όνομα κεντρικού υπολογιστή ανά γραμμή για να την επιτρέψετε παρόλα αυτά. Προσθέστε μόνο διακομιστές που διαχειρίζεστε εσείς.';
$lang['caldav_sync_failed'] = 'Ο συγχρονισμός CalDAV απέτυχε';
$lang['caldav_sync_failed_url'] = 'Δεν ήταν δυνατή η χρήση της αποθηκευμένης διεύθυνσης σύνδεσης. Αν ο διακομιστής CalDAV βρίσκεται στο τοπικό σας δίκτυο, προσθέστε τη διεύθυνσή του στις Ρυθμίσεις, Ενσωματώσεις, CalDAV. Διαφορετικά απενεργοποιήστε τον συγχρονισμό και συνδεθείτε ξανά με σωστή διεύθυνση.';
$lang['caldav_sync_failed_credentials'] = 'Ο διακομιστής CalDAV απέρριψε το όνομα χρήστη και τον κωδικό πρόσβασης. Απενεργοποιήστε τον συγχρονισμό και συνδεθείτε ξανά με τα σωστά στοιχεία.';
$lang['caldav_sync_failed_unreachable'] = 'Δεν ήταν δυνατή η επικοινωνία με τον διακομιστή CalDAV. Βεβαιωθείτε ότι λειτουργεί και ότι η διεύθυνση σύνδεσης είναι σωστή.';
$lang['caldav_private_host_warning'] = 'Αυτός ο διακομιστής βρίσκεται σε ιδιωτικό δίκτυο. Με τη σύνδεση θα προστεθεί στις επιτρεπόμενες διευθύνσεις σύνδεσης.';
$lang['caldav_allow_host_and_connect'] = 'Να επιτραπεί και σύνδεση';
// End
