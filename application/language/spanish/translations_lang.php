...
$lang['about_app'] = 'Acerca de Car2dude';
...
$lang['about_app_info'] = 'Car2dude es un aplicativo web completamente personalizable que le permitirá a sus clientes agendar citas con Usted a través internet. Además, le permitirá sincronizar sus datos con Google Calendar, para poder utilizarlos con otros servicios.';
$lang['current_version'] = 'Versión actual';
$lang['support'] = 'Soporte';
$lang['about_app_support'] = 'El grupo oficial de respuestas de Google Groups se encuentra a su disposición, en caso de que encuentre algún inconveniente con Car2dude.  También podrá informar incidentes en la página de Google Code y así ayudar en el proceso de desarrollo de la herramienta.';
...
$lang['about_app_license'] = 'Car2dude se encuentra bajo licencia GPLv3. Todo tipo de uso del código de Car2dude presume la aceptación de los términos desciptos en la siguiente dirección web:';
...
$lang['ea_update_success'] = 'Car2dude ha sido actualizado exitosamente';
...
$lang['api_token_hint'] = 'Defina un token secreto para habilitar la autentificación por token mediante la API de Car2dude.';
