...
$lang['cancel_appointment_hint'] = 'Presione el botón "Cancelar cita" para eliminar la cita de la agenda de la empresa.';
...
$lang['trigger_sync_hint'] = 'Iniciar el proceso de sincronización del calendario.';
...
$lang['invalid_duration'] = 'Duración inválida.';
...
$lang['enter_password_here'] = 'Introduzca la contraseña aquí ...';
...
$lang['unexpected_issues_message'] = 'La operación no pudo completarse.';
$lang['close'] = 'Cerrar';
...
$lang['enter_captcha_here'] = 'Introduzca el CAPTCHA aquí...';
...
$lang['time_format_hint'] = 'Cambiar el formato de visualización de la hora (H - Horas, M - Minutos).';
...
$lang['matomo_analytics_info'] = 'Matomo Analytics le permite agregar automáticamente el código de seguimiento y el marcado HTML a la página pública y rastrear todas las sesiones de reservas públicas.';
$lang['api'] = 'API';
...
$lang['search'] = 'Buscar';
$lang['slot_interval'] = 'Intervalo de franja (Minutos)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Habilitar la generación automática de enlaces de reunión Jitsi para las citas. Cuando está habilitado, se generará un enlace único de videollamada Jitsi y se almacenará como enlace de reunión.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA es una alternativa CAPTCHA de código abierto centrada en la privacidad que utiliza prueba de trabajo para verificar usuarios humanos sin rastreo.';
$lang['altcha_enabled_hint'] = 'Cuando está habilitado, ALTCHA se utilizará en lugar del CAPTCHA de imagen tradicional para la verificación de formularios.';
$lang['altcha_hmac_key'] = 'Clave HMAC';
$lang['altcha_hmac_key_hint'] = 'Una clave secreta utilizada para firmar y verificar los desafíos ALTCHA. Haga clic en Generar para crear una nueva clave segura.';
$lang['altcha_max_number'] = 'Número máximo';
$lang['altcha_max_number_hint'] = 'El número máximo para el desafío de prueba de trabajo. Valores más altos aumentan la dificultad (por defecto: 100000).';
$lang['altcha_expires'] = 'Expiración (Segundos)';
$lang['altcha_expires_hint'] = 'Tiempo de validez de un desafío en segundos (por defecto: 300).';
$lang['altcha_key_generated'] = 'Nueva clave HMAC generada exitosamente.';
$lang['altcha_enabled'] = 'Habilitar ALTCHA';
$lang['altcha_captcha_not_active_warning'] = 'La configuración CAPTCHA no está activa actualmente. ALTCHA no se utilizará a menos que CAPTCHA esté habilitado en la';
$lang['generate'] = 'Generar';
$lang['meeting_link'] = 'Enlace de reunión';
$lang['google_calendar'] = 'Google Calendar';
$lang['google_calendar_info'] = 'Habilitar la sincronización con Google Calendar para sincronizar las citas con las cuentas de Google Calendar de los proveedores.';
$lang['google_client_id'] = 'ID de cliente';
$lang['google_client_id_info'] = 'El ID de cliente de su proyecto en Google Cloud Console.';
$lang['google_client_secret'] = 'Secreto de cliente';
$lang['google_client_secret_info'] = 'El secreto de cliente de su proyecto en Google Cloud Console.';
$lang['google_calendar_setup_info'] = 'Para habilitar la sincronización con Google Calendar, necesita crear un proyecto en Google Cloud Console, habilitar la API de Google Calendar y crear credenciales OAuth 2.0. Visite:';
$lang['google_meet_link_generation'] = 'Generar enlaces de Google Meet';
$lang['google_meet_link_generation_info'] = 'Crear automáticamente un enlace de videoconferencia Google Meet para las citas sincronizadas. El enlace de reunión se almacenará en el campo de enlace de reunión de la cita.';
$lang['display_add_to_google_calendar'] = 'Mostrar el botón "Agregar a Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Mostrar el botón "Agregar a Google Calendar" en la página de confirmación de reserva, permitiendo a los clientes agregar fácilmente su cita a su Google Calendar personal.';
$lang['select_all'] = 'Seleccionar todo';
$lang['select_none'] = 'Deseleccionar todo';
$lang['appointment_update'] = 'Actualización de cita';
$lang['notify_users_on_update_question'] = '¿Desea enviar una notificación sobre este cambio?';
$lang['yes'] = 'Sí';
$lang['no'] = 'No';
$lang['latest_blog_posts'] = 'Últimas entradas del blog';
$lang['loading'] = 'Cargando';
$lang['blog_posts_load_error'] = 'No se pueden cargar las entradas del blog. Visite el sitio web oficial para actualizaciones.';
...
$lang['would_you_like_to_proceed'] = '¿Desea continuar de todos modos?';
$lang['proceed'] = 'Continuar';
$lang['no_available_service_providers'] = 'No hay servicios disponibles';
$lang['no_available_service_providers_message'] = 'Actualmente no hay servicios ni proveedores disponibles para reservar. Por favor, vuelva más tarde o contáctenos para obtener ayuda.';
$lang['reset_password'] = 'Restablecer contraseña';
$lang['new_password'] = 'Nueva contraseña';
$lang['enter_new_password'] = 'Introduzca su nueva contraseña a continuación.';
$lang['password_reset_request'] = 'Solicitud de restablecimiento de contraseña';
$lang['password_reset_email_message'] = 'Ha solicitado restablecer su contraseña. Haga clic en el botón de abajo para establecer una nueva contraseña para su cuenta.';
$lang['password_reset_link_expires'] = 'Este enlace caducará en 1 hora.';
$lang['password_reset_ignore_message'] = 'Si no ha solicitado restablecer la contraseña, ignore este correo electrónico.';
$lang['invalid_reset_token'] = 'El enlace de restablecimiento de contraseña no es válido.';
$lang['invalid_or_expired_token'] = 'El enlace de restablecimiento de contraseña no es válido o ha caducado. Por favor, solicite uno nuevo.';
$lang['password_reset_success'] = 'Su contraseña ha sido restablecida correctamente. Será redirigido a la página de inicio de sesión.';
$lang['password_reset_failed'] = 'Error al restablecer la contraseña. Por favor, inténtelo de nuevo.';
$lang['no_password_provided'] = 'Por favor, introduzca una contraseña.';
$lang['type_username_and_email_for_reset_link'] = 'Escriba su nombre de usuario y dirección de correo electrónico para recibir un enlace de restablecimiento de contraseña.';
$lang['send_reset_link'] = 'Enviar enlace de restablecimiento';
$lang['reset_link_sent_with_email'] = 'Si existe una cuenta con las credenciales proporcionadas, se ha enviado un enlace de restablecimiento de contraseña a su correo electrónico.';
$lang['working_plan_validation_failed'] = 'Se encontró una configuración de plan de trabajo inválida.';
$lang['start_date'] = 'Fecha de inicio';
$lang['end_date'] = 'Fecha de fin';
$lang['remember_me'] = 'Recordar mi información';
$lang['remember_me_hint'] = 'Guarde sus datos para una reserva más rápida la próxima vez.';
$lang['legal_notice'] = 'Aviso legal';
$lang['legal_notice_url'] = 'URL del aviso legal';
$lang['legal_notice_url_hint'] = 'Introduzca la URL de su página de aviso legal.';
$lang['imprint'] = 'Pie de imprenta';
$lang['imprint_url'] = 'URL del pie de imprenta';
$lang['imprint_url_hint'] = 'Introduzca la URL de su página de pie de imprenta.';
$lang['data_retention'] = 'Retención de datos';
$lang['data_retention_days'] = 'Días de retención de datos';
$lang['data_retention_days_hint'] = 'Establezca el número de días tras los cuales los datos de los clientes se eliminarán automáticamente. Establezca 0 para desactivar la eliminación automática.';
$lang['manage_privacy'] = 'Gestionar privacidad';
$lang['manage_privacy_hint'] = 'Haga clic en el enlace a continuación para ver, actualizar o eliminar su información personal.';
$lang['personal_information_updated'] = 'Su información personal ha sido actualizada exitosamente.';
$lang['verify'] = 'Verificar';
$lang['verifying'] = 'Verificando';
$lang['verified'] = 'Verificado';
$lang['verification_complete'] = 'Verificación completada';
$lang['verification_failed'] = 'La verificación falló. Haga clic para reintentar.';
$lang['click_to_verify'] = 'Haga clic para verificar que es humano';
$lang['altcha_verification_failed'] = 'La verificación ALTCHA falló. Por favor, inténtelo de nuevo.';
...
$lang['invalid_price'] = 'Precio inválido.';
$lang['invalid_slot_interval'] = 'Intervalo de franja inválido.';
$lang['invalid_attendants_number'] = 'Número de asistentes inválido.';
$lang['scheduling_conflict'] = 'Conflicto de programación';
$lang['invalid_time'] = 'Hora inválida.';
$lang['service_and_provider_missing'] = 'Por favor, seleccione un servicio y un proveedor antes de continuar.';
$lang['caldav'] = 'CalDAV';
$lang['caldav_info'] = 'Sincronice las citas de sus proveedores con un servidor de calendario CalDAV y controle a qué hosts se puede conectar la sincronización.';
$lang['caldav_allowed_hosts'] = 'URL de conexión permitidas';
$lang['caldav_allowed_hosts_info'] = 'Las URL de CalDAV que apuntan a una dirección de red privada o reservada se rechazan, para que una URL introducida en el panel de administración no pueda alcanzar la red interna de esta instalación. Añada una URL de conexión o un nombre de host por línea para permitirla de todos modos. Añada únicamente servidores que usted mismo gestione.';
$lang['caldav_sync_failed'] = 'Error en la sincronización con CalDAV';
$lang['caldav_sync_failed_url'] = 'No se pudo utilizar la URL de conexión guardada. Si su servidor CalDAV se ejecuta en su red local, añada su URL en Ajustes, Integraciones, CalDAV. De lo contrario, desactive la sincronización y vuelva a conectarse con una URL correcta.';
$lang['caldav_sync_failed_credentials'] = 'El servidor CalDAV rechazó el nombre de usuario y la contraseña. Desactive la sincronización y vuelva a conectarse con las credenciales correctas.';
$lang['caldav_sync_failed_unreachable'] = 'No se pudo contactar con el servidor CalDAV. Asegúrese de que está en funcionamiento y de que la URL de conexión es correcta.';
$lang['caldav_private_host_warning'] = 'Este servidor está en una red privada. Al conectar se añadirá su host a las URL de conexión permitidas.';
$lang['caldav_allow_host_and_connect'] = 'Permitir y conectar';
// End
