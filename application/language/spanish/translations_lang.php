...
$lang['no_available_hours'] =
    'No hay horarios disponibles para una cita en la fecha seleccionada. Por favor, elija otra fecha.';
...
$lang['thank_you_for_appointment'] =
    'Gracias por utilizar nuestro servicio para agendar su cita.  Debajo encontrará los detalles de su cita. Haga clic en la cita para realizar cambios.';
...
$lang['appointment_does_not_exist_in_db'] =
    'La cita que usted busca ya no se encuentra en la base de datos del sistema.';
...
$lang['manage_appointment_record_hint'] =
    'Gestionar todos las citas agendadas de los proveedores y servicios disponibles.';
...
$lang['enable_appointment_sync_hint'] =
    'Habilitar la sincronización de la cita con la cuenta de Google Calendar del proveedor.';
...
$lang['unavailability_periods_hint'] =
    'El proveedor no podrá aceptar nuevas citas cuando se encuentre como No disponible.';
...
$lang['add_breaks_during_each_day'] =
    'Agregar periodos de descanso para cada día. Durante los periodos de descanso los proveedores no podrán aceptar ninguna cita.';
$lang['day'] = 'Día';
$lang['days'] = 'Días';
...
$lang['company_email_hint'] =
    'Esta será la dirección de E-mail de la empresa. Será utilizada como la dirección para enviar E-mails del sistema y recibir respuestas (obligatorio).';
...
$lang['edit_breaks_hint'] =
    'Agrgar los periodos de descanso de trabajo en cada día. Se aplicarán estos periodos de descanso para todos los nuevos proveedores.';
$lang['book_advance_timeout'] = 'Agendar tiempos muertos';
$lang['book_advance_timeout_hint'] =
    'Defina el tiempo muerto (en minutos) antes que de los clientes puedan agendar o reorganizar citas con la empresa.';
$lang['timeout_minutes'] = 'Tiempo muerto (en minutos)';
$lang['about_app_info'] =
    'Easy!Appointments es un aplicativo web completamente personalizable que le permitirá a sus clientes agendar citas con Usted a través internet. Además, le permitirá sincronizar sus datos con Google Calendar, para poder utilizarlos con otros servicios.';
$lang['current_version'] = 'Versión actual';
$lang['support'] = 'Soporte';
$lang['about_app_support'] =
    'El grupo oficial de respuestas de Google Groups se encuentra a su disposición, en caso de que encuentre algún inconveniente con Easy!Appointments.  También podrá informar incidentes en la página de Google Code y así ayudar en el proceso de desarrollo de la herramienta.';
...
$lang['about_app_license'] =
    'Easy!Appointments se encuentra bajo licencia GPLv3. Todo tipo de uso del código de Easy!Appointments presume la aceptación de los términos desciptos en la siguiente dirección web:';
$lang['logout_success'] =
    'Usted ha cerrado su sesión exitosamente. Haga clic en uno de los siguientes botones para navegar hacia otra página.';
...
$lang['login_failed'] =
    'El inicio de sesión falló. Por favor, ingrese las credenciales correctas e inténtelo nuevamente.';
$lang['type_username_and_email_for_new_password'] =
    'Ingrese su nombre de usuario y su dirección de E-mail para obtener una nueva contraseña.';
...
$lang['new_password_is'] =
    'Su nueva contraseña para iniciar sesión es $password. Por favor, guarde este correo electrónico en caso de que necesite recuperar su contraseña nuevamente. También puede reemplazar esta contraseña por una de su preferncia en la página de Configuración';
...
$lang['page_not_found_message'] =
    'Lamentablemente, la página que Usted solicitó no existe. Por favor, verifique la dirección web de su navegador o utilice los botones de abajo para navegar hacia otra ubicación.';
$lang['error'] = 'Error';
$lang['no_privileges'] = 'Sin permisos';
$lang['no_privileges_message'] =
    'Usted no posee los permisos necesarios para ver esta página. Por favor, navegue hacia otra sección.';
...
$lang['service_communication_error'] =
    'Ha ocurrido un error de comunicación con el servidor, por favor, inténtelo nuevamente.';
...
$lang['user_settings_are_invalid'] =
    'La configuración de usuario es inválida. Por favor, verifique la configuración e inténtelo nuevamente.';
...
$lang['select_google_calendar_prompt'] =
    'Seleccione el calendario con el que desea sincronizar sus citas. Si no desea seleccionar un calendario en particular, se utilizará el calendario por defecto.';
...
$lang['require_captcha_hint'] =
    'Cuando se habilita, el cliente tendrá que escribir el código CAPTCHA antes de reservar/actualizar una cita.';
...
$lang['requested_hour_is_unavailable'] =
    'La cita requerida desafortunadamente no está disponible. Por favor seleccione una hora diferente para su cita.';
$lang['customer_notifications'] = 'Notificaciones de Clientes';
$lang['customer_notifications_hint'] =
    'Define si su cliente recibirá notificaciones de correo cada vez que una agenda cambia o alguna de sus citas.';
...
$lang['website_using_cookies_to_ensure_best_experience'] =
    'Esta web utiliza cookies para asegurarte una mejor experiencia.';
$lang['read_and_agree_to_terms_and_conditions'] =
    'He leido y estoy de acuerdo con {$link}Terminos & Condiciones{/$link}.';
...
$lang['delete_personal_information_prompt'] =
    '¿Estás seguro que quieres borrar tu información personal? Esta acción no se puede deshacer.';
...
$lang['add_working_plan_exceptions_during_each_day'] =
    'Agregar excepciones al plan de trabajo, fuera del plan de trabajo.';
...
$lang['require_phone_number_hint'] =
    'Cuando está habilitado, clientes y usuarios deberán ingresar el número de teléfono del cliente al registrar una cita.';
$lang['check_spam_folder'] =
    'Por favor, verifique su carpeta de correo no deseado si el correo no llega dentro de unos minutos.';
$lang['api_token_hint'] =
    'Defina un token secreto para habilitar la autentificación por token mediante la API de Easy!Appointments.';
$lang['timezone'] = 'Zona horaria';
$lang['overwrite_existing_working_plans'] =
    'Esto sobreescribirá los planes de trabajo existentes del proveedor. ¿Seguro que desea continuar?';
...
$lang['display_any_provider_hint'] =
    'La página de reserva tendrá una opción adicional que permitirá que los clientes se anoten sin específicar un proveedor.';
