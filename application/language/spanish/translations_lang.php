...
$lang['matomo_analytics_site_id'] = 'ID del Sitio de Matomo Analytics';
$lang['matomo_analytics_site_id_hint'] = 'Establece el ID del sitio que será rastreado por Matomo (el sitio predeterminado tiene el ID "1").';
$lang['default_timezone'] = 'Zona horaria predeterminada';
$lang['default_timezone_hint'] = 'Establece el valor de la zona horaria predeterminada que se utilizará para los nuevos registros.';
$lang['default_language'] = 'Idioma predeterminado';
$lang['default_language_hint'] = 'Establece el valor del idioma predeterminado que se utilizará para los nuevos registros.';
$lang['sync_method_prompt'] = '¿Qué método de sincronización te gustaría usar?';
$lang['caldav_server'] = 'Servidor CalDAV';
$lang['caldav_connection_info_prompt'] = 'Por favor, introduce la información de conexión del Calendario CalDAV de destino.';
$lang['connect'] = 'Conectar';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Esta integración te permite conectarte a un servidor LDAP existente e importar automáticamente usuarios a Easy!Appointments y permitirles iniciar sesión con su contraseña de directorio (el nombre de usuario debe coincidir).';
$lang['host'] = 'Host';
$lang['port'] = 'Puerto';
$lang['user_dn'] = 'DN de Usuario';
$lang['base_dn'] = 'DN Base';
$lang['keyword'] = 'Palabra clave';
$lang['ldap_search_hint'] = 'Proporciona una palabra clave para buscar en el directorio LDAP usuarios que coincidan con los criterios de filtro.';
...
$lang['field_mapping'] = 'Asignación de campos';
$lang['content'] = 'Contenido';
$lang['active'] = 'Activo';
$lang['user_imported'] = 'El registro de usuario se importó correctamente.';
$lang['import'] = 'Importar';
$lang['ldap_dn'] = 'LDAP DN';
$lang['role'] = 'Rol';
$lang['at_least_one_field_required'] = 'Al menos un campo debe establecerse como requerido en la página de reserva.';
$lang['customer_is_already_booked'] = 'Este cliente ya tiene una cita durante el período de reserva solicitado.';
$lang['fields'] = 'Campos';
$lang['invalid_credentials_provided'] = 'Credenciales proporcionadas inválidas, por favor inténtelo de nuevo.';
