...
$lang['require_captcha_hint'] = 'Cuando esté habilitado, los clientes deberán resolver un CAPTCHA antes de reservar / actualizar una cita para demostrar que no son un robot.';
$lang['none'] = 'Ninguno';
$lang['recaptcha_server_token'] = 'token de servidor reCAPTCHA';
$lang['recaptcha_client_token'] = 'token de cliente reCAPTCHA';
$lang['recaptcha_hint'] = 'Vaya al sitio web de administración de google recaptcha para configurar un dominio reCAPTCHA v2 y obtener sus tokens de servidor y cliente.';
$lang['recaptcha_warning'] = '¡Usted es responsable de actualizar adecuadamente su política de privacidad para cumplir con las leyes locales al usar reCAPTCHA!';
