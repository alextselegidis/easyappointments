...
$lang['about_app'] = 'O aplikaci Car2dude';
...
$lang['about_app_info'] = 'Car2dude je vysoce přizpůsobitelná webová aplikace, která vašim zákazníkům umožňuje rezervovat si s vámi schůzky prostřednictvím webu. Navíc poskytuje možnost synchronizovat vaše data s Kalendářem Google, takže je můžete využívat v rámci dalších služeb.';
$lang['current_version'] = 'Aktuální verze';
$lang['support'] = 'Podpora';
$lang['about_app_support'] = 'Pokud při používání Car2dude narazíte na jakékoli problémy můžete odpovědi hledat v oficiální skupině Google. Také můžete založit nový incident na stránce Google Code za účelem podpory dalšího vývoje.';
...
$lang['about_app_license'] = 'Car2dude je licencováno pod licencí GPLv3. Používáním kódu Car2dude v jakékoli formě souhlasíte s podmínkami popsanými v dokumentu na následující adrese:';
...
$lang['ea_update_success'] = 'Aplikace Car2dude byla úspěšně aktualizována.';
...
$lang['api_token_hint'] = 'Nastavte bezpečnostní token, aby jste povolili autentizaci tokenem v  API Car2dude.';
