...
$lang['enter_password_here'] = 'Zadejte heslo zde ...';
...
$lang['unexpected_issues_message'] = 'Operaci se nepodařilo dokončit.';
$lang['close'] = 'Zavřít';
...
$lang['enter_captcha_here'] = 'Zadejte CAPTCHA zde...';
...
$lang['service_selection_layout'] = 'Rozložení výběru služby';
$lang['service_selection_layout_hint'] = 'Zvolte, jak se služby zobrazí v prvním kroku rezervace.';
$lang['dropdown'] = 'Rozbalovací nabídka';
$lang['accordion'] = 'Akordeon';
$lang['hide_single_provider_selection'] = 'Skrýt výběr jediného poskytovatele';
$lang['hide_single_provider_selection_hint'] = 'Skryje pole poskytovatele, když má vybraná služba pouze jednoho dostupného poskytovatele.';
$lang['load_more'] = 'Více';
$lang['list'] = 'Seznam';
...
$lang['search'] = 'Hledat';
$lang['slot_interval'] = 'Interval slotů (minuty)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Povolit automatické generování odkazů na schůzky Jitsi pro rezervace. Po povolení bude pro každou rezervaci vytvořen jedinečný odkaz na videohovor Jitsi.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA je alternativa CAPTCHA zaměřená na soukromí s otevřeným zdrojovým kódem, která používá proof-of-work k ověření uživatelů bez sledování.';
$lang['altcha_enabled_hint'] = 'Po povolení bude ALTCHA použita místo tradiční obrázkové CAPTCHA pro ověření formulářů.';
$lang['altcha_hmac_key'] = 'Klíč HMAC';
$lang['altcha_hmac_key_hint'] = 'Tajný klíč používaný k podepisování a ověřování výzev ALTCHA. Klikněte na Generovat pro vytvoření nového bezpečného klíče.';
$lang['altcha_max_number'] = 'Maximální číslo';
$lang['altcha_max_number_hint'] = 'Maximální číslo pro výzvu proof-of-work. Vyšší hodnoty zvyšují obtížnost (výchozí: 100000).';
$lang['altcha_expires'] = 'Platnost (sekundy)';
...
$lang['google_calendar_info'] = 'Povolit synchronizaci s Google Calendar pro synchronizaci rezervací s účty Google Calendar poskytovatelů.';
$lang['google_client_id'] = 'Client ID';
$lang['google_client_id_info'] = 'Client ID z vašeho projektu Google Cloud Console.';
$lang['google_client_secret'] = 'Client Secret';
$lang['google_client_secret_info'] = 'Client Secret z vašeho projektu Google Cloud Console.';
$lang['google_calendar_setup_info'] = 'Pro povolení synchronizace s Google Calendar musíte vytvořit projekt v Google Cloud Console, povolit Google Calendar API a vytvořit přihlašovací údaje OAuth 2.0. Navštivte:';
$lang['google_meet_link_generation'] = 'Generovat odkazy Google Meet';
$lang['google_meet_link_generation_info'] = 'Automaticky vytvořit odkaz na videokonferenci Google Meet pro synchronizované rezervace. Odkaz na schůzku bude uložen v poli odkazu na schůzku rezervace.';
$lang['display_add_to_google_calendar'] = 'Zobrazit tlačítko "Přidat do Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Zobrazit tlačítko "Přidat do Google Calendar" na stránce potvrzení rezervace, které zákazníkům umožní snadno přidat rezervaci do svého osobního Google Calendar.';
$lang['select_all'] = 'Vybrat vše';
$lang['select_none'] = 'Zrušit výběr';
$lang['appointment_update'] = 'Aktualizace schůzky';
$lang['notify_users_on_update_question'] = 'Chcete odeslat upozornění o této změně?';
$lang['yes'] = 'Ano';
$lang['no'] = 'Ne';
$lang['latest_blog_posts'] = 'Nejnovější příspěvky na blogu';
$lang['loading'] = 'Načítání';
$lang['blog_posts_load_error'] = 'Nelze načíst příspěvky blogu. Navštivte prosím oficiální web pro aktualizace.';
$lang['provider_has_conflicting_appointment'] = 'Vybraný poskytovatel již má v daném čase jinou schůzku. Vyberte prosím jiný čas nebo poskytovatele.';
$lang['would_you_like_to_proceed'] = 'Chcete přesto pokračovat?';
$lang['proceed'] = 'Pokračovat';
$lang['no_available_service_providers'] = 'Žádné dostupné služby';
$lang['no_available_service_providers_message'] = 'Momentálně nejsou k dispozici žádné služby ani poskytovatelé pro rezervaci. Zkuste to prosím později nebo nás kontaktujte pro pomoc.';
$lang['reset_password'] = 'Obnovit heslo';
$lang['new_password'] = 'Nové heslo';
$lang['enter_new_password'] = 'Níže zadejte své nové heslo.';
$lang['enter_password_here'] = 'Zadejte heslo zde ...';
$lang['password_reset_request'] = 'Žádost o obnovení hesla';
...
$lang['password_reset_failed'] = 'Obnovení hesla se nezdařilo. Zkuste to prosím znovu.';
$lang['no_password_provided'] = 'Zadejte prosím heslo.';
$lang['type_username_and_email_for_reset_link'] = 'Zadejte své uživatelské jméno a e-mailovou adresu pro obdržení odkazu na obnovení hesla.';
$lang['send_reset_link'] = 'Odeslat odkaz pro obnovení';
$lang['reset_link_sent_with_email'] = 'Pokud existuje účet s poskytnutými údaji, byl na váš e-mail odeslán odkaz pro obnovení hesla.';
$lang['working_plan_validation_failed'] = 'Nalezena neplatná konfigurace pracovního plánu.';
$lang['start_date'] = 'Datum začátku';
$lang['end_date'] = 'Datum konce';
$lang['remember_me'] = 'Zapamatovat si mé údaje';
$lang['remember_me_hint'] = 'Uložit vaše údaje pro rychlejší rezervaci příště.';
$lang['legal_notice'] = 'Právní upozornění';
$lang['legal_notice_url'] = 'URL právního upozornění';
$lang['legal_notice_url_hint'] = 'Zadejte URL stránky s právním upozorněním.';
$lang['imprint'] = 'Impressum';
$lang['imprint_url'] = 'URL impressum';
$lang['imprint_url_hint'] = 'Zadejte URL stránky s impressum.';
$lang['data_retention'] = 'Uchovávání dat';
$lang['data_retention_days'] = 'Doba uchovávání dat (dny)';
$lang['data_retention_days_hint'] = 'Nastavte počet dnů, po kterých budou data zákazníků automaticky smazána. Nastavte 0 pro vypnutí automatického mazání.';
$lang['manage_privacy'] = 'Správa soukromí';
$lang['manage_privacy_hint'] = 'Klikněte na odkaz níže pro zobrazení, aktualizaci nebo smazání vašich osobních údajů.';
$lang['personal_information'] = 'Osobní údaje';
$lang['personal_information_updated'] = 'Vaše osobní údaje byly úspěšně aktualizovány.';
$lang['verify'] = 'Ověřit';
$lang['verifying'] = 'Ověřování';
$lang['verified'] = 'Ověřeno';
$lang['verification_complete'] = 'Ověření dokončeno';
$lang['verification_failed'] = 'Ověření se nezdařilo. Klikněte pro opakování.';
$lang['click_to_verify'] = 'Klikněte pro ověření, že jste člověk';
$lang['altcha_verification_failed'] = 'Ověření ALTCHA se nezdařilo. Zkuste to prosím znovu.';
