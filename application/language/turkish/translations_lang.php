...
$lang['appointment_locked_message'] = 'Randevu, başlangıcından {$limit} saatten kısa bir süre önce değiştirilemez.';
...
$lang['invalid_duration'] = 'Geçersiz süre.';
...
$lang['enter_password_here'] = 'Şifreyi buraya girin ...';
$lang['login'] = 'Giriş';
...
$lang['unexpected_issues_message'] = 'İşlem tamamlanamadı.';
$lang['close'] = 'Kapat';
$lang['page_not_found'] = 'Sayfa Bulunamadı';
$lang['page_not_found_message'] = 'Maalesef istediğiniz sayfa mevcut değil. Lütfen tarayıcı URL\'nizi kontrol edin veya aşağıdaki düğmeleri kullanarak başka bir konuma gidin.';
$lang['error'] = 'Hata';
...
$lang['enter_captcha_here'] = 'CAPTCHA kodunu buraya girin...';
...
$lang['google_analytics_code_hint'] = 'Rezervasyon sayfalarında Google Analytics izlemeyi etkinleştirmek için Google Analytics Kodunuzu ekleyin.';
...
$lang['working_plan_exceptions_hint'] = 'Çalışma planı dışında bir çalışma planı istisna günü ekleyin.';
...
$lang['add_working_plan_exceptions_during_each_day'] = 'Çalışma planı dışında çalışma planı istisnaları ekleyin.';
...
$lang['service_selection_layout'] = 'Hizmet Seçim Düzeni';
$lang['service_selection_layout_hint'] = 'Hizmetlerin ilk rezervasyon adımında nasıl görüntüleneceğini seçin.';
$lang['dropdown'] = 'Açılır Menü';
$lang['accordion'] = 'Akordeon';
$lang['hide_single_provider_selection'] = 'Tek Sağlayıcı Seçimini Gizle';
$lang['hide_single_provider_selection_hint'] = 'Seçilen hizmetin yalnızca bir sağlayıcısı varsa sağlayıcı alanını gizler.';
...
$lang['matomo_analytics_site_id'] = 'Matomo Analytics Site Kimliği';
...
$lang['secret_header'] = 'Gizli Başlık';
$lang['search'] = 'Ara';
$lang['slot_interval'] = 'Zaman Aralığı (Dakika)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Randevular için otomatik Jitsi toplantı bağlantısı oluşturmayı etkinleştirin. Etkinleştirildiğinde, benzersiz bir Jitsi görüntülü görüşme bağlantısı oluşturulacak ve toplantı bağlantısı olarak kaydedilecektir.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA, izleme yapmadan insan kullanıcıları doğrulamak için iş ispatı kullanan, gizlilik odaklı, açık kaynaklı bir CAPTCHA alternatifidir.';
$lang['altcha_enabled_hint'] = 'Etkinleştirildiğinde, form doğrulaması için geleneksel resim CAPTCHA yerine ALTCHA kullanılacaktır.';
$lang['altcha_hmac_key'] = 'HMAC Anahtarı';
$lang['altcha_hmac_key_hint'] = 'ALTCHA meydan okumalarını imzalamak ve doğrulamak için kullanılan gizli bir anahtar. Yeni güvenli bir anahtar oluşturmak için Oluştur\'a tıklayın.';
$lang['altcha_max_number'] = 'Maksimum Sayı';
$lang['altcha_max_number_hint'] = 'İş ispatı meydan okuması için maksimum sayı. Daha yüksek değerler zorluğu artırır (varsayılan: 100000).';
$lang['altcha_expires'] = 'Süre Dolumu (Saniye)';
...
$lang['google_calendar_info'] = 'Randevuları sağlayıcı Google Calendar hesaplarıyla senkronize etmek için Google Calendar senkronizasyonunu etkinleştirin.';
$lang['google_client_id'] = 'İstemci Kimliği';
$lang['google_client_id_info'] = 'Google Cloud Console projenizden alınan İstemci Kimliği.';
$lang['google_client_secret'] = 'İstemci Gizli Anahtarı';
$lang['google_client_secret_info'] = 'Google Cloud Console projenizden alınan İstemci Gizli Anahtarı.';
$lang['google_calendar_setup_info'] = 'Google Calendar senkronizasyonunu etkinleştirmek için Google Cloud Console\'da bir proje oluşturmanız, Google Calendar API\'sini etkinleştirmeniz ve OAuth 2.0 kimlik bilgileri oluşturmanız gerekir. Ziyaret edin:';
$lang['google_meet_link_generation'] = 'Google Meet Bağlantıları Oluştur';
$lang['google_meet_link_generation_info'] = 'Senkronize edilmiş randevular için otomatik olarak bir Google Meet görüntülü konferans bağlantısı oluşturun. Toplantı bağlantısı, randevunun toplantı bağlantısı alanında saklanacaktır.';
$lang['display_add_to_google_calendar'] = '"Google Calendar\'a Ekle" Düğmesini Göster';
$lang['display_add_to_google_calendar_info'] = 'Rezervasyon onay sayfasında "Google Calendar\'a Ekle" düğmesini göstererek müşterilerin randevularını kolayca kişisel Google Calendar\'larına eklemelerine olanak tanıyın.';
$lang['select_all'] = 'Tümünü Seç';
$lang['select_none'] = 'Hiçbirini Seçme';
$lang['appointment_update'] = 'Randevu Güncelleme';
$lang['notify_users_on_update_question'] = 'Bu değişiklik hakkında bir bildirim göndermek ister misiniz?';
$lang['yes'] = 'Evet';
$lang['no'] = 'Hayır';
$lang['latest_blog_posts'] = 'Son Blog Yazıları';
$lang['loading'] = 'Yükleniyor';
$lang['blog_posts_load_error'] = 'Blog yazıları yüklenemiyor. Güncellemeler için lütfen resmi web sitesini ziyaret edin.';
...
$lang['would_you_like_to_proceed'] = 'Yine de devam etmek ister misiniz?';
$lang['proceed'] = 'Devam Et';
$lang['no_available_service_providers'] = 'Kullanılabilir Hizmet Yok';
$lang['no_available_service_providers_message'] = 'Şu anda rezervasyon için mevcut hizmet veya sağlayıcı bulunmamaktadır. Lütfen daha sonra kontrol edin veya yardım için bizimle iletişime geçin.';
$lang['reset_password'] = 'Şifreyi Sıfırla';
$lang['new_password'] = 'Yeni Şifre';
$lang['enter_new_password'] = 'Yeni şifrenizi aşağıya girin.';
$lang['enter_password_here'] = 'Şifreyi buraya girin ...';
$lang['password_reset_request'] = 'Şifre Sıfırlama İsteği';
$lang['password_reset_email_message'] = 'Şifrenizi sıfırlamak istediniz. Hesabınız için yeni bir şifre belirlemek için aşağıdaki düğmeye tıklayın.';
$lang['password_reset_link_expires'] = 'Bu bağlantı 1 saat içinde sona erecek.';
$lang['password_reset_ignore_message'] = 'Şifre sıfırlama talebinde bulunmadıysanız, lütfen bu e-postayı dikkate almayın.';
$lang['invalid_reset_token'] = 'Şifre sıfırlama bağlantısı geçersiz.';
$lang['invalid_or_expired_token'] = 'Şifre sıfırlama bağlantısı geçersiz veya süresi dolmuş. Lütfen yeni bir tane isteyin.';
$lang['password_reset_success'] = 'Şifreniz başarıyla sıfırlandı. Giriş sayfasına yönlendirileceksiniz.';
$lang['password_reset_failed'] = 'Şifre sıfırlama başarısız oldu. Lütfen tekrar deneyin.';
$lang['no_password_provided'] = 'Lütfen bir şifre girin.';
$lang['type_username_and_email_for_reset_link'] = 'Şifre sıfırlama bağlantısı almak için kullanıcı adınızı ve e-posta adresinizi yazın.';
$lang['send_reset_link'] = 'Sıfırlama Bağlantısı Gönder';
$lang['reset_link_sent_with_email'] = 'Sağlanan bilgilerle bir hesap varsa, şifre sıfırlama bağlantısı e-postanıza gönderilmiştir.';
$lang['working_plan_validation_failed'] = 'Geçersiz çalışma planı yapılandırması bulundu.';
$lang['start_date'] = 'Başlangıç Tarihi';
$lang['end_date'] = 'Bitiş Tarihi';
$lang['remember_me'] = 'Bilgilerimi hatırla';
$lang['remember_me_hint'] = 'Bir sonraki rezervasyonunuz için bilgilerinizi kaydedin.';
$lang['legal_notice'] = 'Yasal Uyarı';
$lang['legal_notice_url'] = 'Yasal Uyarı URL';
$lang['legal_notice_url_hint'] = 'Yasal uyarı sayfanızın URL adresini girin.';
$lang['imprint'] = 'Künye';
$lang['imprint_url'] = 'Künye URL';
$lang['imprint_url_hint'] = 'Künye sayfanızın URL adresini girin.';
$lang['data_retention'] = 'Veri Saklama';
$lang['data_retention_days'] = 'Veri Saklama Günleri';
$lang['data_retention_days_hint'] = 'Müşteri verilerinin otomatik olarak silineceği gün sayısını ayarlayın. Otomatik silmeyi devre dışı bırakmak için 0 olarak ayarlayın.';
$lang['manage_privacy'] = 'Gizliliği Yönet';
$lang['manage_privacy_hint'] = 'Kişisel bilgilerinizi görüntülemek, güncellemek veya silmek için aşağıdaki bağlantıya tıklayın.';
$lang['personal_information'] = 'Kişisel Bilgiler';
$lang['personal_information_updated'] = 'Kişisel bilgileriniz başarıyla güncellendi.';
$lang['verify'] = 'Doğrula';
$lang['verifying'] = 'Doğrulanıyor';
$lang['verified'] = 'Doğrulandı';
$lang['verification_complete'] = 'Doğrulama tamamlandı';
$lang['verification_failed'] = 'Doğrulama başarısız oldu. Tekrar denemek için tıklayın.';
$lang['click_to_verify'] = 'İnsan olduğunuzu doğrulamak için tıklayın';
$lang['altcha_verification_failed'] = 'ALTCHA doğrulaması başarısız oldu. Lütfen tekrar deneyin.';
