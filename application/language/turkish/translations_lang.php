...
$lang['fields_are_required'] = '* Zorunlu alanlardır.';
...
$lang['appointment_locked'] = 'Değişiklik yapılamaz.';
...
$lang['page_not_found_message'] = 'Maalesef girmeye çalıştığınız sayfa mevcut değil. Lütfen tarayıcınızın URL\'sini kontrol edin veya aşağıdaki düğmeleri kullanarak başka bir konuma gidin.';
$lang['error'] = 'Hata';
...
$lang['customer_notifications_hint'] = 'Müşterinin randevularından birinde bir program değişikliği olduğunda e-posta bildirimleri alıp almayacağını tanımlar.';
...
$lang['google_analytics_code_hint'] = 'Rezervasyon sayfasına dahil edilmek üzere Google Analytics kimliğinizi ekleyin.';
...
$lang['website_using_cookies_to_ensure_best_experience'] = 'Bu web sitesi, size en iyi deneyimi yaşamanızı sağlamak için çerezleri kullanır.';
$lang['read_and_agree_to_terms_and_conditions'] = '{$link}Şartlar ve Koşulları{/$link} okudum ve kabul ediyorum.';
$lang['read_and_agree_to_privacy_policy'] = '{$link}Gizlilik Politikasını{/$link} okudum ve kabul ediyorum.';
...
$lang['working_plan_exceptions_hint'] = 'Çalışma planının dışına bir çalışma planı istisna günü ekleyin.';
...
$lang['add_working_plan_exceptions_during_each_day'] = 'Çalışma planının dışına çalışma planı istisnaları ekleyin.';
...
$lang['overwrite_existing_working_plans'] = 'Bu, mevcut sağlayıcı çalışma planlarının üzerine yazacaktır, devam etmek istediğinizden emin misiniz?';
...
$lang['color'] = 'Rent';
$lang['matomo_analytics_url_hint'] = 'Rezervasyon sayfalarında Matomo takibini etkinleştirmek için URL\'yi kendi Matomo kurulumunuza ekleyin.';
$lang['invalid_phone'] = 'Geçersiz telefon numarası.';
$lang['legal'] = 'Yasal';
$lang['business'] = 'İşletme';
$lang['account'] = 'Hesap';
$lang['disable_booking'] = 'Rezervasyonu Devre Dışı Bırak';
$lang['disable_booking_hint'] = 'Bu ayar etkin olduğu sürece rezervasyon sayfası devre dışı bırakılacak ve müşteriler yeni randevu kaydı yapamayacaktır.';
$lang['display_message'] = 'Ekran Mesajı';
$lang['booking_is_disabled'] = 'Rezervasyon Devre Dışıdır!';
$lang['appearance'] = 'Görünüş';
$lang['company_logo'] = 'Şirket Logosu';
$lang['company_logo_hint'] = 'Şirket logosu, rezervasyon sayfası ve bildirim e-postaları da dahil olmak üzere uygulamanın birçok yerinde görüntülenecektir (resim dosyası, maksimum 2MB).';
$lang['company_color'] = 'Şirket Rengi';
$lang['company_color_hint'] = 'Şirket rengi, uygulamanın markanızı kullanması için uygulama boyunca uygulanacaktır.';
$lang['localization'] = 'Lokalizasyon';
$lang['integrations'] = 'Entegrasyonlar';
$lang['company'] = 'Şirket';
$lang['remove'] = 'Sil';
$lang['login_button'] = 'Giriş Düğmesi';
$lang['display_login_button_hint'] = 'Rezervasyon sayfasında oturum açma düğmesinin görüntülenip görüntülenmeyeceğini tanımlar.';
$lang['private'] = 'Gizli';
$lang['private_hint'] = 'Özel kayıtlar, rezervasyon sayfası gibi genel sayfalarda görüntülenmeyecek veya işlenmeyecektir.';
$lang['reset'] = 'Sıfırla';
$lang['all'] = 'Tümü';
...
$lang['theme'] = 'Tema';
$lang['limit_customer_access'] = 'Müşteri Erişimini Sınırlayın';
$lang['limit_customer_access_hint'] = 'Etkinleştirilirse, sağlayıcılar ve sekreterler yalnızca randevuları olan müşterilere erişebileceklerdir.';
$lang['url'] = 'URL';
...
$lang['unavailability_save'] = 'Kullanılamazlık Kaydet';
...
$lang['webhooks_info'] = 'Webhooks, bir randevunun oluşturulması veya bir müşterinin silinmesi gibi çeşitli uygulama olaylarına yanıt olarak harici web uygulamalarına HTTP bildirimleri göndermenizi sağlar.';
$lang['integrations_info'] = 'Entegrasyonlar, harici uygulamalar ve API\'lerle üçüncü taraf bağlantılar kurmanızı sağlar.';
$lang['configure'] = 'Yapılandır';
$lang['google_analytics'] = 'Google Analytics';
$lang['google_analytics_info'] = 'Google Analytics, izleme kodunu ve HTML işaretlemesini otomatik olarak genel sayfaya eklemenizi ve tüm genel rezervasyon oturumlarını izlemenizi sağlar.';
$lang['matomo_analytics'] = 'Matomo Analytics';
$lang['matomo_analytics_info'] = 'Matomo Analytics, izleme kodunu ve HTML işaretlemesini otomatik olarak genel sayfaya eklemenizi ve tüm genel rezervasyon oturumlarını izlemenizi sağlar.';
$lang['api'] = 'API';
$lang['api_info'] = 'API, HTTP protokolü ve mevcut API uç noktaları aracılığıyla Easy!Appointments verileriyle etkileşimde bulunmanıza ve kendi entegrasyonlarınızı oluşturmanıza olanak tanır.';
$lang['google_analytics_code'] = 'Google Analytics Kodu';
$lang['matomo_analytics_url'] = 'Matomo Analytics URL\'si';
$lang['future_booking_limit'] = 'Gelecek Rezervasyon Sınırı';
$lang['limit_days'] = 'Sınır (Gün)';
$lang['future_booking_limit_hint'] = 'Müşterilerin genel rezervasyon sayfası aracılığıyla randevu alabilecekleri gün cinsinden gelecekteki sınırı ayarlayın.';
...
$lang['appointment_status_options_info'] = 'Takvim sayfasında kullanılabilecek randevu durum seçeneklerinin bir listesini tanımlayın (ilk seçenek otomatik olarak varsayılan değer olacaktır).';
...
$lang['pm'] = 'ös';
$lang['to'] = 'için';
$lang['click_to_toggle'] = 'Geçiş Yapmak İçin Tıklayın';
$lang['week_short'] = 'Hs';
$lang['scroll_to_increment'] = 'Artırmak için Kaydır';
$lang['year'] = 'Yıl';
$lang['make_non_working_day'] = 'Bu sağlayıcı seçilen gün için çalışmaya uygun olmayacaktır.';
$lang['no_breaks'] = 'Ara Yok';
$lang['service_categories'] = 'Hizmet Kategorileri';
$lang['service_category'] = 'Hizmet Kategorisi';
$lang['blocked_period_saved'] = 'Engelli dönem başarıyla kaydedildi.';
$lang['blocked_period_deleted'] = 'Engelli dönem başarıyla silindi.';
...
$lang['matomo_analytics_site_id_hint'] = 'Matomo tarafından izlenecek site kimliğini ayarlayın (varsayılan site kimliği "1"dir).';
...
$lang['connect'] = 'Bağlan';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Bu entegrasyon, mevcut bir LDAP sunucusuna bağlanmanızı ve kullanıcıları Easy!Appointments\'a otomatik olarak aktarmanızı sağlar ve kullanıcıların dizin şifreleri ile SSO yapmalarına olanak tanır (kullanıcı adının eşleşmesi gerekir).';
$lang['host'] = 'Sunucu';
$lang['port'] = 'Port';
$lang['user_dn'] = 'Kullanıcı DN\'si';
...
$lang['content'] = 'İçerik';
$lang['active'] = 'Aktif';
$lang['user_imported'] = 'Kullanıcı kaydı başarıyla aktarıldı.';
$lang['import'] = 'Aktar';
$lang['ldap_dn'] = 'LDAP DN\'si';
$lang['role'] = 'Rol';
$lang['at_least_one_field_required'] = 'Rezervasyon sayfasında en az bir alanın gerekli olarak ayarlanmış olması gerekir.';
