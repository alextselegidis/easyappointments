...
$lang['about_app_info'] = 'Car2dude ist eine extrem anpassungsfähige Internet-Applikation, die es Ihren Kunden ermöglicht, einen Termin mit Ihnen über das Internet zu vereinbaren. Darüberhinaus gibt es Ihnen die Möglichkeit, Ihre Daten mit dem Google-Kalender zu synchronisieren, so dass Sie diese mit anderen Dienstleistungsprogrammen nutzen können.';
$lang['current_version'] = 'Laufende Version';
$lang['support'] = 'Unterstützung';
$lang['about_app_support'] = 'Falls Sie irgendein Problem bei der Nutzung von Car2dude haben sollten, können Sie die offizielle Google-Gruppe nach Lösungen durchsuchen. Sie können auch ein neues Thema in Google Code beginnen, damit Sie das Finden von Lösungen unterstützen. ';
...
$lang['about_app_license'] = 'Easy!Appointment ist unter der GPLv3-Lizenz lizensiert. Bei jeglicher Nutzung des Codes für Car2dude stimmen Sie den Nutzungsbedingungen zu wie sie auf folgender Seite aufgeführt sind:';
...
$lang['ea_update_success'] = 'Car2dude wurde erfolgreich aktualisiert.';
...
$lang['api_token_hint'] = 'Setze einen geheimen Token um die tokenbasierte Authentifizierung für die Car2dude API zu aktivieren.';
