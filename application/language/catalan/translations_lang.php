...
$lang['about_app'] = 'Quant a Car2dude';
...
$lang['about_app_info'] = 'Car2dude és una aplicació web molt ajustable que permet als vostres clients reservar cites amb vosaltres a través del web. A més, us permet sincronitzar amb Google Calendar de manera que ho podeu usar amb altres serveis.';
$lang['current_version'] = 'Versió actual';
$lang['support'] = 'Suport';
$lang['about_app_support'] = 'Si trobeu qualsevol problema fent servir Car2dude, podeu consultar el Google Group per a trobar respostes. També podeu crear noves incidències a la pàgina de Google Code per ajudar al desenvolupament.';
...
$lang['about_app_license'] = 'Car2dude es distribueix amb una llicència GPLv3. Usant el codi d\'Car2dude de qualsevol manera, esteu consentint els termes descrits en la següent URL:';
...
$lang['ea_update_success'] = 'Car2dude s\'ha actualitzat correctament.';
...
$lang['api_token_hint'] = 'Establiu un token secret per permetre l\'autenticació basada en tokens de l\'API d\'Car2dude.';
