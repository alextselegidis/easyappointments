...
$lang['about_app_license'] = 'Easy!Appointments es distribueix amb una llicència GPLv3. Usant el codi d\'Easy!Appointments de qualsevol forma, esteu consentint els termes descrits en la següent URL:';
...
$lang['enter_password_here'] = 'Introduïu la contrasenya aquí ...';
$lang['login'] = 'Entra';
...
$lang['unexpected_issues_message'] = 'L\'operació no s\'ha pogut completar.';
$lang['close'] = 'Tanca';
...
$lang['enter_captcha_here'] = 'Introdueix el CAPTCHA aquí...';
$lang['any_provider'] = 'Qualsevol proveïdor';
$lang['requested_hour_is_unavailable'] = 'La cita que demaneu no està disponible. Seleccioneu una hora diferent per a la vostra cita.';
...
$lang['service_selection_layout'] = 'Disposició de selecció del servei';
$lang['service_selection_layout_hint'] = 'Trieu com es mostren els serveis al primer pas de reserva.';
$lang['dropdown'] = 'Menú desplegable';
$lang['accordion'] = 'Acordió';
$lang['hide_single_provider_selection'] = 'Amagar selecció d\'un sol proveïdor';
$lang['hide_single_provider_selection_hint'] = 'Amaga el camp de proveïdor quan el servei seleccionat només té un proveïdor disponible.';
...
$lang['secret_header'] = 'Capçalera secreta';
$lang['search'] = 'Cerca';
$lang['slot_interval'] = 'Interval de ranura (minuts)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Permet la generació automàtica d\'enllaços a reunions de Jitsi per les cites. Quan s\'habilita, es genera un enllaç únic de vídeotrucada Jitsi i es desa com a enllaç de la reunió.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA és un CAPTCHA alternatiu, de codi obert i centrat en la privacitat que fa servir proves de treball (PoW) per verificar usuaris humans sense fer-ne seguiment.';
$lang['altcha_enabled_hint'] = 'Quan s\'habilita, s\'usa ALTCHA enlloc de la tradicional imatge CAPTCHA per verificar els formularis.';
$lang['altcha_hmac_key'] = 'Clau HMAC';
$lang['altcha_hmac_key_hint'] = 'Una clau secreta usada per signar i verificar els reptes ALTCHA. Cliqueu a Genera per crear una nova clau segura.';
$lang['altcha_max_number'] = 'Nombre màxim';
$lang['altcha_max_number_hint'] = 'El nombre màxim per al repte de prova de treball. Valors més alts incrementen la dificulatat (per defecte: 100000).';
$lang['altcha_expires'] = 'Caducitat (segons)';
...
$lang['google_calendar_info'] = 'Habilita la sincronització amb Google Calendar per sincronitzar amb el proveïdor dels comptes de Google Calendar.';
$lang['google_client_id'] = 'ID del client';
$lang['google_client_id_info'] = 'L\'ID del client del teu projecte de Google Cloud Console.';
$lang['google_client_secret'] = 'Secret de client';
$lang['google_client_secret_info'] = 'El secret de client del vostre projecte a la Google Cloud Console.';
$lang['google_calendar_setup_info'] = 'Per habilitar la sincronització de Google Calendar, heu de crear un projecte a Google Cloud Console, habiliteu l\'API de Google Calendar i creeu unes credencials de OAuth 2.0. Vegeu:';
$lang['google_meet_link_generation'] = 'Genera enllaços de Google Meet';
$lang['google_meet_link_generation_info'] = 'Crea automàticament un enllaç a una vídeo-conferència de Google Meet per a les cites sincronitzades. L\'enllaça ala reunió es desarà en el camp enllaç a la reunió de la cita.';
$lang['display_add_to_google_calendar'] = 'Mostra el botó "Afegeix al Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Mostra el botó "Afegeix al Google Calendar" a la pàgina de confirmació de la cita, permetent fàcilment als clients que afegeixin les seves cites al seu Google Calendar personal.';
$lang['select_all'] = 'Selecciona tot';
$lang['select_none'] = 'No seleccionis cap';
$lang['appointment_update'] = 'Actualització de cita';
$lang['notify_users_on_update_question'] = 'Voleu enviar una notificació sobre aquest canvi?';
$lang['yes'] = 'Sí';
$lang['no'] = 'No';
$lang['latest_blog_posts'] = 'Últimes entrades del blog';
$lang['loading'] = 'Carregant';
$lang['blog_posts_load_error'] = 'No es poden carregar les entrades del blog. Visiteu el lloc web oficial per a actualitzacions.';
...
$lang['would_you_like_to_proceed'] = 'Voleu continuar igualment?';
$lang['proceed'] = 'Continua';
$lang['no_available_service_providers'] = 'No hi ha serveis disponibles';
$lang['no_available_service_providers_message'] = 'Actualment no hi ha serveis ni proveïdors disponibles per a la reserva. Si us plau, torneu més tard o contacteu-nos per obtenir ajuda.';
$lang['reset_password'] = 'Restablir Contrasenya';
$lang['new_password'] = 'Nova Contrasenya';
$lang['enter_new_password'] = 'Introduïu la vostra nova contrasenya a continuació.';
$lang['enter_password_here'] = 'Introduïu la contrasenya aquí ...';
$lang['password_reset_request'] = 'Sol·licitud de restabliment de contrasenya';
...
$lang['password_reset_failed'] = 'Ha fallat el restabliment de la contrasenya. Si us plau, torneu-ho a provar.';
$lang['no_password_provided'] = 'Si us plau, introduïu una contrasenya.';
$lang['type_username_and_email_for_reset_link'] = 'Escriviu el vostre nom d\'usuari i adreça de correu electrònic per rebre un enllaç de restabliment de contrasenya.';
$lang['send_reset_link'] = 'Envia l\'enllaç de restabliment';
...
$lang['working_plan_validation_failed'] = 'S\'ha trobat una configuració del Pla de Treball que no és vàlida.';
$lang['start_date'] = 'Data d\'inici';
$lang['end_date'] = 'Data de fi';
$lang['remember_me'] = 'Recorda la meva informació';
$lang['remember_me_hint'] = 'Desa la teva informació per reservar més ràpid la propera vegada.';
$lang['legal_notice'] = 'Avís legal';
$lang['legal_notice_url'] = 'URL de l\'avís legal';
$lang['legal_notice_url_hint'] = 'Introduïu la URL de la vostra pàgina d\'avís lega o deixeu en blanc i no es mostrarà l\'enllaç.';
$lang['imprint'] = 'Contacte';
$lang['imprint_url'] = 'URL de contacte';
$lang['imprint_url_hint'] = 'Introduïu la URL de la vostra pàgina de contacte o deixeu en blanc i no es mostrarà l\'enllaç.';
$lang['data_retention'] = 'Retenció de dades';
$lang['data_retention_days'] = 'Dies de retenció de dades';
$lang['data_retention_days_hint'] = 'Estableix el nombre de dies després dels quals les dades del client s\'eliminaran automàticament. Poseu a 0 per desactivar l\'eliminació automàtica.';
$lang['manage_privacy'] = 'Gestió de la privacitat';
$lang['manage_privacy_hint'] = 'Cliqueu a l\'enlla de sota per veure, actualitzar o eliminar la vostra informació personal.';
$lang['personal_information'] = 'Informació personal';
$lang['personal_information_updated'] = 'La vostra informació personal ha estat actualitzada correctament.';
$lang['verify'] = 'Verifica';
$lang['verifying'] = 'Verificant';
$lang['verified'] = 'Verificat';
$lang['verification_complete'] = 'Verificació completada';
$lang['verification_failed'] = 'La verificació ha fallat. Cliqueu per tornar-ho a intentar.';
$lang['click_to_verify'] = 'Clica per verificar que ets humà.';
$lang['altcha_verification_failed'] = 'La verificació ALTCHA ha fallat. Proveu-ho un altre cop.';
