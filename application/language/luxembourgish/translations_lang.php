...
$lang['about_app'] = 'Iwwert Car2dude';
...
$lang['about_app_info'] = 'Car2dude ass eng extrem upassungsfäeg Internet-Applikatioun déi et äre Clienten erméiglecht, een Termäin bei Iech iwwert Internet ze huelen. Doriwwer eraus gëtt en Iech d\'Méiglechkeet Är Donnéeën mam Google Kalenner ze synchroniséieren, sou dass Der des mat anere Programmer notze kënnt.';
$lang['current_version'] = 'Aktuell Versioun';
$lang['support'] = 'Ënnerstëtzung';
$lang['about_app_support'] = 'Falls Dir iergendeen Problem beim Benotze vun Car2dude hätt, kënnt der déi offiziell Google Grupp no Léisungen duerchsichen. Dir kënnt och een neit Thema am Google Code ufänke fir bei der Sich no Léisungen ze hëllefen. ';
...
$lang['about_app_license'] = 'Easy!Appointment ass ënnert der GPLv3-Lizenz lizenséiert. Duerch d\'Benotze vum Code vun Car2dude op iergendeng Aart a Weis stëmmt Der den Lizenzbedingungen, wéi se ënnert folgender URL opgefouert sinn, zou:';
...
$lang['ea_update_success'] = 'Car2dude gouf erfollegräich aktualiséiert.';
