...
$lang['db_batch_missing_index'] =
    'Jeden lub więcej wierszy wysłanych do przetwarzania wsadowego jest nieprawidłowy, albo nie ma ustalonego indeksu.';
$lang['db_must_use_where'] = 'Polecenia "Update" nie są dozwolone dopóki nie posiadają klauzuli "where".';
$lang['db_del_must_use_where'] =
    'Polecenia "Delete" nie są dozwolone dopóki nie posiadają klauzuli "where" albo "like".';
...
$lang['db_unsupported_compression'] =
    'Format kompresji plików, który został wybrany nie jest obsługiwany przez serwer.';
