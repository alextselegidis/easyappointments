...
$lang['enter_password_here'] = 'Wprowadź hasło tutaj ...';
$lang['login'] = 'Zaloguj';
...
$lang['unexpected_issues_message'] = 'Operacja nie mogła zostać ukończona.';
$lang['close'] = 'Zamknij';
...
$lang['personal_information'] = 'Dane osobowe';
...
$lang['enter_captcha_here'] = 'Wprowadź CAPTCHA tutaj...';
...
$lang['service_selection_layout'] = 'Układ wyboru usługi';
$lang['service_selection_layout_hint'] = 'Wybierz, jak usługi są wyświetlane w pierwszym kroku rezerwacji.';
$lang['dropdown'] = 'Lista rozwijana';
$lang['accordion'] = 'Akordeon';
$lang['hide_single_provider_selection'] = 'Ukryj wybór pojedynczego usługodawcy';
$lang['hide_single_provider_selection_hint'] = 'Ukrywa pole usługodawcy, gdy wybrana usługa ma tylko jednego dostępnego usługodawcę.';
...
$lang['secret_header'] = 'Tajny nagłówek';
$lang['search'] = 'Szukaj';
$lang['slot_interval'] = 'Interwał slotów (minuty)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Włącz automatyczne generowanie linków do spotkań Jitsi dla wizyt. Po włączeniu dla każdej wizyty zostanie wygenerowany unikalny link do wideorozmowy Jitsi.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA to skoncentrowana na prywatności, otwartoźródłowa alternatywa dla CAPTCHA, która wykorzystuje proof-of-work do weryfikacji użytkowników bez śledzenia.';
$lang['altcha_enabled_hint'] = 'Po włączeniu ALTCHA będzie używana zamiast tradycyjnej graficznej CAPTCHA do weryfikacji formularzy.';
$lang['altcha_hmac_key'] = 'Klucz HMAC';
$lang['altcha_hmac_key_hint'] = 'Tajny klucz używany do podpisywania i weryfikacji wyzwań ALTCHA. Kliknij Generuj, aby utworzyć nowy bezpieczny klucz.';
$lang['altcha_max_number'] = 'Maksymalna liczba';
$lang['altcha_max_number_hint'] = 'Maksymalna liczba dla wyzwania proof-of-work. Wyższe wartości zwiększają trudność (domyślnie: 100000).';
$lang['altcha_expires'] = 'Wygasa (sekundy)';
$lang['altcha_expires_hint'] = 'Czas ważności wyzwania w sekundach (domyślnie: 300).';
$lang['altcha_key_generated'] = 'Nowy klucz HMAC został pomyślnie wygenerowany.';
$lang['altcha_enabled'] = 'Włącz ALTCHA';
$lang['altcha_captcha_not_active_warning'] = 'Ustawienie CAPTCHA nie jest obecnie aktywne. ALTCHA nie będzie używana, dopóki CAPTCHA nie zostanie włączona w';
$lang['generate'] = 'Generuj';
$lang['meeting_link'] = 'Link do spotkania';
$lang['google_calendar'] = 'Kalendarz Google';
$lang['google_calendar_info'] = 'Włącz synchronizację z Google Calendar, aby synchronizować wizyty z kontami Google Calendar usługodawców.';
$lang['google_client_id'] = 'Client ID';
$lang['google_client_id_info'] = 'Client ID z Twojego projektu Google Cloud Console.';
$lang['google_client_secret'] = 'Client Secret';
$lang['google_client_secret_info'] = 'Client Secret z Twojego projektu Google Cloud Console.';
$lang['google_calendar_setup_info'] = 'Aby włączyć synchronizację z Google Calendar, musisz utworzyć projekt w Google Cloud Console, włączyć Google Calendar API i utworzyć dane uwierzytelniające OAuth 2.0. Odwiedź:';
$lang['google_meet_link_generation'] = 'Generuj linki Google Meet';
$lang['google_meet_link_generation_info'] = 'Automatycznie twórz link do wideokonferencji Google Meet dla zsynchronizowanych wizyt. Link do spotkania zostanie zapisany w polu linku spotkania wizyty.';
$lang['display_add_to_google_calendar'] = 'Wyświetl przycisk "Dodaj do Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Wyświetlaj przycisk "Dodaj do Google Calendar" na stronie potwierdzenia rezerwacji, umożliwiając klientom łatwe dodanie wizyty do ich osobistego Google Calendar.';
$lang['select_all'] = 'Zaznacz wszystko';
$lang['select_none'] = 'Odznacz wszystko';
$lang['appointment_update'] = 'Aktualizacja wizyty';
$lang['notify_users_on_update_question'] = 'Czy chcesz wysłać powiadomienie o tej zmianie?';
$lang['yes'] = 'Tak';
$lang['no'] = 'Nie';
$lang['latest_blog_posts'] = 'Najnowsze wpisy na blogu';
$lang['loading'] = 'Ładowanie';
$lang['blog_posts_load_error'] = 'Nie można załadować wpisów na blogu. Odwiedź oficjalną stronę, aby uzyskać aktualizacje.';
...
$lang['would_you_like_to_proceed'] = 'Czy chcesz kontynuować?';
$lang['proceed'] = 'Kontynuuj';
$lang['no_available_service_providers'] = 'Brak dostępnych usług';
$lang['no_available_service_providers_message'] = 'Obecnie nie ma dostępnych usług ani dostawców do rezerwacji. Sprawdź później lub skontaktuj się z nami w celu uzyskania pomocy.';
$lang['reset_password'] = 'Zresetuj hasło';
$lang['new_password'] = 'Nowe hasło';
$lang['enter_new_password'] = 'Wprowadź swoje nowe hasło poniżej.';
$lang['enter_password_here'] = 'Wprowadź hasło tutaj ...';
$lang['password_reset_request'] = 'Prośba o zresetowanie hasła';
$lang['password_reset_email_message'] = 'Poprosiłeś o zresetowanie hasła. Kliknij poniższy przycisk, aby ustawić nowe hasło dla swojego konta.';
$lang['password_reset_link_expires'] = 'Ten link wygaśnie za 1 godzinę.';
$lang['password_reset_ignore_message'] = 'Jeśli nie prosiłeś o zresetowanie hasła, zignoruj tę wiadomość e-mail.';
$lang['invalid_reset_token'] = 'Link do resetowania hasła jest nieprawidłowy.';
$lang['invalid_or_expired_token'] = 'Link do resetowania hasła jest nieprawidłowy lub wygasł. Poproś o nowy.';
$lang['password_reset_success'] = 'Twoje hasło zostało pomyślnie zresetowane. Zostaniesz przekierowany do strony logowania.';
$lang['password_reset_failed'] = 'Resetowanie hasła nie powiodło się. Spróbuj ponownie.';
$lang['no_password_provided'] = 'Proszę wprowadzić hasło.';
$lang['type_username_and_email_for_reset_link'] = 'Wpisz swoją nazwę użytkownika i adres e-mail, aby otrzymać link do resetowania hasła.';
$lang['send_reset_link'] = 'Wyślij link resetujący';
...
$lang['working_plan_validation_failed'] = 'Wykryto nieprawidłową konfigurację planu pracy.';
$lang['start_date'] = 'Data rozpoczęcia';
$lang['end_date'] = 'Data zakończenia';
$lang['remember_me'] = 'Zapamiętaj moje dane';
$lang['remember_me_hint'] = 'Zapisz swoje dane, aby szybciej rezerwować następnym razem.';
$lang['legal_notice'] = 'Nota prawna';
$lang['legal_notice_url'] = 'URL noty prawnej';
$lang['legal_notice_url_hint'] = 'Wprowadź URL strony z notą prawną.';
$lang['imprint'] = 'Impressum';
$lang['imprint_url'] = 'URL impressum';
$lang['imprint_url_hint'] = 'Wprowadź URL strony z impressum.';
$lang['data_retention'] = 'Przechowywanie danych';
$lang['data_retention_days'] = 'Dni przechowywania danych';
$lang['data_retention_days_hint'] = 'Ustaw liczbę dni, po których dane klientów zostaną automatycznie usunięte. Ustaw 0, aby wyłączyć automatyczne usuwanie.';
$lang['manage_privacy'] = 'Zarządzaj prywatnością';
$lang['manage_privacy_hint'] = 'Kliknij poniższy link, aby wyświetlić, zaktualizować lub usunąć swoje dane osobowe.';
$lang['personal_information'] = 'Dane osobowe';
$lang['personal_information_updated'] = 'Twoje dane osobowe zostały pomyślnie zaktualizowane.';
$lang['verify'] = 'Weryfikuj';
$lang['verifying'] = 'Weryfikowanie';
$lang['verified'] = 'Zweryfikowano';
$lang['verification_complete'] = 'Weryfikacja zakończona';
$lang['verification_failed'] = 'Weryfikacja nie powiodła się. Kliknij, aby ponowić.';
$lang['click_to_verify'] = 'Kliknij, aby potwierdzić, że jesteś człowiekiem';
$lang['altcha_verification_failed'] = 'Weryfikacja ALTCHA nie powiodła się. Spróbuj ponownie.';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = 'Oferujemy kompleksowe usługi dla samodzielnie hostowanego oprogramowania, w tym niestandardowy rozwój, zarządzany hosting, umowy serwisowe, rebranding i ciągłe ulepszenia — abyś mógł skupić się na swoim biznesie, podczas gdy my zajmiemy się resztą.';
