...
$lang['thank_you_for_appointment'] =
    'Dziękuje za dokonanie rezerwacji. Poniżej umieszczone są szczegóły wizyty. Aby dokonać zmian kliknij link wizyty.';
...
$lang['edit_working_plan_hint'] =
    'Zaznacz poniżej dni i godziny w których Twoja firma akceptuje wizyty. Będziesz w stanie dostosować w stosunku do godziny pracujących i nie pracujących. Ten plan będzie domyślny dla każdego nowego personelu. Dla każdego nowego personelu można utworzyć oddzielny plan poprzez edycję planu.';
$lang['edit_breaks_hint'] =
    'Dodaj przerwy w pracy w ciągu dnia. Te przerwy będą dotyczyć również dla nowych pacjentów.';
...
$lang['about_app_info'] =
    'Easy!Appointments jest aplikacją webową wysoce przystosowywalną do potrzeb klienta. Co więcej pozwala na synchronizację z Kalendarzem Google.';
...
$lang['new_password_is'] =
    'Twoje nowe hasło to $password. Proszę zachować ten email aby w razie potrzeby  móc do niego sięgnąć.';
...
$lang['user_settings_are_invalid'] =
    'Ustawienia użytkownika są niepoprawne! Proszę sprawdź swoje ustawienia i spróbuj ponownie.';
