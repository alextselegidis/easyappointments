...
$lang['enter_password_here'] = 'Sisestage parool siia ...';
...
$lang['unexpected_issues_message'] = 'Toimingut ei saanud lõpule viia.';
$lang['close'] = 'Sulge';
...
$lang['personal_information'] = 'Isikuandmed';
...
$lang['enter_captcha_here'] = 'Sisestage CAPTCHA siia...';
$lang['any_provider'] = 'Suvaline teenusepakkuja';
$lang['requested_hour_is_unavailable'] = 'Soovitud aeg ei ole enam saadaval. Palun vali uus aeg.';
...
$lang['service_selection_layout'] = 'Teenuse valiku paigutus';
$lang['service_selection_layout_hint'] = 'Valige, kuidas teenuseid broneerimise esimesel sammul kuvatakse.';
$lang['dropdown'] = 'Rippmenüü';
$lang['accordion'] = 'Akordion';
$lang['hide_single_provider_selection'] = 'Peida üksiku teenusepakkuja valik';
$lang['hide_single_provider_selection_hint'] = 'Peidab teenusepakkuja välja, kui valitud teenusel on ainult üks saadaolev pakkuja.';
...
$lang['require'] = 'Nõutud';
$lang['color'] = 'Värvid';
$lang['matomo_analytics_url_hint'] = 'Lisage oma Matomo paigalduse URL, et võimaldada Matomo jälgimist broneerimislehtedel.';
...
$lang['matomo_analytics_site_id'] = 'Matomo Analytics saidi ID';
...
$lang['connect'] = 'Ühenda';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'See integratsioon võimaldab teil ühenduda olemasoleva LDAP serveriga ja importida kasutajaid automaatselt Easy!Appointments rakendusse ning lasta neil SSO kaudu sisse logida oma kataloogiparooliga (kasutajanimi peab kattuma).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
...
$lang['secret_header'] = 'Salajane päis';
$lang['search'] = 'Otsi';
$lang['slot_interval'] = 'Ajavahemik (minutit)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Luba automaatne Jitsi koosoleku lingi loomine kohtumistele. Kui lubatud, luuakse iga kohtumise jaoks unikaalne Jitsi videokõne link ja salvestatakse see koosoleku lingina.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA on privaatsusele keskendunud avatud lähtekoodiga CAPTCHA alternatiiv, mis kasutab tööjõu tõestust inimkasutajate kontrollimiseks ilma jälgimiseta.';
$lang['altcha_enabled_hint'] = 'Kui lubatud, kasutatakse ALTCHA-d vormi kontrollimiseks traditsioonilise pildi-CAPTCHA asemel.';
$lang['altcha_hmac_key'] = 'HMAC Key';
$lang['altcha_hmac_key_hint'] = 'Salajane võti, mida kasutatakse ALTCHA väljakutsete allkirjastamiseks ja kontrollimiseks. Klõpsake Genereeri, et luua uus turvaline võti.';
$lang['altcha_max_number'] = 'Maksimaalne arv';
$lang['altcha_max_number_hint'] = 'Tööjõu tõestuse väljakutse maksimaalne arv. Suuremad väärtused suurendavad raskust (vaikimisi: 100000).';
$lang['altcha_expires'] = 'Aegub (sekundid)';
...
$lang['google_calendar_info'] = 'Luba Google Calendar sünkroniseerimine, et sünkroniseerida kohtumised teenusepakkujate Google Calendar kontodega.';
$lang['google_client_id'] = 'Client ID';
$lang['google_client_id_info'] = 'Client ID teie Google Cloud Console projektist.';
$lang['google_client_secret'] = 'Client Secret';
$lang['google_client_secret_info'] = 'Client Secret teie Google Cloud Console projektist.';
$lang['google_calendar_setup_info'] = 'Google Calendar sünkroniseerimise lubamiseks peate looma projekti Google Cloud Console\'is, lubama Google Calendar API ja looma OAuth 2.0 mandaadid. Külastage:';
$lang['google_meet_link_generation'] = 'Genereeri Google Meet lingid';
$lang['google_meet_link_generation_info'] = 'Loo automaatselt Google Meet videokonverentsi link sünkroniseeritud kohtumistele. Koosoleku link salvestatakse kohtumise koosoleku lingi väljale.';
$lang['display_add_to_google_calendar'] = 'Kuva "Add to Google Calendar" nupp';
$lang['display_add_to_google_calendar_info'] = 'Kuva "Add to Google Calendar" nupp broneeringu kinnituse lehel, et kliendid saaksid hõlpsalt lisada oma kohtumise isiklikku Google Calendar kalendrisse.';
$lang['select_all'] = 'Vali kõik';
$lang['select_none'] = 'Tühista valik';
$lang['appointment_update'] = 'Kohtumise uuendamine';
$lang['notify_users_on_update_question'] = 'Kas soovite selle muudatuse kohta teavituse saata?';
$lang['yes'] = 'Jah';
$lang['no'] = 'Ei';
$lang['latest_blog_posts'] = 'Viimased blogipostitused';
$lang['loading'] = 'Laadimine';
$lang['blog_posts_load_error'] = 'Blogipostitusi ei saa laadida. Uuenduste saamiseks külastage ametlikku veebisaiti.';
...
$lang['would_you_like_to_proceed'] = 'Kas soovite siiski jätkata?';
$lang['proceed'] = 'Jätka';
$lang['no_available_service_providers'] = 'Teenused pole saadaval';
$lang['no_available_service_providers_message'] = 'Hetkel pole broneerimiseks saadaval teenuseid ega teenusepakkujaid. Palun kontrollige hiljem või võtke meiega ühendust.';
$lang['reset_password'] = 'Lähtesta parool';
$lang['new_password'] = 'Uus parool';
$lang['enter_new_password'] = 'Sisestage oma uus parool allpool.';
$lang['enter_password_here'] = 'Sisestage parool siia ...';
$lang['password_reset_request'] = 'Parooli lähtestamise taotlus';
$lang['password_reset_email_message'] = 'Olete taotlenud parooli lähtestamist. Klõpsake alloleval nupul, et seada oma kontole uus parool.';
$lang['password_reset_link_expires'] = 'See link aegub 1 tunni pärast.';
$lang['password_reset_ignore_message'] = 'Kui te ei ole taotlenud parooli lähtestamist, palun eirake seda e-kirja.';
$lang['invalid_reset_token'] = 'Parooli lähtestamise link on kehtetu.';
$lang['invalid_or_expired_token'] = 'Parooli lähtestamise link on kehtetu või aegunud. Palun taotlege uus.';
$lang['password_reset_success'] = 'Teie parool on edukalt lähtestatud. Teid suunatakse sisselogimislehele.';
$lang['password_reset_failed'] = 'Parooli lähtestamine ebaõnnestus. Palun proovige uuesti.';
$lang['no_password_provided'] = 'Palun sisestage parool.';
$lang['type_username_and_email_for_reset_link'] = 'Sisestage oma kasutajanimi ja e-posti aadress, et saada parooli lähtestamise link.';
$lang['send_reset_link'] = 'Saada lähtestamislink';
$lang['reset_link_sent_with_email'] = 'Kui antud andmetega konto on olemas, on parooli lähtestamise link saadetud teie e-postile.';
$lang['working_plan_validation_failed'] = 'Leiti kehtetu tööplaani konfiguratsioon.';
$lang['start_date'] = 'Alguskuupäev';
$lang['end_date'] = 'Lõppkuupäev';
$lang['remember_me'] = 'Jäta mu andmed meelde';
$lang['remember_me_hint'] = 'Salvesta oma andmed kiiremaks broneerimiseks järgmisel korral.';
$lang['legal_notice'] = 'Õigusteade';
$lang['legal_notice_url'] = 'Õigusteate URL';
$lang['legal_notice_url_hint'] = 'Sisestage oma õigusteate lehe URL.';
$lang['imprint'] = 'Impressum';
$lang['imprint_url'] = 'Impressum URL';
$lang['imprint_url_hint'] = 'Sisestage oma impressumi lehe URL.';
$lang['data_retention'] = 'Andmete säilitamine';
$lang['data_retention_days'] = 'Andmete säilitamise päevad';
$lang['data_retention_days_hint'] = 'Määrake päevade arv, mille järel kliendiandmed automaatselt kustutatakse. Määrake 0, et keelata automaatne kustutamine.';
$lang['manage_privacy'] = 'Halda privaatsust';
$lang['manage_privacy_hint'] = 'Klõpsake alloleval lingil, et vaadata, uuendada või kustutada oma isikuandmeid.';
$lang['personal_information'] = 'Isikuandmed';
$lang['personal_information_updated'] = 'Teie isikuandmed on edukalt uuendatud.';
$lang['verify'] = 'Kontrolli';
$lang['verifying'] = 'Kontrollimine';
$lang['verified'] = 'Kontrollitud';
$lang['verification_complete'] = 'Kontrollimine lõpetatud';
$lang['verification_failed'] = 'Kontrollimine ebaõnnestus. Klõpsake uuesti proovimiseks.';
$lang['click_to_verify'] = 'Klõpsake, et kinnitada, et olete inimene';
$lang['altcha_verification_failed'] = 'ALTCHA kontrollimine ebaõnnestus. Palun proovige uuesti.';
