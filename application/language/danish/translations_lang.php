...
$lang['update'] = 'Opdater';
$lang['cancel_appointment_hint'] = 'Tryk "Slet tid" for at aflyse aftalen.';
...
$lang['trigger_sync_hint'] = 'Start kalendersynkroniseringsprocessen.';
...
$lang['enter_password_here'] = 'Indtast adgangskode her ...';
$lang['login'] = 'Log ind';
...
$lang['unexpected_issues_message'] = 'Handlingen kunne ikke fuldføres.';
$lang['close'] = 'luk';
...
$lang['enter_captcha_here'] = 'Indtast CAPTCHA her...';
...
$lang['require'] = 'Kræv';
$lang['color'] = 'Farve';
$lang['matomo_analytics_url_hint'] = 'Tilføj URL\'en til din egen Matomo-installation for at aktivere Matomo-sporing på bookingsiderne.';
...
$lang['search'] = 'Søg';
$lang['slot_interval'] = 'Tidsinterval (Minutter)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Aktivér automatisk generering af Jitsi-mødelinks til aftaler. Når aktiveret, genereres et unikt Jitsi-videoopkaldslink og gemmes som mødelink.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA er et privatlivsfokuseret, open source CAPTCHA-alternativ, der bruger proof-of-work til at verificere menneskelige brugere uden sporing.';
$lang['altcha_enabled_hint'] = 'Når aktiveret, vil ALTCHA blive brugt i stedet for den traditionelle billed-CAPTCHA til formularverificering.';
$lang['altcha_hmac_key'] = 'HMAC Key';
$lang['altcha_hmac_key_hint'] = 'En hemmelig nøgle, der bruges til at signere og verificere ALTCHA-udfordringer. Klik på Generér for at oprette en ny sikker nøgle.';
$lang['altcha_max_number'] = 'Maks. antal';
$lang['altcha_max_number_hint'] = 'Det maksimale antal for proof-of-work-udfordringen. Højere værdier øger sværhedsgraden (standard: 100000).';
$lang['altcha_expires'] = 'Udløber (Sekunder)';
$lang['altcha_expires_hint'] = 'Hvor længe en udfordring forbliver gyldig i sekunder (standard: 300).';
$lang['altcha_key_generated'] = 'Ny HMAC-nøgle genereret.';
$lang['altcha_enabled'] = 'Aktivér ALTCHA';
$lang['altcha_captcha_not_active_warning'] = 'CAPTCHA-indstillingen er ikke aktiv i øjeblikket. ALTCHA vil ikke blive brugt, medmindre CAPTCHA er aktiveret i';
$lang['generate'] = 'Generér';
$lang['meeting_link'] = 'Mødelink';
$lang['google_calendar'] = 'Google Kalender';
$lang['google_calendar_info'] = 'Aktivér Google Calendar-synkronisering for at synkronisere aftaler med udbydernes Google Calendar-konti.';
$lang['google_client_id'] = 'Klient-ID';
$lang['google_client_id_info'] = 'Klient-ID\'en fra dit Google Cloud Console-projekt.';
$lang['google_client_secret'] = 'Klienthemmelighed';
$lang['google_client_secret_info'] = 'Klienthemmeligheden fra dit Google Cloud Console-projekt.';
$lang['google_calendar_setup_info'] = 'For at aktivere Google Calendar-synkronisering skal du oprette et projekt i Google Cloud Console, aktivere Google Calendar API\'en og oprette OAuth 2.0-legitimationsoplysninger. Besøg:';
$lang['google_meet_link_generation'] = 'Generér Google Meet-links';
$lang['google_meet_link_generation_info'] = 'Opret automatisk et Google Meet-videokonferencelink til synkroniserede aftaler. Mødelinket gemmes i aftalens mødelinkfelt.';
$lang['display_add_to_google_calendar'] = 'Vis "Tilføj til Google Calendar"-knap';
$lang['display_add_to_google_calendar_info'] = 'Vis "Tilføj til Google Calendar"-knappen på bookingbekræftelsessiden, så kunder nemt kan tilføje deres aftale til deres personlige Google Calendar.';
$lang['select_all'] = 'Vælg alle';
$lang['select_none'] = 'Fravælg alle';
$lang['appointment_update'] = 'Opdatering af aftale';
$lang['notify_users_on_update_question'] = 'Vil du sende en notifikation om denne ændring?';
$lang['yes'] = 'Ja';
$lang['no'] = 'Nej';
$lang['latest_blog_posts'] = 'Seneste blogindlæg';
$lang['loading'] = 'Indlæser';
$lang['blog_posts_load_error'] = 'Kan ikke indlæse blogindlæg. Besøg venligst den officielle hjemmeside for opdateringer.';
...
$lang['would_you_like_to_proceed'] = 'Vil du fortsætte alligevel?';
$lang['proceed'] = 'Fortsæt';
$lang['no_available_service_providers'] = 'Ingen tilgængelige tjenester';
$lang['no_available_service_providers_message'] = 'Der er i øjeblikket ingen tjenester eller udbydere tilgængelige for booking. Tjek venligst igen senere eller kontakt os for hjælp.';
$lang['reset_password'] = 'Nulstil adgangskode';
$lang['new_password'] = 'Ny adgangskode';
$lang['enter_new_password'] = 'Indtast din nye adgangskode nedenfor.';
$lang['password_reset_request'] = 'Anmodning om nulstilling af adgangskode';
...
$lang['password_reset_failed'] = 'Nulstilling af adgangskode mislykkedes. Prøv venligst igen.';
$lang['no_password_provided'] = 'Indtast venligst en adgangskode.';
$lang['type_username_and_email_for_reset_link'] = 'Indtast dit brugernavn og e-mailadresse for at modtage et link til nulstilling af adgangskode.';
$lang['send_reset_link'] = 'Send nulstillingslink';
$lang['reset_link_sent_with_email'] = 'Hvis der findes en konto med de angivne oplysninger, er et link til nulstilling af adgangskode sendt til din e-mail.';
$lang['working_plan_validation_failed'] = 'Ugyldig arbejdsplankonfiguration fundet.';
$lang['start_date'] = 'Startdato';
$lang['end_date'] = 'Slutdato';
$lang['remember_me'] = 'Husk mine oplysninger';
$lang['remember_me_hint'] = 'Gem dine oplysninger for hurtigere booking næste gang.';
$lang['legal_notice'] = 'Juridisk meddelelse';
$lang['legal_notice_url'] = 'URL til juridisk meddelelse';
$lang['legal_notice_url_hint'] = 'Indtast URL\'en til din side med juridisk meddelelse.';
$lang['imprint'] = 'Kolofon';
$lang['imprint_url'] = 'Kolofon-URL';
$lang['imprint_url_hint'] = 'Indtast URL\'en til din kolofonside.';
$lang['data_retention'] = 'Dataopbevaring';
$lang['data_retention_days'] = 'Dage for dataopbevaring';
$lang['data_retention_days_hint'] = 'Angiv antallet af dage, hvorefter kundedata automatisk slettes. Sæt til 0 for at deaktivere automatisk sletning.';
$lang['manage_privacy'] = 'Administrér privatliv';
$lang['manage_privacy_hint'] = 'Klik på linket nedenfor for at se, opdatere eller slette dine personlige oplysninger.';
$lang['personal_information_updated'] = 'Dine personlige oplysninger er blevet opdateret.';
$lang['verify'] = 'Verificér';
$lang['verifying'] = 'Verificerer';
$lang['verified'] = 'Verificeret';
$lang['verification_complete'] = 'Verificering fuldført';
$lang['verification_failed'] = 'Verificering mislykkedes. Klik for at prøve igen.';
$lang['click_to_verify'] = 'Klik for at verificere, at du er et menneske';
$lang['altcha_verification_failed'] = 'ALTCHA-verificering mislykkedes. Prøv venligst igen.';
...
$lang['caldav'] = 'CalDAV';
$lang['caldav_info'] = 'Synkroniser dine udbyderes aftaler med en CalDAV-kalenderserver, og bestem hvilke værter synkroniseringen må oprette forbindelse til.';
$lang['caldav_allowed_hosts'] = 'Tilladte forbindelses-URL\'er';
$lang['caldav_allowed_hosts_info'] = 'CalDAV-URL\'er, der peger på en privat eller reserveret netværksadresse, afvises, så en URL, der indtastes i administrationen, ikke kan nå denne installations interne netværk. Tilføj én forbindelses-URL eller ét værtsnavn pr. linje for alligevel at tillade den. Tilføj kun servere, som du selv driver.';
$lang['caldav_sync_failed'] = 'CalDAV-synkronisering mislykkedes';
$lang['caldav_sync_failed_url'] = 'Den gemte forbindelses-URL kunne ikke bruges. Hvis din CalDAV-server kører på dit lokale netværk, skal du tilføje dens URL under Indstillinger, Integrationer, CalDAV. Ellers skal du slå synkroniseringen fra og oprette forbindelse igen med en korrekt URL.';
$lang['caldav_sync_failed_credentials'] = 'CalDAV-serveren afviste brugernavnet og adgangskoden. Slå synkroniseringen fra, og opret forbindelse igen med de korrekte oplysninger.';
$lang['caldav_sync_failed_unreachable'] = 'CalDAV-serveren kunne ikke nås. Kontroller, at den kører, og at forbindelses-URL\'en er korrekt.';
$lang['caldav_private_host_warning'] = 'Denne server er på et privat netværk. Ved at oprette forbindelse tilføjes dens vært til de tilladte forbindelses-URL\'er.';
$lang['caldav_allow_host_and_connect'] = 'Tillad og opret forbindelse';
// End
