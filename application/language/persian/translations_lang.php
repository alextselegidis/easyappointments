...
$lang['cancel_appointment_hint'] = 'برای حذف قرار ملاقات از برنامه شرکت، دکمه "لغو قرار ملاقات" را بفشارید';
$lang['cancel'] = 'لغو';
...
$lang['invalid_duration'] = 'مدت زمان نامعتبر است.';
...
$lang['unexpected_issues_message'] = 'عملیات کامل نشد.';
$lang['close'] = 'بستن';
...
$lang['enter_captcha_here'] = 'کد CAPTCHA را اینجا وارد کنید...';
$lang['any_provider'] = 'هر ارائه‌دهنده‌ای';
...
$lang['matomo_analytics'] = 'ماتومو آنالیتیکس';
...
$lang['secret_header'] = 'سرآیند محرمانه';
$lang['search'] = 'جستجو';
$lang['slot_interval'] = 'فاصله زمانی (دقیقه)';
$lang['jitsi'] = 'جیتسی';
$lang['jitsi_info'] = 'ایجاد خودکار لینک جلسه Jitsi را برای نوبت‌ها فعال کنید. در صورت فعال‌سازی، یک لینک تماس تصویری Jitsi منحصر به فرد ایجاد و به عنوان لینک جلسه ذخیره می‌شود.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA یک جایگزین CAPTCHA متن‌باز و متمرکز بر حریم خصوصی است که از اثبات کار برای تأیید کاربران انسانی بدون ردیابی استفاده می‌کند.';
$lang['altcha_enabled_hint'] = 'در صورت فعال‌سازی، ALTCHA به جای CAPTCHA تصویری سنتی برای تأیید فرم استفاده خواهد شد.';
$lang['altcha_hmac_key'] = 'کلید HMAC';
$lang['altcha_hmac_key_hint'] = 'یک کلید محرمانه که برای امضا و تأیید چالش‌های ALTCHA استفاده می‌شود. برای ایجاد کلید امن جدید روی ایجاد کلیک کنید.';
$lang['altcha_max_number'] = 'حداکثر عدد';
$lang['altcha_max_number_hint'] = 'حداکثر عدد برای چالش اثبات کار. مقادیر بالاتر سختی را افزایش می‌دهند (پیش‌فرض: 100000).';
$lang['altcha_expires'] = 'انقضا (ثانیه)';
...
$lang['google_calendar_info'] = 'همگام‌سازی Google Calendar را برای همگام‌سازی نوبت‌ها با حساب‌های Google Calendar ارائه‌دهندگان فعال کنید.';
$lang['google_client_id'] = 'شناسه کلاینت';
$lang['google_client_id_info'] = 'شناسه کلاینت از پروژه Google Cloud Console شما.';
$lang['google_client_secret'] = 'رمز کلاینت';
$lang['google_client_secret_info'] = 'رمز کلاینت از پروژه Google Cloud Console شما.';
$lang['google_calendar_setup_info'] = 'برای فعال‌سازی همگام‌سازی Google Calendar، باید یک پروژه در Google Cloud Console ایجاد کنید، Google Calendar API را فعال کنید و اعتبارنامه‌های OAuth 2.0 بسازید. مراجعه کنید:';
$lang['google_meet_link_generation'] = 'ایجاد لینک‌های Google Meet';
$lang['google_meet_link_generation_info'] = 'به‌طور خودکار یک لینک ویدئو کنفرانس Google Meet برای نوبت‌های همگام‌شده ایجاد کنید. لینک جلسه در فیلد لینک جلسه نوبت ذخیره خواهد شد.';
$lang['display_add_to_google_calendar'] = 'نمایش دکمه "افزودن به Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'دکمه "افزودن به Google Calendar" را در صفحه تأیید رزرو نمایش دهید تا مشتریان بتوانند به‌راحتی نوبت خود را به تقویم شخصی Google Calendar خود اضافه کنند.';
$lang['select_all'] = 'انتخاب همه';
$lang['select_none'] = 'لغو انتخاب همه';
$lang['appointment_update'] = 'به‌روزرسانی قرار ملاقات';
$lang['notify_users_on_update_question'] = 'آیا می‌خواهید درباره این تغییر اطلاع‌رسانی ارسال کنید؟';
$lang['yes'] = 'بله';
$lang['no'] = 'خیر';
$lang['latest_blog_posts'] = 'آخرین پست‌های وبلاگ';
$lang['loading'] = 'در حال بارگذاری';
$lang['blog_posts_load_error'] = 'امکان بارگذاری پست‌های وبلاگ وجود ندارد. لطفاً برای به‌روزرسانی‌ها به وب‌سایت رسمی مراجعه کنید.';
...
$lang['would_you_like_to_proceed'] = 'آیا می‌خواهید ادامه دهید؟';
$lang['proceed'] = 'ادامه';
$lang['no_available_service_providers'] = 'هیچ خدماتی در دسترس نیست';
$lang['no_available_service_providers_message'] = 'در حال حاضر هیچ خدمات یا ارائه‌دهنده‌ای برای رزرو در دسترس نیست. لطفاً بعداً بررسی کنید یا برای کمک با ما تماس بگیرید.';
$lang['reset_password'] = 'بازنشانی رمز عبور';
$lang['new_password'] = 'رمز عبور جدید';
$lang['enter_new_password'] = 'رمز عبور جدید خود را در زیر وارد کنید.';
$lang['password_reset_request'] = 'درخواست بازنشانی رمز عبور';
...
$lang['password_reset_failed'] = 'بازنشانی رمز عبور ناموفق بود. لطفاً دوباره تلاش کنید.';
$lang['no_password_provided'] = 'لطفاً یک رمز عبور وارد کنید.';
$lang['type_username_and_email_for_reset_link'] = 'نام کاربری و آدرس ایمیل خود را وارد کنید تا لینک بازیابی رمز عبور دریافت کنید.';
$lang['send_reset_link'] = 'ارسال لینک بازنشانی';
...
$lang['working_plan_validation_failed'] = 'پیکربندی برنامه کاری نامعتبر یافت شد.';
$lang['start_date'] = 'تاریخ شروع';
$lang['end_date'] = 'تاریخ پایان';
$lang['remember_me'] = 'اطلاعات من را به خاطر بسپار';
$lang['remember_me_hint'] = 'اطلاعات خود را برای رزرو سریع‌تر در دفعه بعد ذخیره کنید.';
$lang['legal_notice'] = 'اطلاعیه حقوقی';
$lang['legal_notice_url'] = 'آدرس اطلاعیه حقوقی';
$lang['legal_notice_url_hint'] = 'آدرس صفحه اطلاعیه حقوقی خود را وارد کنید.';
$lang['imprint'] = 'مشخصات ناشر';
$lang['imprint_url'] = 'آدرس مشخصات ناشر';
$lang['imprint_url_hint'] = 'آدرس صفحه مشخصات ناشر خود را وارد کنید.';
$lang['data_retention'] = 'نگهداری داده‌ها';
$lang['data_retention_days'] = 'روزهای نگهداری داده‌ها';
$lang['data_retention_days_hint'] = 'تعداد روزهایی را تعیین کنید که پس از آن داده‌های مشتری به‌طور خودکار حذف خواهند شد. برای غیرفعال کردن حذف خودکار روی 0 تنظیم کنید.';
$lang['manage_privacy'] = 'مدیریت حریم خصوصی';
$lang['manage_privacy_hint'] = 'برای مشاهده، به‌روزرسانی یا حذف اطلاعات شخصی خود روی لینک زیر کلیک کنید.';
$lang['personal_information_updated'] = 'اطلاعات شخصی شما با موفقیت به‌روزرسانی شد.';
$lang['verify'] = 'تأیید';
$lang['verifying'] = 'در حال تأیید';
$lang['verified'] = 'تأیید شد';
$lang['verification_complete'] = 'تأیید کامل شد';
$lang['verification_failed'] = 'تأیید ناموفق بود. برای تلاش مجدد کلیک کنید.';
$lang['click_to_verify'] = 'برای تأیید اینکه انسان هستید کلیک کنید';
$lang['altcha_verification_failed'] = 'تأیید ALTCHA ناموفق بود. لطفاً دوباره تلاش کنید.';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = 'ما خدمات جامع برای نرم‌افزارهای خودمیزبان ارائه می‌دهیم، از جمله توسعه سفارشی، میزبانی مدیریت‌شده، قراردادهای پشتیبانی، تغییر برند و بهبودهای مداوم — تا شما بتوانید روی کسب‌وکار خود تمرکز کنید در حالی که ما بقیه کارها را انجام می‌دهیم.';
...
$lang['invalid_price'] = 'هزینه نامعتبر است.';
$lang['invalid_slot_interval'] = 'فاصله زمانی نامعتبر است.';
$lang['invalid_attendants_number'] = 'تعداد حاضران نامعتبر است.';
$lang['scheduling_conflict'] = 'تداخل زمان‌بندی';
$lang['invalid_time'] = 'زمان نامعتبر است.';
$lang['service_and_provider_missing'] = 'لطفا قبل از ادامه، خدمات و ارائه دهنده را انتخاب کنید';
$lang['caldav'] = 'CalDAV';
$lang['caldav_info'] = 'قرارهای ارائه‌دهندگان خود را با یک سرور تقویم CalDAV همگام‌سازی کنید و تعیین کنید همگام‌سازی به کدام میزبان‌ها اجازه اتصال دارد.';
$lang['caldav_allowed_hosts'] = 'نشانی‌های اتصال مجاز';
$lang['caldav_allowed_hosts_info'] = 'نشانی‌های CalDAV که به یک نشانی شبکه خصوصی یا رزرو شده اشاره می‌کنند رد می‌شوند تا نشانی واردشده در بخش مدیریت نتواند به شبکه داخلی این نصب دسترسی پیدا کند. برای مجاز کردن آن، در هر خط یک نشانی اتصال یا نام میزبان بیفزایید. تنها سرورهایی را بیفزایید که خودتان اداره می‌کنید.';
$lang['caldav_sync_failed'] = 'همگام‌سازی CalDAV ناموفق بود';
$lang['caldav_sync_failed_url'] = 'نشانی اتصال ذخیره‌شده قابل استفاده نبود. اگر سرور CalDAV شما در شبکه محلی اجرا می‌شود، نشانی آن را در تنظیمات، یکپارچه‌سازی‌ها، CalDAV بیفزایید. در غیر این صورت همگام‌سازی را غیرفعال کنید و با نشانی درست دوباره متصل شوید.';
$lang['caldav_sync_failed_credentials'] = 'سرور CalDAV نام کاربری و گذرواژه را نپذیرفت. همگام‌سازی را غیرفعال کنید و با اطلاعات درست دوباره متصل شوید.';
$lang['caldav_sync_failed_unreachable'] = 'دسترسی به سرور CalDAV ممکن نشد. مطمئن شوید که در حال اجراست و نشانی اتصال درست است.';
$lang['caldav_private_host_warning'] = 'این سرور در یک شبکه خصوصی است. با اتصال، میزبان آن به نشانی‌های اتصال مجاز افزوده می‌شود.';
$lang['caldav_allow_host_and_connect'] = 'اجازه بده و متصل شو';
// End
