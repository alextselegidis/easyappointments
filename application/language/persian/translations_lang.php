...
$lang['about_app'] = 'درباره Car2dude';
...
$lang['about_app_info'] = 'Car2dude یک نرم افزار تحت وب با قابلیت سفارشی سازی بسیار بالاست که به مشتریان شما امکان می دهد از طریق وب قرار ملاقات با شما را رزرو کنند. علاوه بر این ، توانایی همگام سازی داده های شما با Google Calendar را فراهم می کند ، بنابراین می توانید از آنها در سایر سرویس ها استفاده کنید.';
$lang['current_version'] = 'نسخه فعلی';
$lang['support'] = 'پشتیبانی';
$lang['about_app_support'] = 'اگر هنگام استفاده از Car2dude با مشکلی روبرو شدید می توانید در گروه رسمی Google برای یافتن پاسخ جستجو کنید. همچنین برای کمک به پیشرفت در این زمینه ممکن است لازم باشد یک Issue جدید در صفحه Google Code ایجاد کنید.';
...
$lang['about_app_license'] = 'Car2dude تحت مجوز GPLv3 منتشر شده است. با استفاده از کد این نرم افزار به هر شکل، شما با قوانین موجود در لینک زیر موافقت می کنید ';
...
$lang['ea_update_success'] = 'Car2dude با موفقیت به روز رسانی شد';
