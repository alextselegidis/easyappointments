...
$lang['thank_you_for_appointment'] =
    'Благодарим за оформление встречи с нами. Ниже вы сможете увидеть сведения о встречах. Можете делать изменения, нажав на ссылку назначения.';
...
$lang['appointment_does_not_exist_in_db'] =
    'Назначение которое вы запросили в нашей базе данных вообще-то отсутствует.';
...
$lang['select_filter_item_hint'] =
    'Выберите поставщика или услугу и просматривайте соответствующее назначения в календаре.';
...
$lang['unavailability_periods_hint'] =
    'На протяжении недоступного периода исполнитель не будет принимать новые назначения.';
...
$lang['add_breaks_during_each_day'] =
    'Добавить рабочий перерыв для каждого рабочего дня.Во время перерывов исполнитель не сможет принимать какие-либо назначения.';
$lang['day'] = 'День';
$lang['days'] = 'Дней';
...
$lang['company_email_hint'] =
    'Здесь должен быть e-mail компании. Он будет использован для отправки ответов адресам (написать обязательно).';
$lang['company_link'] = 'Сайт';
$lang['company_link_hint'] =
    'Сайт компании должен указывать на официальную страницу в интернете (написать обязательно).';
...
$lang['edit_breaks_hint'] =
    'Укажите рабочие перерывы на каждый день. Эти перерывы не применяются для всех новых исполнителей.';
$lang['book_advance_timeout'] = 'Время ожидания перед заказом';
$lang['book_advance_timeout_hint'] =
    'Определить перерыв (в минутах) до того как заказчик сделает заказ или переназначит назначение в компании.';
$lang['timeout_minutes'] = 'Время вышло (минут)';
$lang['about_app_info'] =
    'Easy!Appointments хорошо настраиваемое веб приложение которое позволяет вашим заказчикам оформлять время предоставления услуг через интернет. Кроме того, имеется возможность синхронизации с вашими Google-календарями так что вы сможете использовать план заказанных мероприятий.';
$lang['current_version'] = 'Текущая версия';
$lang['support'] = 'Поддержка';
$lang['about_app_support'] =
    'Если произошли проблемы с использованием Easy!Appointments вы можете использовать официальную Google группу для поиска ответа. Вы можете также создать новый запрос на странице проекта в Google Code вопрос на странице Google Code для того, чтобы помочь проекту развиватся.';
...
$lang['about_app_license'] =
    'Easy!Appointments обладает лицензией GPLv3. При использовании кода приложения в любом случае вы соглашаетесь с условиями, описанными в следующей URL:';
...
$lang['type_username_and_email_for_new_password'] =
    'Введите ваш логин или E-mail адрес и мы отправим на вашу почту ваш пароль.';
...
$lang['new_password_is'] =
    'Ваш новый пароль: $password. Пожалуйста сохраните его чтобы  если будет необходимо его вспомнить. Вы можете сменить его в кабинете на странице настроек.';
...
$lang['page_not_found_message'] =
    'К сожалению страница, которую вы запросили, не существует. Пожалуйста проверьте запрос в строке браузера или перейдите по ссылке используя меню и кнопки сайта.';
$lang['error'] = 'Ошибка';
$lang['no_privileges'] = 'Отсутствуют необходимые привилегии';
$lang['no_privileges_message'] =
    'Вы не имеете необходимых разрешений на просмотр этой страницы. Пожалуйста используйте другие разделы.';
...
$lang['user_settings_are_invalid'] =
    'Настройки пользователя недействительны! Пожалуйста проверьте настройки и повторите заново.';
...
$lang['select_google_calendar_prompt'] =
    'Выберите календарь который вы хотите синхронизировать с вашими назначениями. Если вы не выберите будет использован ваш Google-календарь по умолчанию.';
...
$lang['require_captcha_hint'] =
    'Если эта функция включена - клиенты должны будут ввести случайно сгенерированную строку CAPTCHA перед бронированием/обновлением записи на прием.';
...
$lang['requested_hour_is_unavailable'] =
    'Запрашиваемая встреча, к сожалению, недоступна. Пожалуйста, выберите другой час для приема.';
$lang['customer_notifications'] = 'Уведомления клиентов';
$lang['customer_notifications_hint'] =
    'Определяет, будет ли клиент получать уведомления по электронной почте при изменении расписания одной из его встреч.';
...
$lang['google_analytics_code_hint'] =
    'Добавьте свой идентификатор ID Google Аналитики для включения в страницу бронирования.';
...
$lang['website_using_cookies_to_ensure_best_experience'] =
    'Этот сайт использует файлы cookie, чтобы обеспечить вам наилучшие впечатления от использования нашего сайта.';
...
$lang['delete_personal_information_prompt'] =
    'Вы уверены, что хотите удалить свою личную информацию? Это действие нельзя отменить.';
...
$lang['require_phone_number_hint'] =
    'Когда эта функция включена, клиентам и пользователям необходимо будет ввести номер телефона клиента при бронировании встречи';
$lang['check_spam_folder'] = 'Пожалуйста, проверьте папку спама, если письмо не пришло в течение нескольких минут.';
$lang['api_token_hint'] =
    'Установите секретный токен, чтобы включить аутентификацию на основе токена в Easy!Appointments API.';
$lang['timezone'] = 'Часовой пояс';
$lang['overwrite_existing_working_plans'] =
    'Это перезапишет существующие рабочие планы поставщика - Вы уверены что хотите продолжить?';
...
$lang['display_any_provider_hint'] =
    'На странице бронирования появится дополнительная опция, позволяющая клиентам бронировать без указания поставщика услуг.';
...
$lang['matomo_analytics_url_hint'] =
    'Добавьте URL в собственную установку Matomo, чтобы включить отслеживание Matomo на страницах бронирования.';
...
$lang['disable_booking_hint'] =
    'Пока эта настройка активна, страница бронирования будет отключена, и клиенты не смогут регистрировать новые встречи.';
...
$lang['company_logo_hint'] =
    'Логотип компании будет отображаться во многих местах приложения, включая страницу бронирования и электронные письма с уведомлениями (файл изображения, не более 2 МБ).';
$lang['company_color'] = 'Цвет компании';
$lang['company_color_hint'] =
    'Фирменный цвет будет использоваться во всем приложении, чтобы оно использовало ваш брендинг.';
...
$lang['private_hint'] =
    'Частные записи не будут отображаться или обрабатываться на публичных страницах, таких как страница бронирования.';
$lang['reset'] = 'Сброс';
$lang['all'] = 'Все';
...
$lang['limit_customer_access_hint'] =
    'Если эта функция включена, поставщики и секретари смогут получить доступ только к тем клиентам, с которыми у них назначена встреча.';
$lang['url'] = 'URL';
...
$lang['webhooks_info'] =
    'Webhooks позволяют отправлять HTTP-уведомления внешним веб-приложениям в ответ на различные события приложения, такие как создание записи на прием или удаление клиента.';
...
$lang['google_analytics_info'] =
    'Google Аналитика позволяет автоматически добавлять код отслеживания и HTML-разметку на публичную страницу и отслеживать все публичные сеансы бронирования.';
$lang['matomo_analytics'] = 'Matomo Аналитика';
$lang['matomo_analytics_info'] =
    'Matomo Аналитика позволяет автоматически добавлять код отслеживания и HTML-разметку на публичную страницу и отслеживать все публичные сеансы бронирования.';
$lang['api'] = 'API';
$lang['api_info'] =
    'API позволяют вам взаимодействовать со всеми данными Easy!Appointments через протокол HTTP и доступные конечные точки API и создавать собственные интеграции.';
...
$lang['future_booking_limit_hint'] =
    'Установите будущее ограничение в днях, в течение которых клиенты могут назначать встречи через публичную страницу бронирования.';
...
$lang['appointment_status_options_info'] =
    'Определите список доступных вариантов статуса встречи, которые могут быть использованы на странице календаря (первый из них автоматически станет значением по умолчанию).';
