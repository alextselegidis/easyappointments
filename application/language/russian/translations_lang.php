...
$lang['require_captcha_hint'] = 'Если этот параметр включен, клиенты должны будут столкнуться с проблемой CAPTCHA перед бронированием / обновлением встречи, чтобы доказать, что они не робот.';
$lang['none'] = 'Нет';
$lang['recaptcha_server_token'] = 'Серверный токен reCAPTCHA';
$lang['recaptcha_client_token'] = 'клиентский токен reCAPTCHA';
$lang['recaptcha_hint'] = 'Перейдите на сайт администратора google recaptcha, чтобы настроить домен reCAPTCHA v2 и получить токены сервера и клиента.';
$lang['recaptcha_warning'] = 'Вы несете ответственность за надлежащее обновление своей политики конфиденциальности в соответствии с местными законами при использовании reCAPTCHA!';
