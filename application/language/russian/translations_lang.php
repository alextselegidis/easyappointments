...
$lang['notes'] = 'Заметки';
$lang['language'] = 'Язык';
$lang['no_language'] = 'Язык отсутствует';
...
$lang['customer_notifications'] = 'Оповещения клиентов';
...
$lang['google_analytics_code_hint'] = 'Добавьте свой идентификатор Google Analytics ID для включения в страницу бронирования.';
...
$lang['reset_working_plan'] = 'Верните рабочий план к значениям по умолчанию.';
$lang['legal_contents'] = 'Правовое наполнение';
$lang['cookie_notice'] = 'Уведомление о cookie-файлах';
$lang['display_cookie_notice'] = 'Уведомление о cookie-файлах для отображения';
$lang['cookie_notice_content'] = 'Содержание уведомления о файлах cookie';
$lang['terms_and_conditions'] = 'Условия и положения';
$lang['display_terms_and_conditions'] = 'Отображение условий и положений';
$lang['terms_and_conditions_content'] = 'Содержание условий и положений';
$lang['privacy_policy'] = 'Политика приватности';
$lang['display_privacy_policy'] = 'Показать политику приватности';
$lang['privacy_policy_content'] = 'Содержание политики приватности';
$lang['website_using_cookies_to_ensure_best_experience'] = 'Этот веб-сайт использует файлы cookie, чтобы обеспечить вам наилучший режим работы на нашем веб-сайте.';
$lang['read_and_agree_to_terms_and_conditions'] = 'Я прочитал и согласен с {$link}Условиями и положениями {/$link}.';
$lang['read_and_agree_to_privacy_policy'] = 'Я прочитал и согласен с {$link}Политикой конфиденциальности{/$link}.';
$lang['delete_personal_information_hint'] = 'Удалите все ваши встречи и личную информацию из системы.';
$lang['delete_personal_information'] = 'Удалить личную информацию';
$lang['delete_personal_information_prompt'] = 'Вы уверены, что хотите удалить свою личную информацию? Это действие не может быть отменено.';
...
$lang['working_plan_exceptions_hint'] = 'Добавьте день исключения из рабочего плана, вне рабочего плана.';
$lang['new_working_plan_exception_title'] = 'Новое исключение из рабочего плана';
...
$lang['add_working_plan_exceptions_during_each_day'] = 'Добавить исключения из рабочего плана за пределами рабочего плана.';
$lang['add_working_plan_exception'] = 'Добавить исключение из рабочего плана';
$lang['require_phone_number'] = 'Требуется номер телефона';
$lang['require_phone_number_hint'] = 'Если эта функция включена, клиентам и пользователям необходимо будет ввести номер телефона клиента при записи на прием';
$lang['check_spam_folder'] = 'Пожалуйста, проверьте свою папку со спамом, если электронное письмо не придет в течение нескольких минут.';
$lang['api_token_hint'] = 'Установите секретный токен, чтобы включить аутентификацию на основе токенов API Easy!Appointments.';
$lang['timezone'] = 'Часовой пояс';
$lang['overwrite_existing_working_plans'] = 'Это отменит существующие рабочие планы поставщиков, вы уверены, что хотите продолжать?';
...
$lang['display_any_provider'] = 'Отобразить любой параметр поставщика услуг';
