...
$lang['cancel_appointment_hint'] = 'Нажмите кнопку "Отмена назначения" для удаления назначения из расписания компании.';
...
$lang['enter_password_here'] = 'Введите пароль здесь ...';
$lang['login'] = 'Войти';
...
$lang['unexpected_issues_message'] = 'Операция не могла быть завершена.';
$lang['close'] = 'Закрыть';
...
$lang['enter_captcha_here'] = 'Введите CAPTCHA здесь...';
...
$lang['secret_header'] = 'Секретный заголовок';
$lang['search'] = 'Поиск';
$lang['slot_interval'] = 'Интервал слотов (минуты)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Включить автоматическое создание ссылок на конференции Jitsi для записей. При включении для каждой записи будет создана уникальная ссылка на видеозвонок Jitsi.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA — это ориентированная на конфиденциальность альтернатива CAPTCHA с открытым исходным кодом, которая использует proof-of-work для проверки пользователей без отслеживания.';
$lang['altcha_enabled_hint'] = 'При включении ALTCHA будет использоваться вместо традиционной графической CAPTCHA для проверки форм.';
$lang['altcha_hmac_key'] = 'Ключ HMAC';
$lang['altcha_hmac_key_hint'] = 'Секретный ключ, используемый для подписи и проверки вызовов ALTCHA. Нажмите «Сгенерировать» для создания нового безопасного ключа.';
$lang['altcha_max_number'] = 'Максимальное число';
$lang['altcha_max_number_hint'] = 'Максимальное число для задачи proof-of-work. Более высокие значения увеличивают сложность (по умолчанию: 100000).';
$lang['altcha_expires'] = 'Срок действия (секунды)';
$lang['altcha_expires_hint'] = 'Время действия вызова в секундах (по умолчанию: 300).';
$lang['altcha_key_generated'] = 'Новый ключ HMAC успешно сгенерирован.';
$lang['altcha_enabled'] = 'Включить ALTCHA';
$lang['altcha_captcha_not_active_warning'] = 'Настройка CAPTCHA в данный момент не активна. ALTCHA не будет использоваться, пока CAPTCHA не будет включена в';
$lang['generate'] = 'Сгенерировать';
$lang['meeting_link'] = 'Ссылка на встречу';
$lang['google_calendar'] = 'Google Календарь';
$lang['google_calendar_info'] = 'Включите синхронизацию с Google Calendar для синхронизации записей с аккаунтами Google Calendar специалистов.';
$lang['google_client_id'] = 'Client ID';
$lang['google_client_id_info'] = 'Client ID из вашего проекта Google Cloud Console.';
$lang['google_client_secret'] = 'Client Secret';
$lang['google_client_secret_info'] = 'Client Secret из вашего проекта Google Cloud Console.';
$lang['google_calendar_setup_info'] = 'Для включения синхронизации с Google Calendar необходимо создать проект в Google Cloud Console, включить Google Calendar API и создать учётные данные OAuth 2.0. Перейдите по ссылке:';
$lang['google_meet_link_generation'] = 'Генерация ссылок Google Meet';
$lang['google_meet_link_generation_info'] = 'Автоматически создавать ссылку на видеоконференцию Google Meet для синхронизированных записей. Ссылка на встречу будет сохранена в поле ссылки на встречу записи.';
$lang['display_add_to_google_calendar'] = 'Показать кнопку "Добавить в Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Показывать кнопку "Добавить в Google Calendar" на странице подтверждения бронирования, позволяя клиентам легко добавить запись в свой личный Google Calendar.';
$lang['select_all'] = 'Выбрать все';
$lang['select_none'] = 'Снять выделение';
$lang['appointment_update'] = 'Обновление записи';
$lang['notify_users_on_update_question'] = 'Хотите отправить уведомление об этом изменении?';
$lang['yes'] = 'Да';
$lang['no'] = 'Нет';
$lang['latest_blog_posts'] = 'Последние записи в блоге';
$lang['loading'] = 'Загрузка';
$lang['blog_posts_load_error'] = 'Не удалось загрузить записи блога. Посетите официальный сайт для получения обновлений.';
...
$lang['would_you_like_to_proceed'] = 'Вы хотите продолжить?';
$lang['proceed'] = 'Продолжить';
$lang['no_available_service_providers'] = 'Нет доступных услуг';
$lang['no_available_service_providers_message'] = 'В настоящее время нет доступных услуг или поставщиков для бронирования. Пожалуйста, проверьте позже или свяжитесь с нами для получения помощи.';
$lang['reset_password'] = 'Сбросить пароль';
$lang['new_password'] = 'Новый пароль';
$lang['enter_new_password'] = 'Введите новый пароль ниже.';
$lang['password_reset_request'] = 'Запрос на сброс пароля';
$lang['password_reset_email_message'] = 'Вы запросили сброс пароля. Нажмите кнопку ниже, чтобы установить новый пароль для вашей учетной записи.';
$lang['password_reset_link_expires'] = 'Эта ссылка истечет через 1 час.';
$lang['password_reset_ignore_message'] = 'Если вы не запрашивали сброс пароля, пожалуйста, проигнорируйте это письмо.';
$lang['invalid_reset_token'] = 'Ссылка для сброса пароля недействительна.';
$lang['invalid_or_expired_token'] = 'Ссылка для сброса пароля недействительна или устарела. Пожалуйста, запросите новую.';
$lang['password_reset_success'] = 'Ваш пароль успешно сброшен. Вы будете перенаправлены на страницу входа.';
$lang['password_reset_failed'] = 'Сброс пароля не удался. Пожалуйста, попробуйте снова.';
$lang['no_password_provided'] = 'Пожалуйста, введите пароль.';
$lang['type_username_and_email_for_reset_link'] = 'Введите имя пользователя и адрес электронной почты, чтобы получить ссылку для сброса пароля.';
...
$lang['working_plan_validation_failed'] = 'Обнаружена недопустимая конфигурация рабочего плана.';
$lang['start_date'] = 'Дата начала';
$lang['end_date'] = 'Дата окончания';
$lang['remember_me'] = 'Запомнить мои данные';
$lang['remember_me_hint'] = 'Сохранить ваши данные для более быстрого бронирования в следующий раз.';
$lang['legal_notice'] = 'Правовая информация';
$lang['legal_notice_url'] = 'URL правовой информации';
$lang['legal_notice_url_hint'] = 'Введите URL страницы правовой информации.';
$lang['imprint'] = 'Импрессум';
$lang['imprint_url'] = 'URL импрессума';
$lang['imprint_url_hint'] = 'Введите URL страницы импрессума.';
$lang['data_retention'] = 'Хранение данных';
$lang['data_retention_days'] = 'Срок хранения данных (дни)';
$lang['data_retention_days_hint'] = 'Укажите количество дней, после которых данные клиентов будут автоматически удалены. Установите 0 для отключения автоматического удаления.';
$lang['manage_privacy'] = 'Управление конфиденциальностью';
$lang['manage_privacy_hint'] = 'Нажмите на ссылку ниже, чтобы просмотреть, обновить или удалить вашу личную информацию.';
$lang['personal_information_updated'] = 'Ваша личная информация была успешно обновлена.';
$lang['verify'] = 'Подтвердить';
$lang['verifying'] = 'Проверка';
$lang['verified'] = 'Подтверждено';
$lang['verification_complete'] = 'Проверка завершена';
$lang['verification_failed'] = 'Проверка не удалась. Нажмите, чтобы повторить.';
$lang['click_to_verify'] = 'Нажмите для подтверждения, что вы человек';
$lang['altcha_verification_failed'] = 'Проверка ALTCHA не удалась. Пожалуйста, попробуйте снова.';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = 'Мы предлагаем комплексные услуги для самостоятельно размещаемого программного обеспечения, включая индивидуальную разработку, управляемый хостинг, контракты на поддержку, ребрендинг и постоянные улучшения — чтобы вы могли сосредоточиться на своём бизнесе, пока мы позаботимся обо всём остальном.';
...
$lang['invalid_price'] = 'Неверная цена.';
$lang['invalid_slot_interval'] = 'Неверный интервал слотов.';
$lang['invalid_attendants_number'] = 'Неверное количество обслуживающего персонала.';
$lang['scheduling_conflict'] = 'Конфликт расписания';
$lang['invalid_time'] = 'Неверное время.';
$lang['service_and_provider_missing'] = 'Пожалуйста выберите услугу и исполнителя перед продолжением.';
$lang['caldav'] = 'CalDAV';
$lang['caldav_info'] = 'Синхронизируйте записи ваших специалистов с сервером календарей CalDAV и укажите, к каким узлам синхронизации разрешено подключаться.';
$lang['caldav_allowed_hosts'] = 'Разрешённые адреса подключения';
$lang['caldav_allowed_hosts_info'] = 'Адреса CalDAV, указывающие на частный или зарезервированный сетевой адрес, отклоняются, чтобы адрес, введённый в панели управления, не мог обратиться во внутреннюю сеть этой установки. Добавьте по одному адресу подключения или имени узла в строке, чтобы всё же разрешить его. Добавляйте только те серверы, которыми управляете сами.';
$lang['caldav_sync_failed'] = 'Синхронизация CalDAV не удалась';
$lang['caldav_sync_failed_url'] = 'Не удалось использовать сохранённый адрес подключения. Если ваш сервер CalDAV работает в локальной сети, добавьте его адрес в разделе Настройки, Интеграции, CalDAV. Иначе отключите синхронизацию и подключитесь заново с правильным адресом.';
$lang['caldav_sync_failed_credentials'] = 'Сервер CalDAV отклонил имя пользователя и пароль. Отключите синхронизацию и подключитесь заново с правильными учётными данными.';
$lang['caldav_sync_failed_unreachable'] = 'Не удалось связаться с сервером CalDAV. Убедитесь, что он работает и что адрес подключения указан верно.';
$lang['caldav_private_host_warning'] = 'Этот сервер находится в частной сети. При подключении его узел будет добавлен в разрешённые адреса подключения.';
$lang['caldav_allow_host_and_connect'] = 'Разрешить и подключиться';
// End
