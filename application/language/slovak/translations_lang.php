...
$lang['cancel_appointment_hint'] = 'Stlačte tlačidlo "Zrušiť rezerváciu" pre odstránenie Vašej rezervácie.';
$lang['cancel'] = 'Zrušiť';
...
$lang['appointment_locked_message'] = 'Rezerváciu nie je možné zmeniť menej ako {$limit} hodín vopred.';
...
$lang['disable_sync_prompt'] = 'Ste si istí, že chcete vypnúť synchronizáciu kalendára?';
$lang['reload'] = 'Obnoviť';
...
$lang['invalid_duration'] = 'Neplatné trvanie.';
...
$lang['enter_password_here'] = 'Zadajte heslo tu ...';
...
$lang['unexpected_issues_message'] = 'Operáciu sa nepodarilo dokončiť.';
$lang['close'] = 'Zatvoriť';
...
$lang['personal_information'] = 'Osobné údaje';
...
$lang['enter_captcha_here'] = 'Zadajte CAPTCHA tu...';
...
$lang['time_format_hint'] = 'Zmeniť formát zobrazenia času (H - Hodiny, M - Minúty).';
...
$lang['read_and_agree_to_terms_and_conditions'] = 'Prečítal som si a súhlasím so {$link}zmluvnými podmienkami{/$link}.';
...
$lang['search'] = 'Hľadať';
$lang['slot_interval'] = 'Interval slotov (minúty)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Povoliť automatické generovanie odkazov na stretnutia Jitsi pre rezervácie. Po povolení bude pre každú rezerváciu vytvorený jedinečný odkaz na videohovor Jitsi.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA je alternatíva CAPTCHA zameraná na súkromie s otvoreným zdrojovým kódom, ktorá používa proof-of-work na overenie používateľov bez sledovania.';
$lang['altcha_enabled_hint'] = 'Po povolení bude ALTCHA použitá namiesto tradičnej obrázkkovej CAPTCHA na overenie formulárov.';
$lang['altcha_hmac_key'] = 'Kľúč HMAC';
$lang['altcha_hmac_key_hint'] = 'Tajný kľúč používaný na podpisovanie a overovanie výziev ALTCHA. Kliknite na Generovať pre vytvorenie nového bezpečného kľúča.';
$lang['altcha_max_number'] = 'Maximálne číslo';
$lang['altcha_max_number_hint'] = 'Maximálne číslo pre výzvu proof-of-work. Vyššie hodnoty zvyšujú obtiažnosť (predvolené: 100000).';
$lang['altcha_expires'] = 'Platnosť (sekundy)';
$lang['altcha_expires_hint'] = 'Doba platnosti výzvy v sekundách (predvolené: 300).';
$lang['altcha_key_generated'] = 'Nový kľúč HMAC bol úspešne vygenerovaný.';
$lang['altcha_enabled'] = 'Povoliť ALTCHA';
$lang['altcha_captcha_not_active_warning'] = 'Nastavenie CAPTCHA nie je momentálne aktívne. ALTCHA sa nepoužije, pokiaľ nie je CAPTCHA povolená v';
$lang['generate'] = 'Generovať';
$lang['meeting_link'] = 'Odkaz na stretnutie';
$lang['google_calendar'] = 'Kalendár Google';
$lang['google_calendar_info'] = 'Povoliť synchronizáciu s Google Calendar pre synchronizáciu rezervácií s účtami Google Calendar poskytovateľov.';
$lang['google_client_id'] = 'Client ID';
$lang['google_client_id_info'] = 'Client ID z vášho projektu Google Cloud Console.';
$lang['google_client_secret'] = 'Client Secret';
$lang['google_client_secret_info'] = 'Client Secret z vášho projektu Google Cloud Console.';
$lang['google_calendar_setup_info'] = 'Pre povolenie synchronizácie s Google Calendar musíte vytvoriť projekt v Google Cloud Console, povoliť Google Calendar API a vytvoriť prihlasovacie údaje OAuth 2.0. Navštívte:';
$lang['google_meet_link_generation'] = 'Generovať odkazy Google Meet';
$lang['google_meet_link_generation_info'] = 'Automaticky vytvoriť odkaz na videokonferenciu Google Meet pre synchronizované rezervácie. Odkaz na stretnutie bude uložený v poli odkazu na stretnutie rezervácie.';
$lang['display_add_to_google_calendar'] = 'Zobraziť tlačidlo "Pridať do Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Zobraziť tlačidlo "Pridať do Google Calendar" na stránke potvrdenia rezervácie, ktoré zákazníkom umožní jednoducho pridať rezerváciu do ich osobného Google Calendar.';
$lang['select_all'] = 'Vybrať všetko';
$lang['select_none'] = 'Zrušiť výber';
$lang['appointment_update'] = 'Aktualizácia stretnutia';
$lang['notify_users_on_update_question'] = 'Chcete odoslať upozornenie o tejto zmene?';
$lang['yes'] = 'Áno';
$lang['no'] = 'Nie';
$lang['latest_blog_posts'] = 'Najnovšie príspevky na blogu';
$lang['loading'] = 'Načítava sa';
$lang['blog_posts_load_error'] = 'Nepodarilo sa načítať príspevky blogu. Navštívte oficiálnu stránku pre aktualizácie.';
...
$lang['would_you_like_to_proceed'] = 'Chcete napriek tomu pokračovať?';
$lang['proceed'] = 'Pokračovať';
$lang['no_available_service_providers'] = 'Žiadne dostupné služby';
$lang['no_available_service_providers_message'] = 'V súčasnosti nie sú k dispozícii žiadne služby ani poskytovatelia na rezerváciu. Skontrolujte neskôr alebo nás kontaktujte pre pomoc.';
$lang['reset_password'] = 'Obnoviť heslo';
$lang['new_password'] = 'Nové heslo';
$lang['enter_new_password'] = 'Nižšie zadajte svoje nové heslo.';
$lang['password_reset_request'] = 'Žiadosť o obnovenie hesla';
$lang['password_reset_email_message'] = 'Požiadali ste o obnovenie hesla. Kliknutím na tlačidlo nižšie nastavíte nové heslo pre svoj účet.';
$lang['password_reset_link_expires'] = 'Tento odkaz vyprší o 1 hodinu.';
$lang['password_reset_ignore_message'] = 'Ak ste nepožiadali o obnovenie hesla, prosím, ignorujte tento e-mail.';
$lang['invalid_reset_token'] = 'Odkaz na obnovenie hesla je neplatný.';
$lang['invalid_or_expired_token'] = 'Odkaz na obnovenie hesla je neplatný alebo vypršal. Požiadajte prosím o nový.';
$lang['password_reset_success'] = 'Vaše heslo bolo úspešne obnovené. Budete presmerovaní na prihlasovaciu stránku.';
$lang['password_reset_failed'] = 'Obnovenie hesla zlyhalo. Skúste to prosím znova.';
$lang['no_password_provided'] = 'Prosím, zadajte heslo.';
$lang['type_username_and_email_for_reset_link'] = 'Zadajte svoje používateľské meno a e-mailovú adresu pre získanie odkazu na obnovenie hesla.';
$lang['send_reset_link'] = 'Odoslať odkaz na obnovenie';
...
$lang['working_plan_validation_failed'] = 'Nájdená neplatná konfigurácia pracovného plánu.';
$lang['start_date'] = 'Dátum začiatku';
$lang['end_date'] = 'Dátum konca';
$lang['remember_me'] = 'Zapamätať si moje údaje';
$lang['remember_me_hint'] = 'Uložiť vaše údaje pre rýchlejšiu rezerváciu nabudúce.';
$lang['legal_notice'] = 'Právne upozornenie';
$lang['legal_notice_url'] = 'URL právneho upozornenia';
$lang['legal_notice_url_hint'] = 'Zadajte URL stránky s právnym upozornením.';
$lang['imprint'] = 'Impressum';
$lang['imprint_url'] = 'URL impressum';
$lang['imprint_url_hint'] = 'Zadajte URL stránky s impressum.';
$lang['data_retention'] = 'Uchovávanie údajov';
$lang['data_retention_days'] = 'Doba uchovávania údajov (dni)';
$lang['data_retention_days_hint'] = 'Nastavte počet dní, po ktorých budú údaje zákazníkov automaticky vymazané. Nastavte 0 pre vypnutie automatického mazania.';
$lang['manage_privacy'] = 'Správa súkromia';
$lang['manage_privacy_hint'] = 'Kliknite na odkaz nižšie pre zobrazenie, aktualizáciu alebo vymazanie vašich osobných údajov.';
$lang['personal_information_updated'] = 'Vaše osobné údaje boli úspešne aktualizované.';
$lang['verify'] = 'Overiť';
$lang['verifying'] = 'Overovanie';
$lang['verified'] = 'Overené';
$lang['verification_complete'] = 'Overenie dokončené';
$lang['verification_failed'] = 'Overenie zlyhalo. Kliknite pre zopakovanie.';
$lang['click_to_verify'] = 'Kliknite pre overenie, že ste človek';
$lang['altcha_verification_failed'] = 'Overenie ALTCHA zlyhalo. Skúste to prosím znova.';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = 'Ponúkame komplexné služby pre self-hosted softvér, vrátane vlastného vývoja, spravovaného hostingu, servisných zmlúv, rebrandingu a priebežných vylepšení — aby ste sa mohli sústrediť na svoje podnikanie, zatiaľ čo my sa postaráme o zvyšok.';
...
$lang['caldav'] = 'CalDAV';
$lang['caldav_info'] = 'Synchronizujte stretnutia svojich poskytovateľov so serverom kalendára CalDAV a určte, ku ktorým hostiteľom sa synchronizácia smie pripojiť.';
$lang['caldav_allowed_hosts'] = 'Povolené adresy pripojenia';
$lang['caldav_allowed_hosts_info'] = 'Adresy CalDAV, ktoré smerujú na súkromnú alebo vyhradenú sieťovú adresu, sa odmietajú, aby sa adresa zadaná v správe nedostala do vnútornej siete tejto inštalácie. Pridajte jednu adresu pripojenia alebo názov hostiteľa na riadok, ak ju chcete napriek tomu povoliť. Pridávajte iba servery, ktoré sami prevádzkujete.';
$lang['caldav_sync_failed'] = 'Synchronizácia CalDAV zlyhala';
$lang['caldav_sync_failed_url'] = 'Uloženú adresu pripojenia sa nepodarilo použiť. Ak váš server CalDAV beží v lokálnej sieti, pridajte jeho adresu v Nastaveniach, Integrácie, CalDAV. Inak synchronizáciu vypnite a pripojte sa znova so správnou adresou.';
$lang['caldav_sync_failed_credentials'] = 'Server CalDAV odmietol používateľské meno a heslo. Vypnite synchronizáciu a pripojte sa znova so správnymi prihlasovacími údajmi.';
$lang['caldav_sync_failed_unreachable'] = 'Server CalDAV sa nepodarilo kontaktovať. Skontrolujte, či beží a či je adresa pripojenia správna.';
$lang['caldav_private_host_warning'] = 'Tento server je v súkromnej sieti. Pripojením sa jeho hostiteľ pridá medzi povolené adresy pripojenia.';
$lang['caldav_allow_host_and_connect'] = 'Povoliť a pripojiť';
// End
