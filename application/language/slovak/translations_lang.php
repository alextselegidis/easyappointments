...
$lang['require_captcha_hint'] = 'Ak je táto možnosť povolená, zákazníci budú musieť pred rezerváciou / aktualizáciou stretnutia čeliť výzve CAPTCHA, aby dokázali, že nie sú robot.';
$lang['none'] = 'Žiadne';
$lang['recaptcha_server_token'] = 'reCAPTCHA serverový token';
$lang['recaptcha_client_token'] = 'klientský token reCAPTCHA';
$lang['recaptcha_hint'] = 'Prosím, choďte na administrátorskú webovú stránku google recaptcha, aby ste nastavili doménu reCAPTCHA v2 a dostali svoj server a klientske tokeny.';
$lang['recaptcha_warning'] = 'Ste zodpovední za náležitú aktualizáciu svojich zásad ochrany osobných údajov tak, aby boli v súlade s miestnymi zákonmi pri používaní reCAPTCHA!';
