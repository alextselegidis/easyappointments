...
$lang['update'] = 'Update';
$lang['cancel_appointment_hint'] = 'Press the "Cancel Appointment" button to remove the appointment from the company schedule.';
$lang['cancel'] = 'Cancel';
...
$lang['start_date_before_end_error'] = 'Start date value is later than end date.';
...
$lang['unexpected_issues_message'] = 'The operation could not be completed.';
$lang['close'] = 'Close';
...
$lang['appointment_status_options_info'] = 'Define a list of available appointment status options that can be used in the calendar page (the first one will automatically become the default value).';
