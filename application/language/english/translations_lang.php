...
$lang['about_app_info'] = 'Car2dude is a highly customizable web application that allows your customers to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using Car2dude you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'Car2dude is licensed under the GPLv3 license. By using the code of Car2dude in any way you are agreeing to the terms described in the following url:';
...
$lang['ea_update_success'] = 'Car2dude has been successfully updated.';
