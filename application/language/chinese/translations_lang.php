...
$lang['confirm'] = '确认';
$lang['update'] = '更新';
$lang['cancel_appointment_hint'] = '点击「取消预约」可从公司时间表移除预约。';
$lang['cancel'] = '取消';
...
$lang['enter_password_here'] = '在此输入密码 ...';
$lang['login'] = '登陆';
...
$lang['unexpected_issues_message'] = '操作无法完成。';
$lang['close'] = '关闭';
...
$lang['enter_captcha_here'] = '在此输入 CAPTCHA...';
...
$lang['search'] = '搜索';
$lang['slot_interval'] = '时段间隔（分钟）';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = '启用自动生成 Jitsi 会议链接功能。启用后，系统将自动生成唯一的 Jitsi 视频通话链接并存储为会议链接。';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA 是一个注重隐私的开源 CAPTCHA 替代方案，使用工作量证明来验证真实用户，无需跟踪。';
$lang['altcha_enabled_hint'] = '启用后，将使用 ALTCHA 替代传统的图片 CAPTCHA 进行表单验证。';
$lang['altcha_hmac_key'] = 'HMAC 密钥';
$lang['altcha_hmac_key_hint'] = '用于签名和验证 ALTCHA 挑战的密钥。点击生成以创建新的安全密钥。';
$lang['altcha_max_number'] = '最大数字';
$lang['altcha_max_number_hint'] = '工作量证明挑战的最大数字。数值越高难度越大（默认值：100000）。';
$lang['altcha_expires'] = '过期时间（秒）';
...
$lang['google_calendar_info'] = '启用 Google Calendar 同步，将预约与服务提供者的 Google Calendar 账户同步。';
$lang['google_client_id'] = '客户端 ID';
$lang['google_client_id_info'] = '来自您的 Google Cloud Console 项目的客户端 ID。';
$lang['google_client_secret'] = '客户端密钥';
$lang['google_client_secret_info'] = '来自您的 Google Cloud Console 项目的客户端密钥。';
$lang['google_calendar_setup_info'] = '要启用 Google Calendar 同步，您需要在 Google Cloud Console 中创建项目、启用 Google Calendar API 并创建 OAuth 2.0 凭据。请访问：';
$lang['google_meet_link_generation'] = '生成 Google Meet 链接';
$lang['google_meet_link_generation_info'] = '自动为同步的预约创建 Google Meet 视频会议链接。会议链接将存储在预约的会议链接字段中。';
$lang['display_add_to_google_calendar'] = '显示"添加到 Google Calendar"按钮';
$lang['display_add_to_google_calendar_info'] = '在预约确认页面显示"添加到 Google Calendar"按钮，方便客户将预约轻松添加到个人 Google Calendar。';
$lang['select_all'] = '全选';
$lang['select_none'] = '取消全选';
$lang['appointment_update'] = '预约更新';
$lang['notify_users_on_update_question'] = '您想发送关于此更改的通知吗？';
$lang['yes'] = '是';
$lang['no'] = '否';
$lang['latest_blog_posts'] = '最新博客文章';
$lang['loading'] = '加载中';
$lang['blog_posts_load_error'] = '无法加载博客文章。请访问官方网站获取更新。';
$lang['provider_has_conflicting_appointment'] = '所选服务提供者在该时间已有其他预约。请选择其他时间或服务提供者。';
$lang['would_you_like_to_proceed'] = '您确定要继续吗？';
$lang['proceed'] = '继续';
$lang['no_available_service_providers'] = '没有可用的服务';
$lang['no_available_service_providers_message'] = '目前没有可供预约的服务或服务提供者。请稍后再查看或联系我们获取帮助。';
$lang['reset_password'] = '重置密码';
$lang['new_password'] = '新密码';
$lang['enter_new_password'] = '在下方输入您的新密码。';
$lang['password_reset_request'] = '密码重置请求';
...
$lang['password_reset_failed'] = '密码重置失败。请重试。';
$lang['no_password_provided'] = '请输入密码。';
$lang['type_username_and_email_for_reset_link'] = '输入您的用户名和电子邮件地址以接收密码重置链接。';
$lang['send_reset_link'] = '发送重置链接';
$lang['reset_link_sent_with_email'] = '如果存在与所提供凭据匹配的帐户，密码重置链接已发送到您的电子邮件。';
$lang['working_plan_validation_failed'] = '发现无效的工作计划配置。';
$lang['start_date'] = '开始日期';
$lang['end_date'] = '结束日期';
$lang['remember_me'] = '记住我的信息';
$lang['remember_me_hint'] = '保存您的信息以便下次更快预约。';
$lang['legal_notice'] = '法律声明';
$lang['legal_notice_url'] = '法律声明 URL';
$lang['legal_notice_url_hint'] = '输入您的法律声明页面的 URL。';
$lang['imprint'] = '出版信息';
$lang['imprint_url'] = '出版信息 URL';
$lang['imprint_url_hint'] = '输入您的出版信息页面的 URL。';
$lang['data_retention'] = '数据保留';
$lang['data_retention_days'] = '数据保留天数';
$lang['data_retention_days_hint'] = '设置客户数据自动删除的天数。设置为 0 可禁用自动删除。';
$lang['manage_privacy'] = '管理隐私';
$lang['manage_privacy_hint'] = '点击以下链接查看、更新或删除您的个人信息。';
$lang['personal_information_updated'] = '您的个人信息已成功更新。';
$lang['verify'] = '验证';
$lang['verifying'] = '验证中';
$lang['verified'] = '已验证';
$lang['verification_complete'] = '验证完成';
$lang['verification_failed'] = '验证失败。点击重试。';
$lang['click_to_verify'] = '点击验证您是真人';
$lang['altcha_verification_failed'] = 'ALTCHA 验证失败。请重试。';
...
$lang['invalid_price'] = '价格无效。';
$lang['invalid_slot_interval'] = '时段间隔无效。';
$lang['invalid_attendants_number'] = '出席人数无效。';
$lang['scheduling_conflict'] = '预约时间冲突';
$lang['invalid_time'] = '时间无效。';
$lang['service_and_provider_missing'] = '继续之前请选择服务项目和服务人员。';
$lang['caldav'] = 'CalDAV';
$lang['caldav_info'] = '将服务人员的预约与 CalDAV 日历服务器同步，并控制同步可以连接到哪些主机。';
$lang['caldav_allowed_hosts'] = '允许的连接网址';
$lang['caldav_allowed_hosts_info'] = '指向专用或保留网络地址的 CalDAV 网址会被拒绝，以免在后台输入的网址访问本安装的内部网络。如需仍然允许，请每行添加一个连接网址或主机名。请只添加由您自己运行的服务器。';
$lang['caldav_sync_failed'] = 'CalDAV 同步失败';
$lang['caldav_sync_failed_url'] = '无法使用已保存的连接网址。如果您的 CalDAV 服务器运行在本地网络中，请在“设置”“集成”“CalDAV”中添加其网址。否则请关闭同步，并使用正确的网址重新连接。';
$lang['caldav_sync_failed_credentials'] = 'CalDAV 服务器拒绝了用户名和密码。请关闭同步，并使用正确的凭据重新连接。';
$lang['caldav_sync_failed_unreachable'] = '无法连接到 CalDAV 服务器。请确认服务器正在运行，并且连接网址正确。';
$lang['caldav_private_host_warning'] = '此服务器位于专用网络中。连接后会将其主机添加到允许的连接网址中。';
$lang['caldav_allow_host_and_connect'] = '允许并连接';
// End
