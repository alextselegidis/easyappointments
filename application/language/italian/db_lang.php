...
$lang['db_invalid_connection_str'] =
    'Impossibile determinare i parametri del database dalla stringa di connessione immessa.';
...
$lang['db_batch_missing_index'] =
    'Una o più righe presenti per l\'aggiornamento in batch non contengono l\'indice specificato.';
...
$lang['db_field_param_missing'] =
    'Per eseguire il fetch dei campi è necessario il nome della tabella passato come parametro.';
...
$lang['db_unsupported_compression'] =
    'Il formato di compressione dei file che è stato scelto non è supportato dal server in uso.';
...
$lang['db_column_definition_required'] =
    'E\' necessario specificare la definizione di una colonna per questa operazione.';
