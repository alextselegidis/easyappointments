...
$lang['no_available_hours'] =
    'Non ci sono appuntamenti disponibili per la data selezionata. Si prega di scegliere un\'altra data.';
...
$lang['cancel_appointment_hint'] =
    'Clicca sul bottone "Cancella" per rimuovere l\'appuntamento dalla pianificazione aziendale.';
$lang['cancel'] = 'Annulla';
...
$lang['thank_you_for_appointment'] =
    'Grazie per aver pianificato un apputamento con noi. Sotto puoi vedere i dettagli dell\'appuntamento. Effettua le modifiche facendo click sul link dell\'appuntamento.';
...
$lang['unavailability_periods_hint'] =
    'Durante i periodi di indisponibilità il fornitore non vuole accettare nuovi appuntamenti.';
...
$lang['write_appointment_removal_reason'] =
    'Spendi un minuto per scrivere il motivo di annullamento dell\'appuntamento:';
...
$lang['add_breaks_during_each_day'] =
    'Aggiunti pause di lavoro durante il giorno. Durante le pause il fornitore non accetta alcun appuntamento.';
$lang['day'] = 'Giorno';
$lang['days'] = 'Giorni';
$lang['actions'] = 'Azioni';
...
$lang['company_email_hint'] =
    'Questo sarà l\'indirizzo email aziendale e sarà utilizzato come mittente e indirizzo di risposta delle e-mail (richiesto).';
...
$lang['edit_breaks_hint'] =
    'Aggiungi le pause di lavoro ogni giorno. Queste pause saranno applicate per tutti i nuovi fornitori.';
$lang['book_advance_timeout'] = 'Tempo limite prenotazione';
$lang['book_advance_timeout_hint'] =
    'Definisci il tempo limite (in minuti) entro cui i clienti posso prenotare o modificare gli appuntamento con l\'azienda.';
$lang['timeout_minutes'] = 'Tempo limite (Minuti)';
$lang['about_app_info'] =
    'Easy!Appointments è un\'applicazione web estremamente personalizzabile che permette ai tuoi clienti di prenotare appuntamenti con te attraverso il web. Inoltre, fornisce la possibilità di sincronizzare i tuoi dati con Google Calendar in modo da poterli usare in altri servizi.';
$lang['current_version'] = 'Versione corrente';
$lang['support'] = 'Supporto';
$lang['about_app_support'] =
    'Se incontri un problema quando utilizzi Easy!Appointments puoi cercare sul Gruppo Google ufficiale per le risposte. Potresti anche aver bisogno di creare una nuova segnalazione sulla pagina Google Code al fine di aiutarci negli sviluppi futuri.';
...
$lang['about_app_license'] =
    'Easy!Appointments è distributo sotto licenza GPLv3. Usando il codice di Easy!Appointments stai accettando i termini e le condizioni descritte al seguente URL:';
$lang['logout_success'] =
    'Logout effettuato correttamente! Clicca su uno dei seguenti bottoni per navigare su una pagina differente.';
...
$lang['type_username_and_email_for_new_password'] =
    'Inserisci il tuo nome utente e la tua e-mail per ottenere la nuova password.';
...
$lang['new_password_is'] =
    'La tua nuova password è $password. Memorizza questa e-mail per essere sicuro di recuperarla quando necessario. Puoi anche cambiare questa password con un\'altra dalla pagina impostazioni.';
...
$lang['page_not_found_message'] =
    'Sfortunatamente la pagina richiesta non esiste. Controlla lo URL o naviga un indirizzo diverso usando i bottoni posti sotto.';
$lang['error'] = 'Errore';
$lang['no_privileges'] = 'Nessun privilegio';
$lang['no_privileges_message'] =
    'Non hai i privilegi richiesti per visualizzare questa pagina. Naviga una sezione differente.';
...
$lang['user_settings_are_invalid'] =
    'Le impostazioni utente non sono valide! Rivedi le tue impostazione e prova ancora.';
...
$lang['google_sync_failed'] =
    'Sincronizzazione con Google fallita: Non è stato possibile stabilire una connessione col server.';
$lang['select_google_calendar'] = 'Seleziona Google Calendar';
$lang['select_google_calendar_prompt'] =
    'Seleziona il calendario con cui vuoi sincronizzare i tuoi appuntamenti. Se non vuoi selezionare un calendario specifico, sarà usato quello predefinito.';
...
$lang['could_not_add_to_google_calendar'] =
    'Il tuo appuntamento potrebbe non essere stato aggiunto al tuo account Google Calendar.';
...
$lang['require_captcha_hint'] =
    'Quando abilitato, i clienti dovranno digitare il codice CAPTCHA prima di prenotare/aggiornare un appuntamento.';
...
$lang['requested_hour_is_unavailable'] =
    'Sfortunatamente l\'appuntamento richiesto non è disponibile. Per cortesia seleziona un orario diverso per il tuo appuntamento.';
$lang['customer_notifications'] = 'Notifiche cliente';
$lang['customer_notifications_hint'] =
    'Definisce se il cliente riceverà notifiche email ogni volta che c\'è un cambiamento di programma su uno dei suoi appuntamenti.';
...
$lang['google_analytics_code_hint'] =
    'Aggiunti il tuo ID di Google Analytics per includerlo nella pagina di prenotazione.';
...
$lang['website_using_cookies_to_ensure_best_experience'] =
    'Questo sito utilizza i cookie per assicurarti una esperienza migliore di navigazione.';
...
$lang['delete_personal_information_prompt'] =
    'Sicuro di voler cancellare i tuoi dati personali? Questa operazione è irreversibile.';
...
$lang['require_phone_number_hint'] =
    'Quando abilitato i clienti e gli utenti necessitano di inserire il numero di telefono quando prenotano un appuntamento';
$lang['check_spam_folder'] = 'Controlla la cartella SPAM se non ricevi l\'email di conferma entro pochi minuti.';
$lang['api_token_hint'] =
    'Imposta un token segreto per abilitare l\'autenticazione basata su token nelle API di Easy!Appointments.';
$lang['timezone'] = 'Fuso Orario';
$lang['overwrite_existing_working_plans'] =
    'Questa operazione sovrascrive il Piano di Lavoro del fornitore esistente, sei sicuro di voler continuare?';
...
$lang['display_any_provider_hint'] =
    'La pagina di prenotazione avrà un\'opzione aggiuntiva che permetterà ai clienti di prenotare senza specificare un fornitore.';
