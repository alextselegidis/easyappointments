...
$lang['require_captcha_hint'] = 'Se abilitato, i clienti dovranno affrontare una sfida CAPTCHA prima di prenotare/aggiornare un appuntamento per dimostrare di non essere un robot.';
$lang['none'] = 'Nessuno';
$lang['recaptcha_server_token'] = 'Token server reCAPTCHA';
$lang['recaptcha_client_token'] = 'Token client reCAPTCHA';
$lang['recaptcha_hint'] = 'Vai al sito web di amministrazione di google recaptcha per configurare un dominio reCAPTCHA v2 e ottenere i token del tuo server e client.';
$lang['recaptcha_warning'] = 'Sei responsabile dell\'aggiornamento appropriato della tua politica sulla privacy per conformarsi alle leggi locali quando usi reCAPTCHA!';
