...
$lang['disable_sync_prompt'] = 'Sei sicuro di voler disabilitare la sincronizzazione?';
...
$lang['color'] = 'Color';
$lang['matomo_analytics_url_hint'] = 'Aggiungere l\'URL alla propria installazione Matomo per abilitare il tracciamento Matomo sulle pagine di prenotazione.';
$lang['invalid_phone'] = 'Numero di telefono non valido.';
$lang['legal'] = 'Legal';
$lang['business'] = 'Business';
$lang['account'] = 'Account';
$lang['disable_booking'] = 'Disabilita prenotazioni';
$lang['disable_booking_hint'] = 'Finché questa impostazione è attiva, la pagina di prenotazione sarà disattivata e i clienti non potranno registrare nuovi appuntamenti.';
...
$lang['company_logo_hint'] = 'Il logo dell\'azienda sarà visualizzato in molti punti dell\'applicazione, tra cui la pagina di prenotazione e le e-mail di notifica (file immagine, max 2MB).';
$lang['company_color'] = 'Colore dell\'azienda';
$lang['company_color_hint'] = 'Il colore dell\'azienda sarà applicato a tutta l\'applicazione, in modo che l\'applicazione utilizzi il vostro marchio.';
$lang['localization'] = 'Localizzazioni';
...
$lang['private_hint'] = 'I record privati non saranno visualizzati o elaborati nelle pagine pubbliche, come la pagina di prenotazione.';
$lang['reset'] = 'Reset';
$lang['all'] = 'Tutto';
$lang['booking_link'] = 'Link di Prenotazione';
$lang['add_new_event'] = 'Aggiungi Nuovo Evento';
$lang['what_kind_of_event'] = 'Che tipo di evento vorresti aggiungere?';
$lang['theme'] = 'Tema';
$lang['limit_customer_access'] = 'Limita Accesso Cliente';
$lang['limit_customer_access_hint'] = 'Se abilitato, i fornitori e i segretari potranno accedere solo ai clienti con cui hanno un appuntamento.';
$lang['url'] = 'URL';
...
$lang['admin_save'] = 'Salva Admin';
$lang['admin_delete'] = 'Elimina Admin';
$lang['options'] = 'Opzioni';
$lang['webhooks'] = 'Webhooks';
$lang['webhooks_info'] = 'I Webhooks consentono di inviare notifiche HTTP a applicazioni web esterne in risposta a vari eventi dell\'applicazione, come la creazione di un appuntamento o la rimozione di un cliente.';
$lang['integrations_info'] = 'Le integrazioni consentono di effettuare connessioni di terze parti con applicazioni e API esterne.';
$lang['configure'] = 'Configura';
$lang['google_analytics'] = 'Google Analytics';
$lang['google_analytics_info'] = 'Google Analytics consente di aggiungere automaticamente il codice di monitoraggio e il markup HTML alla pagina pubblica e tracciare tutte le sessioni di prenotazione pubbliche.';
$lang['matomo_analytics'] = 'Matomo Analytics';
$lang['matomo_analytics_info'] = 'Matomo Analytics consente di aggiungere automaticamente il codice di monitoraggio e il markup HTML alla pagina pubblica e tracciare tutte le sessioni di prenotazione pubbliche.';
$lang['api'] = 'API';
$lang['api_info'] = 'Le API consentono di interagire con tutti i dati di Easy!Appointments tramite il protocollo HTTP e gli endpoint API disponibili e di creare le proprie integrazioni.';
...
$lang['future_booking_limit_hint'] = 'Imposta il limite futuro in giorni in cui i clienti possono effettuare prenotazioni tramite la pagina di prenotazione pubblica.';
$lang['api_token'] = 'Token API';
$lang['allow_rescheduling_cancellation_before'] = 'Permetti Ripianificazione/Cancellazione Prima';
...
$lang['appointment_status_options_info'] = 'Definisci un elenco di opzioni di stato degli appuntamenti disponibili che possono essere utilizzate nella pagina del calendario (la prima diventerà automaticamente il valore predefinito).';
$lang['sunday_short'] = 'Do';
$lang['monday_short'] = 'Lu';
$lang['tuesday_short'] = 'Ma';
$lang['wednesday_short'] = 'Me';
$lang['thursday_short'] = 'Gi';
...
$lang['pm'] = 'pm';
$lang['to'] = 'a';
$lang['click_to_toggle'] = 'Clicca Per Alternare';
$lang['week_short'] = 'Sett';
$lang['scroll_to_increment'] = 'Scorri Per Incrementare';
$lang['year'] = 'Anno';
$lang['make_non_working_day'] = 'Questo fornitore non sarà disponibile per lavoro nel giorno selezionato.';
$lang['no_breaks'] = 'Nessuna Pausa';
$lang['service_categories'] = 'Categorie di Servizio';
...
$lang['blocked_periods_hint'] = 'Definisci periodi di tempo in cui le prenotazioni pubbliche saranno disabilitate per tutti i fornitori (ad esempio, date chiuse, festività, ecc.).';
...
$lang['matomo_analytics_site_id_hint'] = 'Imposta l\'ID del sito che sarà monitorato da Matomo (il sito predefinito ha l\'ID "1").';
$lang['default_timezone'] = 'Fuso Orario Predefinito';
$lang['default_timezone_hint'] = 'Imposta il valore predefinito del fuso orario che verrà utilizzato per i nuovi record.';
$lang['default_language'] = 'Lingua Predefinita';
$lang['default_language_hint'] = 'Imposta il valore predefinito della lingua che verrà utilizzato per i nuovi record.';
$lang['sync_method_prompt'] = 'Quale metodo di sincronizzazione vorresti utilizzare?';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Questa integrazione consente di connettersi a un server LDAP esistente e importare automaticamente gli utenti in Easy!Appointments e consentire loro di accedere con la password della directory (il nome utente deve corrispondere).';
$lang['host'] = 'Host';
$lang['port'] = 'Porta';
$lang['user_dn'] = 'DN Utente';
$lang['base_dn'] = 'DN Base';
$lang['keyword'] = 'Parola Chiave';
$lang['ldap_search_hint'] = 'Fornisci una parola chiave per cercare nel directory LDAP utenti che corrispondono ai criteri di filtro.';
$lang['ldap_extension_not_loaded'] = 'L\'estensione LDAP PHP non è caricata, ma è richiesta per far funzionare questa integrazione.';
$lang['field_mapping'] = 'Mappatura Campi';
$lang['content'] = 'Contenuto';
$lang['active'] = 'Attivo';
$lang['user_imported'] = 'Il record utente è stato importato con successo.';
$lang['import'] = 'Importa';
...
$lang['customer_is_already_booked'] = 'Questo cliente ha già un appuntamento durante il periodo di prenotazione richiesto.';
$lang['fields'] = 'Campi';
$lang['invalid_credentials_provided'] = 'Credenziali fornite non valide, riprova.';
$lang['calendar_url'] = 'URL Calendario';
$lang['please_select'] = 'Seleziona Per Favore';
$lang['search'] = 'Search';
// End
