...
$lang['cancel_appointment_hint'] = 'Clicca sul bottone "Cancella appuntamento" per rimuovere l\'appuntamento dalla pianificazione aziendale.';
$lang['cancel'] = 'Annulla';
...
$lang['disable_sync_prompt'] = 'Sei sicuro di voler disattivare la sincronizzazione del calendario?';
...
$lang['manage_users_hint'] = 'Gestisci gli utenti del backend (amministratori, fornitori, segretari).';
...
$lang['business_logic'] = 'Logiche di business';
...
$lang['google_plus_community'] = 'Comunità Google+';
...
$lang['enter_password_here'] = 'Inserisci la password qui ...';
$lang['login'] = 'Accesso';
...
$lang['delete_secretary'] = 'Cancella segretario';
...
$lang['unexpected_issues_message'] = 'L\'operazione non può essere completata.';
$lang['close'] = 'Chiudi';
...
$lang['enter_captcha_here'] = 'Inserisci il CAPTCHA qui...';
...
$lang['limit_customer_access_hint'] = 'Se abilitato, fornitori e segretari potranno accedere solo ai clienti con cui hanno un appuntamento.';
$lang['url'] = 'URL';
...
$lang['secretary_save'] = 'Salva Segretario';
$lang['secretary_delete'] = 'Elimina Segretario';
$lang['admin_save'] = 'Salva Amministratore';
$lang['admin_delete'] = 'Elimina Amministratore';
$lang['options'] = 'Opzioni';
$lang['webhooks'] = 'Webhook';
...
$lang['secret_header'] = 'Intestazione segreta';
$lang['search'] = 'Cerca';
$lang['slot_interval'] = 'Intervallo slot (Minuti)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Abilita la generazione automatica di link per riunioni Jitsi per gli appuntamenti. Quando abilitato, verrà generato un link unico per videochiamata Jitsi e salvato come link della riunione.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA è un\'alternativa CAPTCHA open-source incentrata sulla privacy che utilizza la prova di lavoro per verificare gli utenti umani senza tracciamento.';
$lang['altcha_enabled_hint'] = 'Quando abilitato, ALTCHA verrà utilizzato al posto del CAPTCHA a immagine tradizionale per la verifica dei moduli.';
$lang['altcha_hmac_key'] = 'Chiave HMAC';
$lang['altcha_hmac_key_hint'] = 'Una chiave segreta utilizzata per firmare e verificare le sfide ALTCHA. Clicca su Genera per creare una nuova chiave sicura.';
$lang['altcha_max_number'] = 'Numero massimo';
$lang['altcha_max_number_hint'] = 'Il numero massimo per la sfida di prova di lavoro. Valori più alti aumentano la difficoltà (predefinito: 100000).';
$lang['altcha_expires'] = 'Scadenza (Secondi)';
$lang['altcha_expires_hint'] = 'Per quanto tempo una sfida rimane valida in secondi (predefinito: 300).';
$lang['altcha_key_generated'] = 'Nuova chiave HMAC generata con successo.';
$lang['altcha_enabled'] = 'Abilita ALTCHA';
$lang['altcha_captcha_not_active_warning'] = 'L\'impostazione CAPTCHA non è attualmente attiva. ALTCHA non verrà utilizzato a meno che CAPTCHA non sia abilitato nelle';
$lang['generate'] = 'Genera';
$lang['meeting_link'] = 'Link della riunione';
$lang['google_calendar'] = 'Google Calendar';
$lang['google_calendar_info'] = 'Abilita la sincronizzazione con Google Calendar per sincronizzare gli appuntamenti con gli account Google Calendar dei fornitori.';
$lang['google_client_id'] = 'ID client';
$lang['google_client_id_info'] = 'L\'ID client del tuo progetto Google Cloud Console.';
$lang['google_client_secret'] = 'Segreto client';
$lang['google_client_secret_info'] = 'Il segreto client del tuo progetto Google Cloud Console.';
$lang['google_calendar_setup_info'] = 'Per abilitare la sincronizzazione con Google Calendar, devi creare un progetto in Google Cloud Console, abilitare l\'API Google Calendar e creare le credenziali OAuth 2.0. Visita:';
$lang['google_meet_link_generation'] = 'Genera link Google Meet';
$lang['google_meet_link_generation_info'] = 'Crea automaticamente un link di videoconferenza Google Meet per gli appuntamenti sincronizzati. Il link della riunione verrà salvato nel campo link riunione dell\'appuntamento.';
$lang['display_add_to_google_calendar'] = 'Mostra il pulsante "Aggiungi a Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Mostra il pulsante "Aggiungi a Google Calendar" nella pagina di conferma della prenotazione, consentendo ai clienti di aggiungere facilmente il loro appuntamento al proprio Google Calendar personale.';
$lang['select_all'] = 'Seleziona tutto';
$lang['select_none'] = 'Deseleziona tutto';
$lang['appointment_update'] = 'Aggiornamento appuntamento';
$lang['notify_users_on_update_question'] = 'Vuoi inviare una notifica riguardo questa modifica?';
$lang['yes'] = 'Sì';
$lang['no'] = 'No';
$lang['latest_blog_posts'] = 'Ultimi articoli del blog';
$lang['loading'] = 'Caricamento';
$lang['blog_posts_load_error'] = 'Impossibile caricare i post del blog. Visita il sito ufficiale per gli aggiornamenti.';
$lang['provider_has_conflicting_appointment'] = 'Il fornitore selezionato ha già un altro appuntamento in quel momento. Si prega di selezionare un orario o un fornitore diverso.';
$lang['would_you_like_to_proceed'] = 'Vuoi procedere comunque?';
$lang['proceed'] = 'Procedi';
$lang['no_available_service_providers'] = 'Nessun servizio disponibile';
$lang['no_available_service_providers_message'] = 'Al momento non ci sono servizi o fornitori disponibili per la prenotazione. Riprova più tardi o contattaci per assistenza.';
...
$lang['password_reset_request'] = 'Richiesta di reimpostazione password';
$lang['password_reset_email_message'] = 'Hai richiesto di reimpostare la tua password. Clicca sul pulsante qui sotto per impostare una nuova password per il tuo account.';
$lang['password_reset_link_expires'] = 'Questo link scadrà tra 1 ora.';
$lang['password_reset_ignore_message'] = 'Se non hai richiesto la reimpostazione della password, ignora questa email.';
$lang['invalid_reset_token'] = 'Il link per reimpostare la password non è valido.';
$lang['invalid_or_expired_token'] = 'Il link per reimpostare la password non è valido o è scaduto. Si prega di richiederne uno nuovo.';
$lang['password_reset_success'] = 'La password è stata reimpostata con successo. Verrai reindirizzato alla pagina di accesso.';
$lang['password_reset_failed'] = 'Reimpostazione della password non riuscita. Si prega di riprovare.';
$lang['no_password_provided'] = 'Si prega di inserire una password.';
$lang['type_username_and_email_for_reset_link'] = 'Inserisci il tuo nome utente e indirizzo email per ricevere un link per reimpostare la password.';
$lang['send_reset_link'] = 'Invia link di ripristino';
$lang['reset_link_sent_with_email'] = 'Se esiste un account con le credenziali fornite, un link per reimpostare la password è stato inviato alla tua email.';
$lang['working_plan_validation_failed'] = 'Configurazione del piano di lavoro non valida.';
$lang['start_date'] = 'Data di inizio';
$lang['end_date'] = 'Data di fine';
$lang['remember_me'] = 'Ricorda le mie informazioni';
$lang['remember_me_hint'] = 'Salva i tuoi dati per una prenotazione più rapida la prossima volta.';
$lang['legal_notice'] = 'Avviso legale';
$lang['legal_notice_url'] = 'URL dell\'avviso legale';
$lang['legal_notice_url_hint'] = 'Inserisci l\'URL della tua pagina di avviso legale.';
$lang['imprint'] = 'Impressum';
$lang['imprint_url'] = 'URL dell\'impressum';
$lang['imprint_url_hint'] = 'Inserisci l\'URL della tua pagina di impressum.';
$lang['data_retention'] = 'Conservazione dei dati';
$lang['data_retention_days'] = 'Giorni di conservazione dei dati';
$lang['data_retention_days_hint'] = 'Imposta il numero di giorni dopo i quali i dati dei clienti verranno eliminati automaticamente. Imposta 0 per disabilitare l\'eliminazione automatica.';
$lang['manage_privacy'] = 'Gestisci privacy';
$lang['manage_privacy_hint'] = 'Clicca sul link qui sotto per visualizzare, aggiornare o eliminare le tue informazioni personali.';
$lang['personal_information_updated'] = 'Le tue informazioni personali sono state aggiornate con successo.';
$lang['verify'] = 'Verifica';
$lang['verifying'] = 'Verifica in corso';
$lang['verified'] = 'Verificato';
$lang['verification_complete'] = 'Verifica completata';
$lang['verification_failed'] = 'Verifica fallita. Clicca per riprovare.';
$lang['click_to_verify'] = 'Clicca per verificare che sei umano';
$lang['altcha_verification_failed'] = 'Verifica ALTCHA fallita. Per favore riprova.';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = 'Offriamo servizi completi per software self-hosted, inclusi sviluppo personalizzato, hosting gestito, contratti di supporto, rebranding e miglioramenti continui — così puoi concentrarti sulla tua attività mentre noi ci occupiamo del resto.';
...
$lang['invalid_price'] = 'Prezzo non valido.';
$lang['invalid_slot_interval'] = 'Intervallo slot non valido.';
$lang['invalid_attendants_number'] = 'Numero di partecipanti non valido.';
$lang['scheduling_conflict'] = 'Conflitto di pianificazione';
$lang['invalid_time'] = 'Orario non valido.';
$lang['service_and_provider_missing'] = 'Seleziona un servizio e un fornitore prima di continuare.';
$lang['caldav'] = 'CalDAV';
$lang['caldav_info'] = 'Sincronizza gli appuntamenti dei tuoi operatori con un server di calendario CalDAV e controlla a quali host la sincronizzazione può connettersi.';
$lang['caldav_allowed_hosts'] = 'URL di connessione consentiti';
$lang['caldav_allowed_hosts_info'] = 'Gli URL CalDAV che puntano a un indirizzo di rete privato o riservato vengono rifiutati, in modo che un URL inserito nel pannello di amministrazione non possa raggiungere la rete interna di questa installazione. Aggiungi un URL di connessione o un nome host per riga per consentirlo comunque. Aggiungi solo server che gestisci tu stesso.';
$lang['caldav_sync_failed'] = 'Sincronizzazione CalDAV non riuscita';
$lang['caldav_sync_failed_url'] = 'Non è stato possibile utilizzare l\'URL di connessione salvato. Se il tuo server CalDAV è nella rete locale, aggiungi il suo URL in Impostazioni, Integrazioni, CalDAV. Altrimenti disattiva la sincronizzazione e connettiti di nuovo con un URL corretto.';
$lang['caldav_sync_failed_credentials'] = 'Il server CalDAV ha rifiutato il nome utente e la password. Disattiva la sincronizzazione e connettiti di nuovo con le credenziali corrette.';
$lang['caldav_sync_failed_unreachable'] = 'Non è stato possibile raggiungere il server CalDAV. Verifica che sia in funzione e che l\'URL di connessione sia corretto.';
$lang['caldav_private_host_warning'] = 'Questo server si trova in una rete privata. Connettendosi, il suo host verrà aggiunto agli URL di connessione consentiti.';
$lang['caldav_allow_host_and_connect'] = 'Consenti e connetti';
// End
