...
BASE_DIR = "."  # Script liegt direkt im language-Verzeichnis
...
for lang_folder in os.listdir(BASE_DIR):
    ...
    file_path = os.path.join(folder_path, "translations_lang.php")
    ...
    if not translation:
        print(f"Keine Übersetzung definiert für: {lang_folder}")
        continue
    ...
    if inserted:
        ...
        print(f"✗ Key '{TARGET_KEY}' nicht gefunden in: {lang_folder}")
