...
$lang['enter_password_here'] = 'Entrez le mot de passe ici ...';
...
$lang['unexpected_issues_message'] = 'L\'opération n\'a pu être terminée.';
$lang['close'] = 'Fermer';
...
$lang['enter_captcha_here'] = 'Entrez le CAPTCHA ici...';
...
$lang['secret_header'] = 'En-tête secret';
$lang['search'] = 'Rechercher';
$lang['slot_interval'] = 'Intervalle de créneau (Minutes)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Activez la génération automatique de liens de réunion Jitsi pour les rendez-vous. Lorsque cette option est activée, un lien unique de visioconférence Jitsi sera généré et enregistré comme lien de réunion.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA est une alternative CAPTCHA open-source axée sur la confidentialité qui utilise la preuve de travail pour vérifier les utilisateurs humains sans suivi.';
$lang['altcha_enabled_hint'] = 'Lorsque cette option est activée, ALTCHA sera utilisé à la place du CAPTCHA image traditionnel pour la vérification des formulaires.';
$lang['altcha_hmac_key'] = 'Clé HMAC';
$lang['altcha_hmac_key_hint'] = 'Une clé secrète utilisée pour signer et vérifier les défis ALTCHA. Cliquez sur Générer pour créer une nouvelle clé sécurisée.';
$lang['altcha_max_number'] = 'Nombre maximum';
$lang['altcha_max_number_hint'] = 'Le nombre maximum pour le défi de preuve de travail. Des valeurs plus élevées augmentent la difficulté (par défaut : 100000).';
$lang['altcha_expires'] = 'Expiration (Secondes)';
...
$lang['google_calendar_info'] = 'Activez la synchronisation Google Calendar pour synchroniser les rendez-vous avec les comptes Google Calendar des prestataires.';
$lang['google_client_id'] = 'ID client';
$lang['google_client_id_info'] = 'L\'ID client de votre projet Google Cloud Console.';
$lang['google_client_secret'] = 'Secret client';
$lang['google_client_secret_info'] = 'Le secret client de votre projet Google Cloud Console.';
$lang['google_calendar_setup_info'] = 'Pour activer la synchronisation Google Calendar, vous devez créer un projet dans Google Cloud Console, activer l\'API Google Calendar et créer des identifiants OAuth 2.0. Visitez :';
$lang['google_meet_link_generation'] = 'Générer des liens Google Meet';
$lang['google_meet_link_generation_info'] = 'Créer automatiquement un lien de visioconférence Google Meet pour les rendez-vous synchronisés. Le lien de réunion sera enregistré dans le champ lien de réunion du rendez-vous.';
$lang['display_add_to_google_calendar'] = 'Afficher le bouton "Ajouter à Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Afficher le bouton "Ajouter à Google Calendar" sur la page de confirmation de réservation, permettant aux clients d\'ajouter facilement leur rendez-vous à leur Google Calendar personnel.';
$lang['select_all'] = 'Tout sélectionner';
$lang['select_none'] = 'Tout désélectionner';
$lang['appointment_update'] = 'Mise à jour du rendez-vous';
$lang['notify_users_on_update_question'] = 'Souhaitez-vous envoyer une notification concernant ce changement ?';
$lang['yes'] = 'Oui';
$lang['no'] = 'Non';
$lang['latest_blog_posts'] = 'Derniers articles du blog';
$lang['loading'] = 'Chargement';
$lang['blog_posts_load_error'] = 'Impossible de charger les articles du blog. Veuillez visiter le site officiel pour les mises à jour.';
...
$lang['would_you_like_to_proceed'] = 'Souhaitez-vous continuer quand même ?';
$lang['proceed'] = 'Continuer';
$lang['no_available_service_providers'] = 'Aucun service disponible';
$lang['no_available_service_providers_message'] = 'Il n\'y a actuellement aucun service ni prestataire disponible pour la réservation. Veuillez réessayer plus tard ou nous contacter pour obtenir de l\'aide.';
...
$lang['enter_password_here'] = 'Entrez le mot de passe ici ...';
$lang['password_reset_request'] = 'Demande de réinitialisation du mot de passe';
...
$lang['password_reset_failed'] = 'Échec de la réinitialisation du mot de passe. Veuillez réessayer.';
$lang['no_password_provided'] = 'Veuillez entrer un mot de passe.';
$lang['type_username_and_email_for_reset_link'] = 'Entrez votre nom d\'utilisateur et votre adresse e-mail pour recevoir un lien de réinitialisation du mot de passe.';
...
$lang['working_plan_validation_failed'] = 'Configuration du planning de travail invalide.';
$lang['start_date'] = 'Date de début';
$lang['end_date'] = 'Date de fin';
$lang['remember_me'] = 'Se souvenir de mes informations';
$lang['remember_me_hint'] = 'Enregistrez vos coordonnées pour une réservation plus rapide la prochaine fois.';
$lang['legal_notice'] = 'Mentions légales';
$lang['legal_notice_url'] = 'URL des mentions légales';
$lang['legal_notice_url_hint'] = 'Entrez l\'URL de votre page de mentions légales.';
$lang['imprint'] = 'Impressum';
$lang['imprint_url'] = 'URL de l\'impressum';
$lang['imprint_url_hint'] = 'Entrez l\'URL de votre page d\'impressum.';
$lang['data_retention'] = 'Conservation des données';
$lang['data_retention_days'] = 'Jours de conservation des données';
$lang['data_retention_days_hint'] = 'Définissez le nombre de jours après lesquels les données clients seront automatiquement supprimées. Mettez 0 pour désactiver la suppression automatique.';
$lang['manage_privacy'] = 'Gérer la confidentialité';
$lang['manage_privacy_hint'] = 'Cliquez sur le lien ci-dessous pour consulter, mettre à jour ou supprimer vos informations personnelles.';
$lang['personal_information'] = 'Informations personnelles';
$lang['personal_information_updated'] = 'Vos informations personnelles ont été mises à jour avec succès.';
$lang['verify'] = 'Vérifier';
$lang['verifying'] = 'Vérification en cours';
$lang['verified'] = 'Vérifié';
$lang['verification_complete'] = 'Vérification terminée';
$lang['verification_failed'] = 'La vérification a échoué. Cliquez pour réessayer.';
$lang['click_to_verify'] = 'Cliquez pour vérifier que vous êtes humain';
$lang['altcha_verification_failed'] = 'La vérification ALTCHA a échoué. Veuillez réessayer.';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = 'Nous proposons des services complets pour les logiciels auto-hébergés, incluant le développement sur mesure, l\'hébergement géré, les contrats de support, le changement de marque et les améliorations continues — afin que vous puissiez vous concentrer sur votre activité pendant que nous nous occupons du reste.';
...
$lang['online_appointment_scheduler'] = 'Planificateur de rendez-vous en ligne';
$lang['powered_by'] = 'Propulsé par';
$lang['software_development'] = 'Développement logiciel';
$lang['warning'] = 'Attention';
$lang['toggle_dropdown'] = 'Ouvrir le menu';
$lang['administrator'] = 'Administrateur';
$lang['installation_heading'] = 'Installation d\'Easy!Appointments';
$lang['installation_welcome'] = 'Bienvenue sur la page d\'installation d\'Easy!Appointments.';
$lang['installation_info'] = 'Cette page vous aidera à configurer les principaux paramètres de votre installation Easy!Appointments. Vous pourrez modifier ces paramètres et bien d\'autres dans la session d\'administration de votre système. Si vous rencontrez des problèmes lors de l\'utilisation d\'Easy!Appointments, vous pouvez toujours consulter la Documentation et le Groupe de Support. Vous pouvez également soumettre de nouveaux problèmes sur GitHub Issues pour aider notre processus de développement.';
$lang['installation_business_logic_hint'] = 'Vous pourrez configurer votre logique commerciale dans la page des paramètres d\'administration après l\'installation.';
$lang['installation_complete_hint'] = 'Appuyez sur le bouton suivant pour terminer le processus d\'installation.';
$lang['installation_license_text'] = 'Easy!Appointments est sous licence GPL-3.0. En utilisant le code d\'Easy!Appointments de quelque manière que ce soit, vous acceptez les conditions décrites dans l\'URL suivante :';
$lang['install'] = 'Installer Easy!Appointments';
$lang['update_title'] = 'Mise à jour Easy!Appointments';
$lang['database_update_success'] = 'Succès ! La base de données a été mise à jour avec succès.';
$lang['update_success_message'] = 'Vous pouvez maintenant utiliser la dernière version d\'Easy!Appointments.';
$lang['database_update_error'] = 'Attention ! Une erreur s\'est produite lors de la mise à jour.';
$lang['error_message_label'] = 'Message d\'erreur :';
$lang['restore_backup_message'] = 'Veuillez restaurer votre sauvegarde de base de données.';
$lang['reschedule_cancel_appointment'] = 'Reporter / Annuler le rendez-vous';
$lang['logo'] = 'Logo';
$lang['loading'] = 'Chargement';
$lang['google_cloud_console'] = 'Google Cloud Console';
$lang['captcha'] = 'CAPTCHA';
$lang['error_404_title'] = '404 Page non trouvée';
$lang['error_general_title'] = 'Erreur';
$lang['error_db_title'] = 'Erreur de base de données';
// End
