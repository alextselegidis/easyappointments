...
$lang['invalid_duration'] = 'Durée non valide.';
...
$lang['working_plan_exception'] = 'Exception du planning de travail';
$lang['working_plan_exceptions'] = 'Exceptions du planning de travail';
$lang['working_plan_exceptions_hint'] = 'Ajoutez une journée d\'exception du planning de travail, en dehors du plan de travail.';
$lang['new_working_plan_exception_title'] = 'Nouvelle exception de planning de travail';
$lang['working_plan_exception_saved'] = 'Exception de planning de travail économisé avec succès.';
$lang['working_plan_exception_deleted'] = 'Exception de planning de travail supprimé avec succès.';
$lang['add_working_plan_exceptions_during_each_day'] = 'Ajoutez des exceptions du planning de travail, en dehors du plan de travail.';
$lang['add_working_plan_exception'] = 'Ajouter une exception du planning de travail';
$lang['require_phone_number'] = 'Nécessite un numéro de téléphone';
$lang['require_phone_number_hint'] = 'Lorsqu\'ils sont activés, les clients et les utilisateurs devront saisir le numéro de téléphone du client lors de la prise de rendez-vous';
$lang['check_spam_folder'] = 'Veuillez vérifier votre dossier de spam si l\'e-mail n\'arrive pas d\'ici quelques minutes.';
$lang['api_token_hint'] = 'Définissez un jeton secret afin d\'activer l\'authentification basée sur le jeton de l\'API';
$lang['timezone'] = 'Fuseau horaire';
$lang['overwrite_existing_working_plans'] = 'Cela écrasera les plannings de travail du fournisseur existant, êtes-vous sûr de vouloir continuer?';
$lang['working_plans_got_updated'] = 'Tous les plannings de travail ont été mis à jour.';
$lang['apply_to_all_providers'] = 'Appliquer à tous les exécutant';
$lang['display_any_provider'] = 'Afficher une option de exécutant';
$lang['display_any_provider_hint'] = 'La page de réservation contiendra une option supplémentaire qui permet aux clients de réserver sans spécifier un fournisseur.';
