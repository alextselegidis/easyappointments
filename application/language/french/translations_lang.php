...
$lang['service_and_provider'] = 'Choisissez une prestation et un prestataire';
$lang['select_service'] = 'Choisissez une prestation';
$lang['select_provider'] = 'Choisissez un prestataire';
$lang['duration'] = 'Durée';
$lang['minutes'] = 'Minutes';
$lang['price'] = 'Prix';
$lang['back'] = 'Retour';
$lang['appointment_date_and_time'] = 'Choisissez la date et l’horaire de votre rendez-vous';
$lang['no_available_hours'] = 'Aucun horaire de rendez-vous disponible pour la date sélectionnée. Veuillez choisir une autre date.';
$lang['appointment_hour_missing'] = 'Veuillez choisir un horaire de rendez-vous avant de pouvoir poursuivre.';
...
$lang['appointment_booked'] = 'Votre rendez-vous a bien été confirmé.';
...
$lang['appointment_does_not_exist_in_db'] = 'Le rendez-vous demandé n’existe plus dans notre base de données.';
...
$lang['disable_sync_prompt'] = 'Voulez-vous vraiment désactiver la synchronisation du calendrier ?';
...
$lang['manage_appointment_record_hint'] = 'Gérer tous les enregistrements de rendez-vous des prestataires et des prestations actives.';
$lang['select_filter_item_hint'] = 'Choisir un prestataire ou une prestation et visualisez les rendez-vous sur l’agenda.';
$lang['enable_appointment_sync_hint'] = 'Activer la synchronisation des rendez-vous avec le calendrier Google du prestataire.';
...
$lang['manage_users_hint'] = 'Gérer les utilisateurs back office (administrateurs, prestataires, secrétaires).';
$lang['settings_hint'] = 'Régler les paramètres système et utilisateurs.';
$lang['log_out_hint'] = 'Déconnexion du système.';
$lang['unavailability_periods_hint'] = 'Durant les périodes d’indisponibilité, le prestataire n’acceptera pas de nouvelle prestation.';
...
$lang['edit_unavailability_title'] = 'Editer une période d’indisponibilité';
...
$lang['breaks'] = 'Pauses';
$lang['add_breaks_during_each_day'] = 'Ajoutez ici les périodes de pause pour chaque jour. Pendant ces pauses, le prestataire n’acceptera pas de rendez-vous…';
$lang['day'] = 'Jour';
$lang['days'] = 'Jours';
...
$lang['settings_saved'] = 'Paramètres sauvegardés.';
...
$lang['edit_breaks_hint'] = 'Indiquer ici les périodes des pauses quotidiennes. Ces pauses seront disponibles à chaque nouveau prestataire.';
...
$lang['delete_provider'] = 'Supprimer un prestataire';
...
$lang['delete_personal_information_prompt'] = 'Voulez-vous vraiment effacer toutes vos données personnelles ? Cette action est irréversible.';
$lang['location'] = 'Lieu';
$lang['working_plan_exception'] = 'Exception au plan de travail';
$lang['working_plan_exceptions'] = 'Exceptions au plan de travail';
$lang['working_plan_exceptions_hint'] = 'Ajouter un jour d’exception au plan de travail, en dehors du plan de travail habituel.';
$lang['new_working_plan_exception_title'] = 'Nouvelle exception au plan de travail';
$lang['working_plan_exception_saved'] = 'L’exception au plan de travail a bien été enregistré.';
$lang['working_plan_exception_deleted'] = 'Exception au plan de travail supprimée.';
$lang['add_working_plan_exceptions_during_each_day'] = 'Ajouter une exception au plan de travail, en dehors du plan de travail habituel.';
$lang['add_working_plan_exception'] = 'Ajouter une exception au plan de travail';
$lang['require_phone_number'] = 'Numéro de téléphone obligatoire';
$lang['require_phone_number_hint'] = 'Lorsqu’activé, les clients et utilisateurs devront entrer un numéro de téléphone lors de la réservation d’un rendez-vous.';
$lang['check_spam_folder'] = 'Veuillez vérifier votre dossier des indésirables si l’e-mail n’arrive pas danq quelques minutes.';
$lang['api_token_hint'] = 'Choisissez un jeton secret pour activer l’identification basée sur un jeton pour l’API Easy!Appointments.';
$lang['timezone'] = 'Fuseau horaire';
$lang['overwrite_existing_working_plans'] = 'Ceci remplacera tous les plans de travail des prestataires, voulez-vous vraiment continuer ?';
$lang['working_plans_got_updated'] = 'Tous les plans de travail on été mis-à-jour.';
$lang['apply_to_all_providers'] = 'Appliquer à tous les prestataires';
$lang['display_any_provider'] = 'Afficher l’option N’importe quel prestataire';
$lang['display_any_provider_hint'] = 'La page de prise de rendez-vous aura une option supplémentaire qui autorisera les clients à réserver un rendez-vous sans spécifier un prestataire.';
...
$lang['disable_booking_hint'] = 'La page de réservation sera désactivée tant que ce paramètre sera actif. Les clients ne pourront pas enregistrer de nouveaux rendez-vous.';
...
$lang['company_logo_hint'] = 'Le logo de l’entreprise sera affiché dans de nombreux endroits de l’application, y compris la page de réservation et les emails de notification (fichier image, max 2 Mo).';
...
$lang['url'] = 'URL';
$lang['secret_token'] = 'Jeton secret';
...
$lang['provider_save'] = 'Sauvegarde de le prestataire';
$lang['provider_delete'] = 'Supprimer le prestataire';
...
$lang['webhooks'] = 'Points de terminaison';
$lang['webhooks_info'] = 'Les points de terminaison vous permettent d’envoyer des notifications HTTP aux applications Web externes en réponse à divers événements d’application, tels que la création d’un rendez-vous ou la suppression d’un client.';
...
$lang['future_booking_limit'] = 'Limite d’ouverture du planning';
$lang['limit_days'] = 'Limite (jours)';
$lang['future_booking_limit_hint'] = 'Définissez la limite en jours après laquelle les clients ne peuvent plus prendre rendez-vous via la page de réservation publique.';
$lang['api_token'] = 'Jeton API';
$lang['allow_rescheduling_cancellation_before'] = 'Autoriser la modification/annulation de rendez-vous avant';
...
$lang['may_short'] = 'Mai';
$lang['june_short'] = 'Juin';
$lang['july_short'] = 'Juil';
$lang['august_short'] = 'Aoû';
...
$lang['week_short'] = 'Se';
$lang['scroll_to_increment'] = 'Faire défiler pour augmenter';
$lang['year'] = 'Année';
$lang['make_non_working_day'] = 'Ce prestataire ne sera pas disponible les jours sélectionnés.';
$lang['no_breaks'] = 'Aucune pause';
$lang['service_categories'] = 'Catégories de service';
$lang['service_category'] = 'Catégorie de service';
$lang['blocked_period_saved'] = 'Période d’indisponibilité sauvegardée.';
$lang['blocked_period_deleted'] = 'Période d’indisponibilité supprimée.';
$lang['delete_blocked_period'] = 'Supprimer la période d’indisponibilité';
$lang['blocked_period'] = 'Période d’indisponibilité';
$lang['blocked_periods'] = 'Périodes d’indisponibilité';
$lang['blocked_period_save'] = 'Enregistrer la période d’indisponibilité';
$lang['blocked_period_delete'] = 'Supprimer la période d’indisponibilité';
$lang['blocked_periods_hint'] = 'Définit les dates auxquelles les réservations sont impossibles pour tous les prestataires (ex. fermeture de l’établissement, vacances…).';
$lang['custom_field'] = 'Champs personnalisé';
$lang['custom_fields'] = 'Champs personnalisés';
$lang['label'] = 'Intitulé';
$lang['webhook_saved'] = 'Points de terminaison sauvegardé.';
$lang['webhook_deleted'] = 'Points de terminaison supprimé.';
$lang['delete_webhook'] = 'Supprimer le point de terminaison';
$lang['contact_info'] = 'Information du contact';
// End
