...
$lang['about_app'] = 'Au sujet d\'Car2dude';
...
$lang['about_app_info'] = 'Car2dude est une application Web hautement personnalisable qui permet à vos clients de prendre rendez-vous avec vous via le web. En outre, elle offre la possibilité de synchroniser vos données avec un calendrier Google afin que vous puissiez les utiliser avec d\'autres services. Car2dude est un projet open source et vous pouvez le télécharger et l\'installer même pour un usage commercial. Car2dude fonctionnera sans problème avec votre site web existant car il peut être installé dans un dossier spécifique du serveur et bien sûr, les deux sites peuvent partager la même base de données.';
...
$lang['about_app_license'] = 'Car2dude est enregistré sous licence GPLv3. En utilisant le code d\'Car2dude, quelqu\'en soit l\'usage, vous êtes tenu d\'accepter les termes décrits dans l\'URL suivante:';
...
$lang['ea_update_success'] = 'Car2dude à été mis à jour avec succès .';
