...
$lang['enter_password_here'] = 'Kirjoita salasana tähän ...';
$lang['login'] = 'Kirjaudu';
...
$lang['unexpected_issues_message'] = 'Toimintoa ei voitu suorittaa.';
$lang['close'] = 'Sulje';
...
$lang['personal_information'] = 'Henkilötiedot';
...
$lang['enter_captcha_here'] = 'Syötä CAPTCHA tähän...';
...
$lang['service_selection_layout'] = 'Palvelun valinnan asettelu';
$lang['service_selection_layout_hint'] = 'Valitse, miten palvelut näytetään ensimmäisessä varausvaiheessa.';
$lang['dropdown'] = 'Pudotusvalikko';
$lang['accordion'] = 'Haitari';
$lang['hide_single_provider_selection'] = 'Piilota yksittäisen tarjoajan valinta';
$lang['hide_single_provider_selection_hint'] = 'Piilottaa tarjoajakentän, kun valitulla palvelulla on vain yksi saatavilla oleva tarjoaja.';
...
$lang['matomo_analytics_site_id'] = 'Matomo Analytics -sivuston tunnus';
...
$lang['host'] = 'Isäntä';
$lang['port'] = 'Portti';
$lang['user_dn'] = 'Käyttäjä DN';
$lang['base_dn'] = 'Kanta DN';
$lang['keyword'] = 'Avainsana';
$lang['ldap_search_hint'] = 'Anna avainsana, jolla etsitään käyttäjiä LDAP:sta.';
$lang['ldap_extension_not_loaded'] = 'LDAP PHP -laajennusta ei ole ladattu, mutta se vaaditaan tämän integraation toimimiseksi.';
$lang['field_mapping'] = 'Kenttien yhdistäminen';
...
$lang['secret_header'] = 'Salainen otsikko';
$lang['search'] = 'Hae';
$lang['slot_interval'] = 'Aikaväli (minuuttia)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Ota käyttöön automaattinen Jitsi-kokouslinkin luonti ajanvarauksille. Kun käytössä, jokaiselle ajanvaraukselle luodaan yksilöllinen Jitsi-videopuhelulinkki ja se tallennetaan kokouslinkkinä.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA on yksityisyyteen keskittyvä, avoimen lähdekoodin CAPTCHA-vaihtoehto, joka käyttää proof-of-work-menetelmää ihmiskäyttäjien vahvistamiseen ilman seurantaa.';
$lang['altcha_enabled_hint'] = 'Kun käytössä, ALTCHA:ta käytetään perinteisen kuva-CAPTCHA:n sijaan lomakkeiden vahvistuksessa.';
$lang['altcha_hmac_key'] = 'HMAC Key';
$lang['altcha_hmac_key_hint'] = 'Salainen avain, jota käytetään ALTCHA-haasteiden allekirjoittamiseen ja vahvistamiseen. Napsauta Luo luodaksesi uuden suojatun avaimen.';
$lang['altcha_max_number'] = 'Enimmäisluku';
$lang['altcha_max_number_hint'] = 'Proof-of-work-haasteen enimmäisluku. Suuremmat arvot lisäävät vaikeutta (oletus: 100000).';
$lang['altcha_expires'] = 'Vanhenee (sekuntia)';
$lang['altcha_expires_hint'] = 'Kuinka kauan haaste on voimassa sekunteina (oletus: 300).';
$lang['altcha_key_generated'] = 'Uusi HMAC-avain luotu onnistuneesti.';
$lang['altcha_enabled'] = 'Ota ALTCHA käyttöön';
$lang['altcha_captcha_not_active_warning'] = 'CAPTCHA-asetus ei ole tällä hetkellä aktiivinen. ALTCHA:ta ei käytetä, ellei CAPTCHA ole käytössä';
$lang['generate'] = 'Luo';
$lang['meeting_link'] = 'Kokouslinkki';
$lang['google_calendar'] = 'Google-kalenteri';
$lang['google_calendar_info'] = 'Ota käyttöön Google Calendar -synkronointi synkronoidaksesi ajanvaraukset palveluntarjoajien Google Calendar -tilien kanssa.';
$lang['google_client_id'] = 'Client ID';
$lang['google_client_id_info'] = 'Client ID Google Cloud Console -projektistasi.';
$lang['google_client_secret'] = 'Client Secret';
$lang['google_client_secret_info'] = 'Client Secret Google Cloud Console -projektistasi.';
$lang['google_calendar_setup_info'] = 'Ottaaksesi Google Calendar -synkronoinnin käyttöön, sinun on luotava projekti Google Cloud Consolessa, otettava käyttöön Google Calendar API ja luotava OAuth 2.0 -tunnistetiedot. Käy osoitteessa:';
$lang['google_meet_link_generation'] = 'Luo Google Meet -linkkejä';
$lang['google_meet_link_generation_info'] = 'Luo automaattisesti Google Meet -videoneuvottelulinkki synkronoiduille ajanvarauksille. Kokouslinkki tallennetaan ajanvarauksen kokouslinkki-kenttään.';
$lang['display_add_to_google_calendar'] = 'Näytä "Add to Google Calendar" -painike';
$lang['display_add_to_google_calendar_info'] = 'Näytä "Add to Google Calendar" -painike varausvahvistussivulla, jotta asiakkaat voivat helposti lisätä ajanvarauksensa henkilökohtaiseen Google Calendar -kalenteriinsa.';
$lang['select_all'] = 'Valitse kaikki';
$lang['select_none'] = 'Poista valinnat';
$lang['appointment_update'] = 'Varauksen päivitys';
$lang['notify_users_on_update_question'] = 'Haluatko lähettää ilmoituksen tästä muutoksesta?';
$lang['yes'] = 'Kyllä';
$lang['no'] = 'Ei';
$lang['latest_blog_posts'] = 'Uusimmat blogikirjoitukset';
$lang['loading'] = 'Ladataan';
$lang['blog_posts_load_error'] = 'Blogikirjoituksia ei voitu ladata. Vieraile virallisella sivustolla päivitysten saamiseksi.';
...
$lang['would_you_like_to_proceed'] = 'Haluatko jatkaa silti?';
$lang['proceed'] = 'Jatka';
$lang['no_available_service_providers'] = 'Ei saatavilla olevia palveluita';
$lang['no_available_service_providers_message'] = 'Tällä hetkellä ei ole saatavilla palveluita tai palveluntarjoajia varausta varten. Tarkista myöhemmin tai ota meihin yhteyttä.';
$lang['reset_password'] = 'Palauta salasana';
$lang['new_password'] = 'Uusi salasana';
$lang['enter_new_password'] = 'Kirjoita uusi salasanasi alle.';
$lang['enter_password_here'] = 'Kirjoita salasana tähän ...';
$lang['password_reset_request'] = 'Salasanan palautuspyyntö';
$lang['password_reset_email_message'] = 'Olet pyytänyt salasanan palautusta. Napsauta alla olevaa painiketta asettaaksesi uuden salasanan tilillesi.';
$lang['password_reset_link_expires'] = 'Tämä linkki vanhenee 1 tunnin kuluttua.';
$lang['password_reset_ignore_message'] = 'Jos et ole pyytänyt salasanan palautusta, jätä tämä sähköposti huomiotta.';
$lang['invalid_reset_token'] = 'Salasanan palautuslinkki on virheellinen.';
$lang['invalid_or_expired_token'] = 'Salasanan palautuslinkki on virheellinen tai vanhentunut. Ole hyvä ja pyydä uusi.';
$lang['password_reset_success'] = 'Salasanasi on palautettu onnistuneesti. Sinut ohjataan kirjautumissivulle.';
$lang['password_reset_failed'] = 'Salasanan palautus epäonnistui. Yritä uudelleen.';
$lang['no_password_provided'] = 'Anna salasana.';
$lang['type_username_and_email_for_reset_link'] = 'Kirjoita käyttäjätunnuksesi ja sähköpostiosoitteesi saadaksesi salasanan palautuslinkin.';
...
$lang['working_plan_validation_failed'] = 'Virheellinen työsuunnitelman määritys löydetty.';
$lang['start_date'] = 'Aloituspäivä';
$lang['end_date'] = 'Lopetuspäivä';
$lang['remember_me'] = 'Muista tietoni';
$lang['remember_me_hint'] = 'Tallenna tietosi nopeampaa varausta varten seuraavalla kerralla.';
$lang['legal_notice'] = 'Oikeudellinen ilmoitus';
$lang['legal_notice_url'] = 'Oikeudellinen ilmoitus URL';
$lang['legal_notice_url_hint'] = 'Syötä oikeudellisen ilmoituksen sivun URL.';
$lang['imprint'] = 'Sivuston tiedot';
$lang['imprint_url'] = 'Sivuston tiedot URL';
$lang['imprint_url_hint'] = 'Syötä sivuston tiedot -sivun URL.';
$lang['data_retention'] = 'Tietojen säilytys';
$lang['data_retention_days'] = 'Tietojen säilytyspäivät';
$lang['data_retention_days_hint'] = 'Aseta päivien lukumäärä, jonka jälkeen asiakastiedot poistetaan automaattisesti. Aseta arvoksi 0 poistaaksesi automaattisen poiston käytöstä.';
$lang['manage_privacy'] = 'Hallitse yksityisyyttä';
$lang['manage_privacy_hint'] = 'Napsauta alla olevaa linkkiä nähdäksesi, päivittääksesi tai poistaaksesi henkilötietosi.';
$lang['personal_information'] = 'Henkilötiedot';
$lang['personal_information_updated'] = 'Henkilötietosi on päivitetty onnistuneesti.';
$lang['verify'] = 'Vahvista';
$lang['verifying'] = 'Vahvistetaan';
$lang['verified'] = 'Vahvistettu';
$lang['verification_complete'] = 'Vahvistus valmis';
$lang['verification_failed'] = 'Vahvistus epäonnistui. Napsauta yrittääksesi uudelleen.';
$lang['click_to_verify'] = 'Napsauta vahvistaaksesi, että olet ihminen';
$lang['altcha_verification_failed'] = 'ALTCHA-vahvistus epäonnistui. Yritä uudelleen.';
