...
$lang['service_communication_error'] = 'Yhteys palvelimeen katkesi, yritä uudelleen.';
...
$lang['time_format_hint'] = 'Muuta ajan näyttömuotoa (H - tunnit, M - minuutit).';
...
$lang['availabilities_type'] = 'Saatavuustyyppi';
$lang['flexible'] = 'Joustava';
$lang['fixed'] = 'Kiinteä';
$lang['attendants_number'] = 'Henkilön numero';
$lang['reset_working_plan'] = 'Tyhjennä työsuunnitelma oletusarvoille';
$lang['legal_contents'] = 'Oikeudelliset sisällöt';
$lang['cookie_notice'] = 'Evästeilmoitus';
$lang['display_cookie_notice'] = 'Näytä evästeilmoitus';
$lang['cookie_notice_content'] = 'Evästeilmoituksen sisältö';
...
$lang['display_privacy_policy'] = 'Näytä tietosuojakäytäntö';
$lang['privacy_policy_content'] = 'Tietosuojakäytännön sisältö';
$lang['website_using_cookies_to_ensure_best_experience'] = 'Tämä sivusto käyttää evästeitä varmistaakseen parhaan käyttökokemuksen.';
$lang['read_and_agree_to_terms_and_conditions'] = 'Olen lukenut ja hyväksyn {$link}käyttöehdot{/$link}.';
$lang['read_and_agree_to_privacy_policy'] = 'Olen lukenut ja hyväksyn {$link}tietosuojakäytännön{/$link}.';
$lang['delete_personal_information_hint'] = 'Poista järjestelmästä kaikki varauksesi ja henkilökohtaiset tietosi.';
$lang['delete_personal_information'] = 'Poista henkilökohtaiset tiedot';
$lang['delete_personal_information_prompt'] = 'Oletko varma että haluat poistaa kaikki henkilökohtaiset tietosi järjestelmästä? Tätä toimintoa ei voi kumota.';
...
$lang['working_plan_exceptions_hint'] = 'Lisää työsuunnitelman poikkeuspäivä työsuunnitelman ulkopuolelle.';
$lang['new_working_plan_exception_title'] = 'Uusi työsuunnitelman poikkeus';
$lang['working_plan_exception_saved'] = 'Työsuunnitelman poikkeus tallennettiin onnistuneesti.';
$lang['working_plan_exception_deleted'] = 'Työsuunnitelman poikkeus poistettiin onnistuneesti.';
$lang['add_working_plan_exceptions_during_each_day'] = 'Lisää työsuunnitelman poikkeus jokaiselle päivälle.';
$lang['add_working_plan_exception'] = 'Lisää työsuunnitelman poikkeus';
$lang['require_phone_number'] = 'Vaadi puhelinnumeroa';
$lang['require_phone_number_hint'] = 'Jos aktivoitu, asiakkaan pitää syöttää puhelinnumero varauksen lisäämisen yhteydessä.';
$lang['check_spam_folder'] = 'Jos et löydä sähköpostia, tarkista roskapostikansio.';
$lang['api_token_hint'] = 'Aseta salainen token ottaaksesi käyttöön Easy!Appointments API:n token-pohjaisen todennuksen.';
$lang['timezone'] = 'Aikavyöhyke';
$lang['overwrite_existing_working_plans'] = 'Tämä toiminto ylikirjoittaa kaikki olemassa olevat työsuunnitelmat. Haluatko varmasti jatkaa?';
$lang['working_plans_got_updated'] = 'Kaikki työsuunnitelmat päivitettiin onnistuneesti.';
$lang['apply_to_all_providers'] = 'Käytä kaikkiin palveluntuottajiin';
$lang['display_any_provider'] = 'Näytä mikä tahansa palveluntuottaja';
$lang['display_any_provider_hint'] = 'Varaussivulle lisätään vaihtoehto, jonka avulla asiakkaat voivat tehdä varauksen ilmoittamatta palveluntarjoajaa.';
