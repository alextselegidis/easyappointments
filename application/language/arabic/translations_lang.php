...
$lang['confirm'] = 'تأكيد';
$lang['update'] = 'تحديث';
$lang['cancel_appointment_hint'] = ' .إضغط زر "إلغاء الموعد" لحذف الموعد من الجدول';
$lang['cancel'] = 'إلغاء';
...
$lang['enter_password_here'] = 'أدخل كلمة المرور هنا ...';
...
$lang['unexpected_issues_message'] = 'لا يمكن إتمام العملية.';
$lang['close'] = 'إغلاق';
...
$lang['enter_captcha_here'] = 'أدخل رمز CAPTCHA هنا...';
...
$lang['matomo_analytics'] = 'تحليلات Matomo';
...
$lang['google_analytics_code'] = 'رمز Google Analytics';
$lang['matomo_analytics_url'] = 'رابط Matomo Analytics';
...
$lang['no_breaks'] = 'لا توجد استراحات';
...
$lang['secret_header'] = 'الرأس السري';
$lang['search'] = 'بحث';
$lang['slot_interval'] = 'فترة الفتحة الزمنية (دقائق)';
$lang['jitsi'] = 'جيتسي';
$lang['jitsi_info'] = 'تمكين إنشاء رابط اجتماع Jitsi تلقائياً للمواعيد. عند التمكين، سيتم إنشاء رابط مكالمة فيديو Jitsi فريد وتخزينه كرابط الاجتماع.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA هو بديل CAPTCHA مفتوح المصدر يركز على الخصوصية ويستخدم إثبات العمل للتحقق من المستخدمين البشريين دون تتبع.';
$lang['altcha_enabled_hint'] = 'عند التمكين، سيتم استخدام ALTCHA بدلاً من CAPTCHA التقليدي بالصور للتحقق من النماذج.';
$lang['altcha_hmac_key'] = 'مفتاح HMAC';
$lang['altcha_hmac_key_hint'] = 'مفتاح سري يُستخدم لتوقيع تحديات ALTCHA والتحقق منها. انقر على إنشاء لإنشاء مفتاح آمن جديد.';
$lang['altcha_max_number'] = 'الحد الأقصى للرقم';
$lang['altcha_max_number_hint'] = 'الحد الأقصى للرقم في تحدي إثبات العمل. القيم الأعلى تزيد من الصعوبة (الافتراضي: 100000).';
$lang['altcha_expires'] = 'انتهاء الصلاحية (ثوانٍ)';
$lang['altcha_expires_hint'] = 'المدة التي يظل فيها التحدي صالحاً بالثواني (الافتراضي: 300).';
$lang['altcha_key_generated'] = 'تم إنشاء مفتاح HMAC جديد بنجاح.';
$lang['altcha_enabled'] = 'تمكين ALTCHA';
$lang['altcha_captcha_not_active_warning'] = 'إعداد CAPTCHA غير مفعّل حالياً. لن يتم استخدام ALTCHA ما لم يتم تفعيل CAPTCHA في';
$lang['generate'] = 'إنشاء';
$lang['meeting_link'] = 'رابط الاجتماع';
$lang['google_calendar'] = 'تقويم جوجل';
$lang['google_calendar_info'] = 'تمكين مزامنة Google Calendar لمزامنة المواعيد مع حسابات Google Calendar الخاصة بمقدمي الخدمة.';
$lang['google_client_id'] = 'معرّف العميل';
$lang['google_client_id_info'] = 'معرّف العميل من مشروع Google Cloud Console الخاص بك.';
$lang['google_client_secret'] = 'سر العميل';
$lang['google_client_secret_info'] = 'سر العميل من مشروع Google Cloud Console الخاص بك.';
$lang['google_calendar_setup_info'] = 'لتمكين مزامنة Google Calendar، تحتاج إلى إنشاء مشروع في Google Cloud Console وتمكين Google Calendar API وإنشاء بيانات اعتماد OAuth 2.0. قم بزيارة:';
$lang['google_meet_link_generation'] = 'إنشاء روابط Google Meet';
$lang['google_meet_link_generation_info'] = 'إنشاء رابط مؤتمر فيديو Google Meet تلقائياً للمواعيد المتزامنة. سيتم تخزين رابط الاجتماع في حقل رابط اجتماع الموعد.';
$lang['display_add_to_google_calendar'] = 'عرض زر "إضافة إلى Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'عرض زر "إضافة إلى Google Calendar" في صفحة تأكيد الحجز، مما يتيح للعملاء إضافة موعدهم بسهولة إلى تقويم Google Calendar الشخصي.';
$lang['select_all'] = 'تحديد الكل';
$lang['select_none'] = 'إلغاء تحديد الكل';
$lang['appointment_update'] = 'تحديث الموعد';
$lang['notify_users_on_update_question'] = 'هل ترغب في إرسال إشعار بشأن هذا التغيير؟';
$lang['yes'] = 'نعم';
$lang['no'] = 'لا';
$lang['latest_blog_posts'] = 'أحدث مقالات المدونة';
$lang['loading'] = 'جاري التحميل';
$lang['blog_posts_load_error'] = 'تعذر تحميل منشورات المدونة. يرجى زيارة الموقع الرسمي للحصول على التحديثات.';
...
$lang['would_you_like_to_proceed'] = 'هل تريد المتابعة على أي حال؟';
$lang['proceed'] = 'متابعة';
$lang['no_available_service_providers'] = 'لا توجد خدمات متاحة';
$lang['no_available_service_providers_message'] = 'لا توجد حاليًا خدمات أو مقدمي خدمات متاحين للحجز. يرجى المراجعة لاحقًا أو الاتصال بنا للمساعدة.';
...
$lang['password_reset_failed'] = 'فشل إعادة تعيين كلمة المرور. يرجى المحاولة مرة أخرى.';
$lang['no_password_provided'] = 'يرجى إدخال كلمة مرور.';
$lang['type_username_and_email_for_reset_link'] = 'اكتب اسم المستخدم وعنوان البريد الإلكتروني للحصول على رابط إعادة تعيين كلمة المرور.';
$lang['send_reset_link'] = 'إرسال رابط إعادة التعيين';
...
$lang['working_plan_validation_failed'] = 'تم العثور على تكوين خطة عمل غير صالح.';
$lang['start_date'] = 'تاريخ البداية';
$lang['end_date'] = 'تاريخ النهاية';
$lang['remember_me'] = 'تذكر معلوماتي';
$lang['remember_me_hint'] = 'احفظ بياناتك لحجز أسرع في المرة القادمة.';
$lang['legal_notice'] = 'إشعار قانوني';
$lang['legal_notice_url'] = 'رابط الإشعار القانوني';
$lang['legal_notice_url_hint'] = 'أدخل رابط صفحة الإشعار القانوني الخاصة بك.';
$lang['imprint'] = 'بيانات الناشر';
$lang['imprint_url'] = 'رابط بيانات الناشر';
$lang['imprint_url_hint'] = 'أدخل رابط صفحة بيانات الناشر الخاصة بك.';
$lang['data_retention'] = 'الاحتفاظ بالبيانات';
$lang['data_retention_days'] = 'أيام الاحتفاظ بالبيانات';
$lang['data_retention_days_hint'] = 'حدد عدد الأيام التي سيتم بعدها حذف بيانات العملاء تلقائياً. اضبط على 0 لتعطيل الحذف التلقائي.';
$lang['manage_privacy'] = 'إدارة الخصوصية';
$lang['manage_privacy_hint'] = 'انقر على الرابط أدناه لعرض معلوماتك الشخصية أو تحديثها أو حذفها.';
$lang['personal_information_updated'] = 'تم تحديث معلوماتك الشخصية بنجاح.';
$lang['verify'] = 'تحقق';
$lang['verifying'] = 'جارٍ التحقق';
$lang['verified'] = 'تم التحقق';
$lang['verification_complete'] = 'اكتمل التحقق';
$lang['verification_failed'] = 'فشل التحقق. انقر لإعادة المحاولة.';
$lang['click_to_verify'] = 'انقر للتحقق من أنك إنسان';
$lang['altcha_verification_failed'] = 'فشل التحقق من ALTCHA. يرجى المحاولة مرة أخرى.';
...
$lang['caldav'] = 'CalDAV';
$lang['caldav_info'] = 'زامن مواعيد مقدمي الخدمة لديك مع خادم تقويم CalDAV، وتحكم في المضيفين الذين يُسمح للمزامنة بالاتصال بهم.';
$lang['caldav_allowed_hosts'] = 'عناوين الاتصال المسموح بها';
$lang['caldav_allowed_hosts_info'] = 'تُرفض عناوين CalDAV التي تشير إلى عنوان شبكة خاص أو محجوز، حتى لا يتمكن عنوان يُدخل في لوحة الإدارة من الوصول إلى الشبكة الداخلية لهذا التثبيت. أضف عنوان اتصال واحدًا أو اسم مضيف واحدًا في كل سطر للسماح به رغم ذلك. أضف الخوادم التي تديرها بنفسك فقط.';
$lang['caldav_sync_failed'] = 'فشلت مزامنة CalDAV';
$lang['caldav_sync_failed_url'] = 'تعذر استخدام عنوان الاتصال المحفوظ. إذا كان خادم CalDAV لديك يعمل على شبكتك المحلية، فأضف عنوانه في الإعدادات، التكاملات، CalDAV. وإلا فعطّل المزامنة وأعد الاتصال بعنوان صحيح.';
$lang['caldav_sync_failed_credentials'] = 'رفض خادم CalDAV اسم المستخدم وكلمة المرور. عطّل المزامنة وأعد الاتصال ببيانات صحيحة.';
$lang['caldav_sync_failed_unreachable'] = 'تعذر الوصول إلى خادم CalDAV. تأكد من أنه يعمل وأن عنوان الاتصال صحيح.';
$lang['caldav_private_host_warning'] = 'هذا الخادم على شبكة خاصة. سيؤدي الاتصال إلى إضافة مضيفه إلى عناوين الاتصال المسموح بها.';
$lang['caldav_allow_host_and_connect'] = 'السماح والاتصال';
// End
