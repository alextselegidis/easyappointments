...
$lang['appointment_locked_message'] = 'De afspraak kan niet minder dan {$limit} uur van tevoren worden gewijzigd.';
...
$lang['disable_sync_prompt'] = 'Weet u zeker dat u de kalender synchronisatie wilt uitschakelen?';
...
$lang['invalid_duration'] = 'Ongeldige duur.';
...
$lang['support_group'] = 'Ondersteuningsgroep';
...
$lang['enter_password_here'] = 'Voer hier het wachtwoord in ...';
$lang['login'] = 'Inloggen';
...
$lang['unexpected_issues_message'] = 'De bewerking kon niet worden voltooid.';
$lang['close'] = 'Sluit';
...
$lang['enter_captcha_here'] = 'Voer CAPTCHA hier in...';
...
$lang['time_format_hint'] = 'Wijzig het tijdweergaveformaat (H - Uren, M - Minuten).';
$lang['first_weekday'] = 'Eerste dag van de week';
$lang['first_weekday_hint'] = 'Stel de eerste dag van de kalenderweek in.';
...
$lang['service_selection_layout'] = 'Indeling service selectie';
$lang['service_selection_layout_hint'] = 'Kies hoe services worden weergegeven in de eerste boekingsstap.';
$lang['dropdown'] = 'Dropdown';
$lang['accordion'] = 'Accordeon';
$lang['hide_single_provider_selection'] = 'Selectie bij één aanbieder verbergen';
$lang['hide_single_provider_selection_hint'] = 'Verbergt het aanbiedersveld wanneer de geselecteerde service slechts één beschikbare aanbieder heeft.';
...
$lang['appointment_status_options_info'] = 'Definieer een lijst met beschikbare afspraakstatusopties die kunnen worden gebruikt op de kalenderpagina (de eerste wordt automatisch de standaardwaarde).';
...
$lang['pm'] = 'pm';
$lang['to'] = 'tot';
$lang['click_to_toggle'] = 'Klik om te wisselen';
$lang['week_short'] = 'Wk';
$lang['scroll_to_increment'] = 'Scroll om te verhogen';
$lang['year'] = 'Jaar';
$lang['make_non_working_day'] = 'Deze aanbieder is niet beschikbaar voor werk op de geselecteerde dag.';
$lang['no_breaks'] = 'Geen pauzes';
$lang['service_categories'] = 'Dienstcategorieën';
$lang['service_category'] = 'Dienstcategorie';
$lang['blocked_period_saved'] = 'Geblokkeerde periode succesvol opgeslagen.';
$lang['blocked_period_deleted'] = 'Geblokkeerde periode succesvol verwijderd.';
$lang['delete_blocked_period'] = 'Verwijder geblokkeerde periode';
$lang['blocked_period'] = 'Geblokkeerde periode';
$lang['blocked_periods'] = 'Geblokkeerde periodes';
$lang['blocked_period_save'] = 'Geblokkeerde periode opslaan';
$lang['blocked_period_delete'] = 'Geblokkeerde periode verwijderen';
$lang['blocked_periods_hint'] = 'Definieer periodes waarin openbare boekingen voor alle aanbieders worden uitgeschakeld (bijv. sluitingsdagen, vakanties, enz.).';
$lang['custom_field'] = 'Aangepast veld';
$lang['custom_fields'] = 'Aangepaste velden';
$lang['label'] = 'Label';
$lang['webhook_saved'] = 'Webhook succesvol opgeslagen.';
$lang['webhook_deleted'] = 'Webhook succesvol verwijderd.';
$lang['delete_webhook'] = 'Verwijder webhook';
$lang['contact_info'] = 'Contactgegevens';
$lang['hide_from_public'] = 'Verbergen voor publiek';
$lang['matomo_analytics_site_id'] = 'Matomo Analytics Site-ID';
$lang['matomo_analytics_site_id_hint'] = 'Stel de site-ID in die door Matomo wordt gevolgd (de standaardsite heeft ID "1").';
$lang['default_timezone'] = 'Standaardtijdzone';
$lang['default_timezone_hint'] = 'Stel de standaardtijdzone in die wordt gebruikt voor nieuwe records.';
$lang['default_language'] = 'Standaardtaal';
$lang['default_language_hint'] = 'Stel de standaardtaal in die wordt gebruikt voor nieuwe records.';
$lang['sync_method_prompt'] = 'Welke synchronisatiemethode wilt u gebruiken?';
$lang['caldav_server'] = 'CalDAV-server';
$lang['caldav_connection_info_prompt'] = 'Voer de verbindingsgegevens in van de doel CalDAV-agenda.';
$lang['connect'] = 'Verbinden';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Met deze integratie kunt u verbinding maken met een bestaande LDAP-server en automatisch gebruikers importeren in Easy!Appointments en hen SSO laten gebruiken met hun directorywachtwoord (gebruikersnaam moet overeenkomen).';
$lang['host'] = 'Host';
$lang['port'] = 'Poort';
$lang['user_dn'] = 'Gebruiker DN';
$lang['base_dn'] = 'Basis DN';
$lang['keyword'] = 'Trefwoord';
$lang['ldap_search_hint'] = 'Voer een trefwoord in om in de LDAP-directory te zoeken naar gebruikers die aan het filter voldoen.';
$lang['ldap_extension_not_loaded'] = 'De LDAP PHP-extensie is niet geladen, maar is vereist voor deze integratie.';
$lang['field_mapping'] = 'Veldtoewijzing';
$lang['content'] = 'Inhoud';
$lang['active'] = 'Actief';
$lang['user_imported'] = 'Het gebruikersrecord is succesvol geïmporteerd.';
$lang['import'] = 'Importeren';
$lang['ldap_dn'] = 'LDAP DN';
$lang['role'] = 'Rol';
$lang['at_least_one_field_required'] = 'Er moet minstens één veld als verplicht worden ingesteld op de boekingspagina.';
$lang['customer_is_already_booked'] = 'Deze klant heeft al een afspraak in de gevraagde periode.';
$lang['fields'] = 'Velden';
$lang['invalid_credentials_provided'] = 'Ongeldige inloggegevens, probeer het opnieuw.';
$lang['calendar_url'] = 'Agenda-URL';
$lang['please_select'] = 'Selecteer alstublieft';
$lang['secret_header'] = 'Geheime header';
$lang['search'] = 'Zoeken';
$lang['slot_interval'] = 'Tijdslot-interval (Minuten)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Schakel automatische Jitsi-vergaderlinkgeneratie in voor afspraken. Wanneer ingeschakeld, wordt een unieke Jitsi-videogespreklink gegenereerd en opgeslagen als vergaderlink.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA is een privacygericht, open-source CAPTCHA-alternatief dat proof-of-work gebruikt om menselijke gebruikers te verifiëren zonder tracking.';
$lang['altcha_enabled_hint'] = 'Wanneer ingeschakeld, wordt ALTCHA gebruikt in plaats van de traditionele afbeelding-CAPTCHA voor formulierverificatie.';
$lang['altcha_hmac_key'] = 'HMAC Key';
$lang['altcha_hmac_key_hint'] = 'Een geheime sleutel die wordt gebruikt om ALTCHA-uitdagingen te ondertekenen en te verifiëren. Klik op Genereren om een nieuwe beveiligde sleutel aan te maken.';
$lang['altcha_max_number'] = 'Maximaal aantal';
$lang['altcha_max_number_hint'] = 'Het maximale aantal voor de proof-of-work-uitdaging. Hogere waarden verhogen de moeilijkheidsgraad (standaard: 100000).';
$lang['altcha_expires'] = 'Verloopt (Seconden)';
...
$lang['google_calendar_info'] = 'Schakel Google Calendar-synchronisatie in om afspraken te synchroniseren met de Google Calendar-accounts van aanbieders.';
$lang['google_client_id'] = 'Client-ID';
$lang['google_client_id_info'] = 'De Client-ID van uw Google Cloud Console-project.';
$lang['google_client_secret'] = 'Clientgeheim';
$lang['google_client_secret_info'] = 'Het Clientgeheim van uw Google Cloud Console-project.';
$lang['google_calendar_setup_info'] = 'Om Google Calendar-synchronisatie in te schakelen, moet u een project aanmaken in de Google Cloud Console, de Google Calendar API inschakelen en OAuth 2.0-referenties aanmaken. Bezoek:';
$lang['google_meet_link_generation'] = 'Google Meet-links genereren';
$lang['google_meet_link_generation_info'] = 'Automatisch een Google Meet-videoconferentielink aanmaken voor gesynchroniseerde afspraken. De vergaderlink wordt opgeslagen in het vergaderlinkveld van de afspraak.';
$lang['display_add_to_google_calendar'] = '"Toevoegen aan Google Calendar"-knop weergeven';
$lang['display_add_to_google_calendar_info'] = 'De "Toevoegen aan Google Calendar"-knop weergeven op de boekingsbevestigingspagina, zodat klanten hun afspraak eenvoudig aan hun persoonlijke Google Calendar kunnen toevoegen.';
$lang['select_all'] = 'Alles selecteren';
$lang['select_none'] = 'Niets selecteren';
$lang['appointment_update'] = 'Afspraak bijwerken';
$lang['notify_users_on_update_question'] = 'Wilt u een melding over deze wijziging versturen?';
$lang['yes'] = 'Ja';
$lang['no'] = 'Nee';
$lang['latest_blog_posts'] = 'Laatste blogberichten';
$lang['loading'] = 'Laden';
$lang['blog_posts_load_error'] = 'Kan blogberichten niet laden. Bezoek de officiële website voor updates.';
...
$lang['would_you_like_to_proceed'] = 'Wilt u toch doorgaan?';
$lang['proceed'] = 'Doorgaan';
$lang['no_available_service_providers'] = 'Geen beschikbare diensten';
$lang['no_available_service_providers_message'] = 'Er zijn momenteel geen diensten of aanbieders beschikbaar voor boeking. Kom later terug of neem contact met ons op voor hulp.';
$lang['reset_password'] = 'Wachtwoord opnieuw instellen';
$lang['new_password'] = 'Nieuw wachtwoord';
$lang['enter_new_password'] = 'Voer hieronder uw nieuwe wachtwoord in.';
$lang['enter_password_here'] = 'Voer hier het wachtwoord in ...';
$lang['password_reset_request'] = 'Verzoek om wachtwoord opnieuw in te stellen';
...
$lang['password_reset_failed'] = 'Wachtwoord opnieuw instellen mislukt. Probeer het opnieuw.';
$lang['no_password_provided'] = 'Voer een wachtwoord in.';
$lang['type_username_and_email_for_reset_link'] = 'Voer uw gebruikersnaam en e-mailadres in om een link voor het opnieuw instellen van uw wachtwoord te ontvangen.';
$lang['send_reset_link'] = 'Stuur resetlink';
...
$lang['working_plan_validation_failed'] = 'Ongeldige werkplanconfiguratie gevonden.';
$lang['start_date'] = 'Startdatum';
$lang['end_date'] = 'Einddatum';
$lang['remember_me'] = 'Mijn gegevens onthouden';
$lang['remember_me_hint'] = 'Sla uw gegevens op voor een snellere boeking de volgende keer.';
$lang['legal_notice'] = 'Juridische kennisgeving';
$lang['legal_notice_url'] = 'URL juridische kennisgeving';
$lang['legal_notice_url_hint'] = 'Voer de URL in naar uw pagina met juridische kennisgeving.';
$lang['imprint'] = 'Impressum';
$lang['imprint_url'] = 'Impressum-URL';
$lang['imprint_url_hint'] = 'Voer de URL in naar uw impressumpagina.';
$lang['data_retention'] = 'Gegevensbewaring';
$lang['data_retention_days'] = 'Gegevensbewaringsdagen';
$lang['data_retention_days_hint'] = 'Stel het aantal dagen in waarna klantgegevens automatisch worden verwijderd. Stel in op 0 om automatische verwijdering uit te schakelen.';
$lang['manage_privacy'] = 'Privacy beheren';
$lang['manage_privacy_hint'] = 'Klik op de onderstaande link om uw persoonlijke informatie te bekijken, bij te werken of te verwijderen.';
$lang['personal_information'] = 'Persoonlijke informatie';
$lang['personal_information_updated'] = 'Uw persoonlijke informatie is succesvol bijgewerkt.';
$lang['verify'] = 'Verifiëren';
$lang['verifying'] = 'Verifiëren...';
$lang['verified'] = 'Geverifieerd';
$lang['verification_complete'] = 'Verificatie voltooid';
$lang['verification_failed'] = 'Verificatie mislukt. Klik om opnieuw te proberen.';
$lang['click_to_verify'] = 'Klik om te verifiëren dat u een mens bent';
$lang['altcha_verification_failed'] = 'ALTCHA-verificatie mislukt. Probeer het opnieuw.';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = 'Wij bieden uitgebreide diensten voor zelf gehoste software, waaronder maatwerkontwikkeling, beheerde hosting, ondersteuningscontracten, rebranding en doorlopende verbeteringen — zodat u zich kunt richten op uw bedrijf terwijl wij de rest verzorgen.';
