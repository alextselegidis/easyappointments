...
$lang['thank_you_for_appointment'] =
    'Tack för din bokning hos oss. Här nedan kan du se information om bokningen. Klicka på länken till bokningen för att göra ändringar.';
...
$lang['company_email_hint'] =
    'Detta är företagets epostadress. Den kommer användas som avsändare och mottagare av systemets epostmeddelanden. (obligatorisk)';
...
$lang['edit_working_plan_hint'] =
    'Markera de dagar och timmar ni kan boka. Ni komer kunna justera bokningar utanför angivna tider, men kunder kan inte boka utanför de angivna tiderna. Detta schema kommer vara standard för alla leverantörer, men går att redigera. Därefter kan du lägga till raster.';
$lang['edit_breaks_hint'] =
    'Lägg till raster varje dag. Dessa kommer att tillde3las standardschemat för alla leverantörer.';
$lang['book_advance_timeout'] = 'Blockera bokning';
$lang['book_advance_timeout_hint'] =
    'Definiera tiden (i minuter) kunderna måste vänta innan de kan boka eller ändra en bokning hos företaget.';
$lang['timeout_minutes'] = 'Paus (minutter)';
$lang['about_app_info'] =
    'Easy!Appointments är ett system som gör det möjligt för dina kunder att, via internet, boka tid för tjänster hos er. Bokningarna kan synkroniseras med dina leverantörers Google-kalendrar så att de bli tillgängliga även för andra tjänster.';
$lang['current_version'] = 'Nuvarande version';
$lang['support'] = 'Support';
$lang['about_app_support'] =
    'Om du stöter på problem när du använder Easy!Appointments kan du söka i den officiella Google-gruppen för support. Du kan även underlätta för utvecklarna genom att registrera ett ärende på GitHub-sidan.';
...
$lang['about_app_license'] =
    'Easy!Appointments använder GPLv3 licensen. Genom att använda koden till Easy!Appointments på något sätt accepterar du villkoren i följande url.';
$lang['logout_success'] =
    'Du har blivit utloggad! Klicka på någon av följande knappar för att komma till en annan sida.';
...
$lang['type_username_and_email_for_new_password'] =
    'Skriv ditt användarnamn och epostadress for att få ett nytt lösenord.';
...
$lang['new_password_is'] =
    'Ditt nya lösenord är $password  Spara detta meddelande så att du kan hitta ditt lösenord senare. Du kan byta lösenord i inställningarna.';
...
$lang['page_not_found_message'] =
    'Sidan du söker finns inte. Dubbelkolla url:en i din webbläsare eller tryck på någon av knapparna nedan. ';
$lang['error'] = 'Fel';
...
$lang['select_google_calendar_prompt'] =
    'Välj den kalender du vill ha bokningen i. Om du inte väljer hamnar den i din standardkalender.';
...
$lang['require_captcha_hint'] =
    'När denna är aktiv måste kunderna skriva lite slumpmässig text innann de kan göra/ändra en bokning.';
...
$lang['customer_notifications_hint'] =
    'Talar om huruvida kunderna ska få notiser varje gång det sker en förändring på deras bokning(ar).';
...
$lang['delete_personal_information_prompt'] =
    'Är du säker på att du vill ta bort all information om dig från systemet? Det går inte att återställa informationen om du ångrar dig.';
$lang['location'] = 'Plats';
...
$lang['require_phone_number_hint'] =
    'När denna är aktiv måste kunderna ange ett telefonnummer för att kunna göra en bokning.';
$lang['check_spam_folder'] = 'Om eposten inte kommit fram inom några minuter; kolla skräpposten.';
$lang['api_token_hint'] =
    'Ställ in en hemlig token för att aktivera tokenbaserad autentisering av Easy!Appointments API.';
$lang['timezone'] = 'Tidszon';
$lang['overwrite_existing_working_plans'] =
    'Detta kommer skriva över befintliga leverantörsscheman. Är du säker på att du vill det?';
