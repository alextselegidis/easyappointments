...
$lang['require_captcha_hint'] = 'När den är aktiverad måste kunderna möta en CAPTCHA-utmaning innan de bokar / uppdaterar ett möte för att bevisa att de inte är en robot.';
$lang['none'] = 'Ingen';
$lang['recaptcha_server_token'] = 'reCAPTCHA servertoken';
$lang['recaptcha_client_token'] = 'reCAPTCHA klienttoken';
$lang['recaptcha_hint'] = 'Gå till administratörswebbplatsen för google recaptcha för att konfigurera en reCAPTCHA v2-domän och få din server och klienttoken.';
$lang['recaptcha_warning'] = 'Du ansvarar för att uppdatera din integritetspolicy på lämpligt sätt för att följa lokala lagar när du använder reCAPTCHA!';
