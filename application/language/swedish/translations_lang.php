...
$lang['enter_password_here'] = 'Ange lösenord här ...';
$lang['login'] = 'Logga in';
...
$lang['unexpected_issues_message'] = 'Åtgärden kunde inte slutföras.';
$lang['close'] = 'Stäng';
...
$lang['notify_customer_on_update_question'] = 'Vill du meddela kunden om denna ändring?';
$lang['yes'] = 'Ja';
$lang['no'] = 'Nej';
$lang['latest_blog_posts'] = 'Senaste blogginlägg';
$lang['loading'] = 'Laddar';
$lang['blog_posts_load_error'] = 'Kan inte ladda blogginlägg. Besök den officiella webbplatsen för uppdateringar.';
$lang['would_you_like_to_proceed'] = 'Would you like to proceed anyway?';
$lang['proceed'] = 'Proceed';
$lang['no_available_service_providers'] = 'Inga tillgängliga tjänster';
$lang['no_available_service_providers_message'] = 'Det finns för närvarande inga tjänster eller leverantörer tillgängliga för bokning. Vänligen kontrollera senare eller kontakta oss för hjälp.';
$lang['reset_password'] = 'Återställ lösenord';
$lang['new_password'] = 'Nytt lösenord';
$lang['enter_new_password'] = 'Ange ditt nya lösenord nedan.';
$lang['enter_password_here'] = 'Ange lösenord här ...';
$lang['password_reset_request'] = 'Begäran om lösenordsåterställning';
$lang['password_reset_email_message'] = 'Du har begärt att återställa ditt lösenord. Klicka på knappen nedan för att ställa in ett nytt lösenord för ditt konto.';
$lang['password_reset_link_expires'] = 'Denna länk upphör att gälla om 1 timme.';
$lang['password_reset_ignore_message'] = 'Om du inte har begärt en lösenordsåterställning, vänligen ignorera detta e-postmeddelande.';
$lang['invalid_reset_token'] = 'Länken för att återställa lösenordet är ogiltig.';
$lang['invalid_or_expired_token'] = 'Länken för att återställa lösenordet är ogiltig eller har gått ut. Vänligen begär en ny.';
$lang['password_reset_success'] = 'Ditt lösenord har återställts. Du kommer att omdirigeras till inloggningssidan.';
$lang['password_reset_failed'] = 'Lösenordsåterställning misslyckades. Försök igen.';
$lang['no_password_provided'] = 'Ange ett lösenord.';
$lang['type_username_and_email_for_reset_link'] = 'Ange ditt användarnamn och e-postadress för att få en länk för att återställa lösenordet.';
$lang['send_reset_link'] = 'Skicka återställningslänk';
$lang['reset_link_sent_with_email'] = 'Om ett konto finns med de angivna uppgifterna har en länk för att återställa lösenordet skickats till din e-post.';
$lang['provider_has_conflicting_appointment'] = 'Den valda leverantören har redan en annan bokning vid den tiden. Vänligen välj en annan tid eller leverantör.';
// End
