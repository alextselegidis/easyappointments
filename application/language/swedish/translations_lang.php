...
$lang['about_app_info'] = 'Car2dude är ett system som gör det böjligt för dina kunder att boka tid för tjänster hos er via internet. Bokningarna kan synkroniseras med dina leverantörers Google-kalendrar så att de bli tillgängliga för andra tjänster.';
$lang['current_version'] = 'Nuvarande version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'Om du stöter på problem när du använder Car2dude kan du söka i den officiella Google-gruppen för support. Du kanske kan underlätta för utvecklarna genom att registrera ett ärende på GitHub-sidan.';
...
$lang['license'] = 'Licens';
$lang['about_app_license'] = 'Car2dude använder GPLv3 licensen. Genom att använda koden till Car2dude på något sätt accepterar du villkoren i följande url.';
...
$lang['ea_update_success'] = 'Car2dude är uppdaterad.';
