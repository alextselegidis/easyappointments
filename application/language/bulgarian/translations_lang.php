...
$lang['cancel_appointment_hint'] = 'Натиснете бутон "Отказ на Час" за да отстраните часът си от графика.';
$lang['cancel'] = 'Отказ';
...
$lang['appointment_locked_message'] = 'Часът не може да бъде променен по-малко от {$limit} часа предварително.';
...
$lang['disable_sync_prompt'] = 'Сигурни ли сте, че искате да деактивирате синхронизацията на календара?';
...
$lang['invalid_duration'] = 'Невалидна продължителност.';
...
$lang['google_plus_community'] = 'Google+ общност';
$lang['support_group'] = 'Група за поддръжка';
...
$lang['enter_password_here'] = 'Въведете паролата тук ...';
$lang['login'] = 'Вход';
$lang['forgot_your_password'] = 'Забравена парола ?';
$lang['login_failed'] = 'Неуспешно влизане, моля въведете правилните данни и опитайте отново.';
...
$lang['captcha_is_wrong'] = 'Неуспешна CAPTCHA верификация, моля опитайте отново.';
$lang['enter_captcha_here'] = 'Въведете CAPTCHA тук...';
...
$lang['time_format_hint'] = 'Променете формата за показване на времето (H - Часове, M - Минути).';
$lang['first_weekday'] = 'Първи ден от седмицата';
$lang['first_weekday_hint'] = 'Задайте първия ден от календарната седмица.';
...
$lang['reset_working_plan'] = 'Възстановяване на работния план до стойностите по подразбиране.';
...
$lang['google_analytics'] = 'Google Анализи';
...
$lang['matomo_analytics'] = 'Matomo Анализи';
...
$lang['customer_is_already_booked'] = 'Този клиент вече има час по време на заявения период за резервация.';
$lang['fields'] = 'Полета';
...
$lang['secret_header'] = 'Секретно заглавие';
$lang['search'] = 'Търсене';
$lang['slot_interval'] = 'Интервал на слотове (минути)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Активирайте автоматичното генериране на линкове за срещи в Jitsi за часовете. Когато е активирано, ще бъде генериран уникален линк за Jitsi видео разговор и съхранен като линк за срещата.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA е фокусирана върху поверителността, с отворен код алтернатива на CAPTCHA, която използва доказателство за работа за верификация на потребители без проследяване.';
$lang['altcha_enabled_hint'] = 'Когато е активирано, ALTCHA ще се използва вместо традиционната CAPTCHA с изображение за верификация на формуляри.';
$lang['altcha_hmac_key'] = 'HMAC ключ';
$lang['altcha_hmac_key_hint'] = 'Секретен ключ за подписване и верификация на ALTCHA предизвикателства. Кликнете Генериране за създаване на нов сигурен ключ.';
$lang['altcha_max_number'] = 'Максимален брой';
$lang['altcha_max_number_hint'] = 'Максималният брой за предизвикателството за доказателство за работа. По-високите стойности увеличават трудността (по подразбиране: 100000).';
$lang['altcha_expires'] = 'Изтича (секунди)';
$lang['altcha_expires_hint'] = 'Колко дълго предизвикателството остава валидно в секунди (по подразбиране: 300).';
$lang['altcha_key_generated'] = 'Нов HMAC ключ е генериран успешно.';
$lang['altcha_enabled'] = 'Активиране на ALTCHA';
$lang['altcha_captcha_not_active_warning'] = 'Настройката CAPTCHA в момента не е активна. ALTCHA няма да се използва, освен ако CAPTCHA не е активирана в';
$lang['generate'] = 'Генериране';
$lang['meeting_link'] = 'Връзка за среща';
$lang['google_calendar'] = 'Google Календар';
$lang['google_calendar_info'] = 'Активирайте синхронизацията с Google Calendar за синхронизиране на часовете с Google Calendar акаунтите на доставчиците.';
$lang['google_client_id'] = 'Клиентски ID';
$lang['google_client_id_info'] = 'Клиентският ID от вашия проект в Google Cloud Console.';
$lang['google_client_secret'] = 'Клиентска тайна';
$lang['google_client_secret_info'] = 'Клиентската тайна от вашия проект в Google Cloud Console.';
$lang['google_calendar_setup_info'] = 'За да активирате синхронизацията с Google Calendar, трябва да създадете проект в Google Cloud Console, да активирате Google Calendar API и да създадете OAuth 2.0 удостоверения. Посетете:';
$lang['google_meet_link_generation'] = 'Генериране на линкове за Google Meet';
$lang['google_meet_link_generation_info'] = 'Автоматично създаване на линк за видеоконференция Google Meet за синхронизираните часове. Линкът за срещата ще бъде съхранен в полето за линк на срещата.';
$lang['display_add_to_google_calendar'] = 'Показване на бутон "Добавяне в Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Показване на бутона "Добавяне в Google Calendar" на страницата за потвърждение на резервацията, позволявайки на клиентите лесно да добавят часа си в личния си Google Calendar.';
$lang['select_all'] = 'Избери всички';
$lang['select_none'] = 'Премахни избора';
$lang['appointment_update'] = 'Актуализация на среща';
$lang['notify_users_on_update_question'] = 'Желаете ли да изпратите известие за тази промяна?';
$lang['yes'] = 'Да';
$lang['no'] = 'Не';
$lang['latest_blog_posts'] = 'Последни публикации в блога';
$lang['loading'] = 'Зареждане';
$lang['blog_posts_load_error'] = 'Неуспешно зареждане на публикациите в блога. Моля, посетете официалния уебсайт за актуализации.';
...
$lang['would_you_like_to_proceed'] = 'Искате ли да продължите въпреки това?';
$lang['proceed'] = 'Продължи';
$lang['no_available_service_providers'] = 'Няма налични услуги';
$lang['no_available_service_providers_message'] = 'В момента няма налични услуги или доставчици за резервация. Моля, проверете по-късно или се свържете с нас за помощ.';
$lang['reset_password'] = 'Нулиране на паролата';
$lang['new_password'] = 'Нова парола';
$lang['enter_new_password'] = 'Въведете новата си парола по-долу.';
$lang['password_reset_request'] = 'Заявка за нулиране на парола';
...
$lang['password_reset_failed'] = 'Неуспешно нулиране на паролата. Моля, опитайте отново.';
$lang['no_password_provided'] = 'Моля, въведете парола.';
$lang['type_username_and_email_for_reset_link'] = 'Въведете потребителското си име и имейл адрес, за да получите връзка за нулиране на паролата.';
$lang['send_reset_link'] = 'Изпращане на връзка за нулиране';
$lang['reset_link_sent_with_email'] = 'Ако съществува акаунт с предоставените данни, на имейла ви е изпратена връзка за нулиране на паролата.';
$lang['working_plan_validation_failed'] = 'Открита е невалидна конфигурация на работния план.';
$lang['start_date'] = 'Начална дата';
$lang['end_date'] = 'Крайна дата';
$lang['remember_me'] = 'Запомни моята информация';
$lang['remember_me_hint'] = 'Запазете данните си за по-бързо резервиране следващия път.';
$lang['legal_notice'] = 'Правно известие';
$lang['legal_notice_url'] = 'URL на правното известие';
$lang['legal_notice_url_hint'] = 'Въведете URL адреса на страницата с правното известие.';
$lang['imprint'] = 'Импресум';
$lang['imprint_url'] = 'URL на импресума';
$lang['imprint_url_hint'] = 'Въведете URL адреса на страницата с импресума.';
$lang['data_retention'] = 'Съхранение на данни';
$lang['data_retention_days'] = 'Дни за съхранение на данни';
$lang['data_retention_days_hint'] = 'Задайте броя дни, след които данните на клиентите ще бъдат автоматично изтрити. Задайте 0 за деактивиране на автоматичното изтриване.';
$lang['manage_privacy'] = 'Управление на поверителността';
$lang['manage_privacy_hint'] = 'Кликнете върху линка по-долу, за да прегледате, актуализирате или изтриете личната си информация.';
$lang['personal_information_updated'] = 'Вашата лична информация беше успешно актуализирана.';
$lang['verify'] = 'Верифициране';
$lang['verifying'] = 'Верифициране';
$lang['verified'] = 'Верифицирано';
$lang['verification_complete'] = 'Верификацията е завършена';
$lang['verification_failed'] = 'Верификацията е неуспешна. Кликнете за повторен опит.';
$lang['click_to_verify'] = 'Кликнете, за да потвърдите, че сте човек';
$lang['altcha_verification_failed'] = 'ALTCHA верификацията е неуспешна. Моля, опитайте отново.';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = 'Предлагаме цялостни услуги за самостоятелно хостван софтуер, включително персонализирана разработка, управляван хостинг, договори за поддръжка, ребрандиране и постоянни подобрения — за да можете да се фокусирате върху бизнеса си, докато ние се грижим за останалото.';
...
$lang['caldav'] = 'CalDAV';
$lang['caldav_info'] = 'Синхронизирайте часовете на вашите изпълнители със сървър за календари CalDAV и определете към кои хостове синхронизацията може да се свързва.';
$lang['caldav_allowed_hosts'] = 'Разрешени адреси за връзка';
$lang['caldav_allowed_hosts_info'] = 'Адресите CalDAV, които сочат към частен или запазен мрежов адрес, се отхвърлят, за да не може адрес, въведен в администрацията, да достигне вътрешната мрежа на тази инсталация. Добавете по един адрес за връзка или име на хост на ред, за да го разрешите въпреки това. Добавяйте само сървъри, които управлявате сами.';
$lang['caldav_sync_failed'] = 'Синхронизацията с CalDAV не бе успешна';
$lang['caldav_sync_failed_url'] = 'Запазеният адрес за връзка не можа да бъде използван. Ако вашият сървър CalDAV работи в локалната ви мрежа, добавете адреса му в Настройки, Интеграции, CalDAV. В противен случай изключете синхронизацията и се свържете отново с правилен адрес.';
$lang['caldav_sync_failed_credentials'] = 'Сървърът CalDAV отхвърли потребителското име и паролата. Изключете синхронизацията и се свържете отново с правилните данни.';
$lang['caldav_sync_failed_unreachable'] = 'Сървърът CalDAV не можа да бъде достигнат. Уверете се, че работи и че адресът за връзка е правилен.';
$lang['caldav_private_host_warning'] = 'Този сървър е в частна мрежа. При свързване хостът му ще бъде добавен към разрешените адреси за връзка.';
$lang['caldav_allow_host_and_connect'] = 'Разреши и свържи';
// End
