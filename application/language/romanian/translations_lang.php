...
$lang['require_captcha_hint'] = 'Când este activat, clienții vor trebui să facă față unei provocări CAPTCHA înainte de a rezerva / actualiza o întâlnire pentru a dovedi că nu sunt un robot.';
$lang['none'] = 'Niciunul';
$lang['recaptcha_server_token'] = 'reCAPTCHA Server Token';
$lang['recaptcha_client_token'] = 'reCAPTCHA Token client';
$lang['recaptcha_hint'] = 'Vă rugăm să accesați site-ul de administrare google recaptcha pentru a configura un domeniu reCAPTCHA v2 și să obțineți jetoanele de server și client.';
$lang['recaptcha_warning'] = 'Sunteți responsabil pentru actualizarea adecvată a politicii dvs. de confidențialitate pentru a respecta legile locale atunci când utilizați reCAPTCHA!';
