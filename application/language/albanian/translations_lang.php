...
$lang['enter_password_here'] = 'Shkruani fjalëkalimin këtu ...';
...
$lang['unexpected_issues_message'] = 'Veprimi nuk mund të përfundonte.';
$lang['close'] = 'Mbyll';
...
$lang['personal_information'] = 'Të Dhëna Personale';
...
$lang['enter_captcha_here'] = 'Shkruani CAPTCHA këtu...';
...
$lang['service_selection_layout'] = 'Paraqitja e përzgjedhjes së shërbimit';
$lang['service_selection_layout_hint'] = 'Zgjidhni si shfaqen shërbimet në hapin e parë të rezervimit.';
$lang['dropdown'] = 'Meny rënëse';
$lang['accordion'] = 'Fizarmonikë';
$lang['hide_single_provider_selection'] = 'Fshih përzgjedhjen e një ofruesi të vetëm';
$lang['hide_single_provider_selection_hint'] = 'Fsheh fushën e ofruesit kur shërbimi i përzgjedhur ka vetëm një ofrues të disponueshëm.';
...
$lang['search'] = 'Kërko';
$lang['slot_interval'] = 'Intervali i Orarit (Minuta)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Aktivizoni gjenerimin automatik të lidhjeve të takimeve Jitsi për takimet. Kur aktivizohet, një lidhje unike e videothirrjes Jitsi do të gjenerohet dhe ruhet si lidhja e takimit.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA është një alternativë CAPTCHA me burim të hapur dhe e fokusuar në privatësi që përdor provën e punës për të verifikuar përdoruesit njerëzorë pa gjurmim.';
$lang['altcha_enabled_hint'] = 'Kur aktivizohet, ALTCHA do të përdoret në vend të CAPTCHA tradicionale me imazhe për verifikimin e formularëve.';
$lang['altcha_hmac_key'] = 'Çelësi HMAC';
$lang['altcha_hmac_key_hint'] = 'Një çelës sekret i përdorur për të nënshkruar dhe verifikuar sfidat ALTCHA. Klikoni Gjenero për të krijuar një çelës të ri të sigurt.';
$lang['altcha_max_number'] = 'Numri Maksimal';
$lang['altcha_max_number_hint'] = 'Numri maksimal për sfidën e provës së punës. Vlerat më të larta rrisin vështirësinë (parazgjedhur: 100000).';
$lang['altcha_expires'] = 'Skadon (Sekonda)';
...
$lang['google_calendar_info'] = 'Aktivizoni sinkronizimin me Google Calendar për të sinkronizuar takimet me llogaritë Google Calendar të ofruesve.';
$lang['google_client_id'] = 'ID e Klientit';
$lang['google_client_id_info'] = 'ID e Klientit nga projekti juaj në Google Cloud Console.';
$lang['google_client_secret'] = 'Sekreti i Klientit';
$lang['google_client_secret_info'] = 'Sekreti i Klientit nga projekti juaj në Google Cloud Console.';
$lang['google_calendar_setup_info'] = 'Për të aktivizuar sinkronizimin me Google Calendar, duhet të krijoni një projekt në Google Cloud Console, të aktivizoni API-n e Google Calendar dhe të krijoni kredencialet OAuth 2.0. Vizitoni:';
$lang['google_meet_link_generation'] = 'Gjenero Lidhje Google Meet';
$lang['google_meet_link_generation_info'] = 'Krijoni automatikisht një lidhje videokonference Google Meet për takimet e sinkronizuara. Lidhja e takimit do të ruhet në fushën e lidhjes së takimit.';
$lang['display_add_to_google_calendar'] = 'Shfaq Butonin "Shto në Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Shfaqni butonin "Shto në Google Calendar" në faqen e konfirmimit të rezervimit, duke i lejuar klientët të shtojnë lehtësisht takimin në Google Calendar-in e tyre personal.';
$lang['select_all'] = 'Zgjidh të Gjitha';
$lang['select_none'] = 'Mos Zgjidh Asnjë';
$lang['appointment_update'] = 'Përditësim Takimi';
$lang['notify_users_on_update_question'] = 'Dëshironi të dërgoni një njoftim për këtë ndryshim?';
$lang['yes'] = 'Po';
$lang['no'] = 'Jo';
$lang['latest_blog_posts'] = 'Postimet e Fundit të Blogut';
$lang['loading'] = 'Duke ngarkuar';
$lang['blog_posts_load_error'] = 'Nuk mund të ngarkohen postimet e blogut. Ju lutemi vizitoni faqen zyrtare për përditësime.';
...
$lang['would_you_like_to_proceed'] = 'Dëshironi të vazhdoni gjithsesi?';
$lang['proceed'] = 'Vazhdo';
$lang['no_available_service_providers'] = 'Nuk ka Shërbime të Disponueshme';
$lang['no_available_service_providers_message'] = 'Aktualisht nuk ka shërbime ose ofrues të disponueshëm për rezervim. Ju lutemi kontrolloni më vonë ose na kontaktoni për ndihmë.';
$lang['reset_password'] = 'Rivendos Fjalëkalimin';
$lang['new_password'] = 'Fjalëkalim i Ri';
$lang['enter_new_password'] = 'Shkruani fjalëkalimin tuaj të ri më poshtë.';
$lang['enter_password_here'] = 'Shkruani fjalëkalimin këtu ...';
$lang['password_reset_request'] = 'Kërkesë për Rivendosje Fjalëkalimi';
$lang['password_reset_email_message'] = 'Ju keni kërkuar të rivendosni fjalëkalimin tuaj. Klikoni butonin më poshtë për të vendosur një fjalëkalim të ri për llogarinë tuaj.';
$lang['password_reset_link_expires'] = 'Kjo lidhje do të skadojë në 1 orë.';
$lang['password_reset_ignore_message'] = 'Nëse nuk keni kërkuar rivendosje fjalëkalimi, ju lutemi injoroni këtë email.';
$lang['invalid_reset_token'] = 'Lidhja e rivendosjes së fjalëkalimit është e pavlefshme.';
$lang['invalid_or_expired_token'] = 'Lidhja e rivendosjes së fjalëkalimit është e pavlefshme ose ka skaduar. Ju lutemi kërkoni një të re.';
$lang['password_reset_success'] = 'Fjalëkalimi juaj është rivendosur me sukses. Do të ridrejtoheni në faqen e hyrjes.';
$lang['password_reset_failed'] = 'Rivendosja e fjalëkalimit dështoi. Ju lutemi provoni përsëri.';
$lang['no_password_provided'] = 'Ju lutemi shkruani një fjalëkalim.';
$lang['type_username_and_email_for_reset_link'] = 'Shkruani emrin e përdoruesit dhe adresën e emailit tuaj për të marrë një lidhje rivendosjeje fjalëkalimi.';
$lang['send_reset_link'] = 'Dërgo Lidhjen e Rivendosjes';
...
$lang['working_plan_validation_failed'] = 'U gjet konfigurim i pavlefshëm i planit të punës.';
$lang['start_date'] = 'Data e Fillimit';
$lang['end_date'] = 'Data e Mbarimit';
$lang['remember_me'] = 'Mbaj mend informacionet e mia';
$lang['remember_me_hint'] = 'Ruani të dhënat tuaja për rezervim më të shpejtë herën tjetër.';
$lang['legal_notice'] = 'Njoftim Ligjor';
$lang['legal_notice_url'] = 'URL e Njoftimit Ligjor';
$lang['legal_notice_url_hint'] = 'Shkruani URL-në e faqes suaj të njoftimit ligjor.';
$lang['imprint'] = 'Imprint';
$lang['imprint_url'] = 'URL e Imprint-it';
$lang['imprint_url_hint'] = 'Shkruani URL-në e faqes suaj të imprint-it.';
$lang['data_retention'] = 'Ruajtja e të Dhënave';
$lang['data_retention_days'] = 'Ditët e Ruajtjes së të Dhënave';
$lang['data_retention_days_hint'] = 'Vendosni numrin e ditëve pas të cilave të dhënat e klientit do të fshihen automatikisht. Vendosni 0 për të çaktivizuar fshirjen automatike.';
$lang['manage_privacy'] = 'Menaxho Privatësinë';
$lang['manage_privacy_hint'] = 'Klikoni lidhjen më poshtë për të parë, përditësuar ose fshirë informacionet tuaja personale.';
$lang['personal_information'] = 'Të Dhëna Personale';
$lang['personal_information_updated'] = 'Informacionet tuaja personale u përditësuan me sukses.';
$lang['verify'] = 'Verifiko';
$lang['verifying'] = 'Duke verifikuar';
$lang['verified'] = 'I verifikuar';
$lang['verification_complete'] = 'Verifikimi i plotë';
$lang['verification_failed'] = 'Verifikimi dështoi. Klikoni për të provuar përsëri.';
$lang['click_to_verify'] = 'Klikoni për të verifikuar që jeni njeri';
$lang['altcha_verification_failed'] = 'Verifikimi ALTCHA dështoi. Ju lutemi provoni përsëri.';
