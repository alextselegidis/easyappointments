...
$lang['cancel_appointment_hint'] = 'Pritisnite dugme "Otkaži termin" da uklonite termin iz rasporeda kompanije.';
$lang['cancel'] = 'Otkaži';
$lang['appointment_registered'] = 'Vaš termin je uspješno registrovan!';
$lang['cancel_appointment_title'] = 'Otkaži termin';
$lang['reschedule_or_cancel_appointment'] = 'Promijeni / Otkaži termin';
...
$lang['enter_password_here'] = 'Unesite lozinku ovdje ...';
$lang['login'] = 'Prijava';
...
$lang['enter_captcha_here'] = 'Unesite CAPTCHA ovdje...';
...
$lang['secret_header'] = 'Tajni Zaglavlje';
$lang['search'] = 'Pretraži';
$lang['slot_interval'] = 'Interval Termina (Minute)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Omogućite automatsko generisanje linkova za Jitsi sastanke za termine. Kada je omogućeno, jedinstveni Jitsi video poziv link će biti generisan i sačuvan kao link sastanka.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA je alternativa CAPTCHA fokusirana na privatnost i otvorenog koda koja koristi dokaz rada za verifikaciju ljudskih korisnika bez praćenja.';
$lang['altcha_enabled_hint'] = 'Kada je omogućeno, ALTCHA će se koristiti umjesto tradicionalnog CAPTCHA sa slikama za verifikaciju formulara.';
$lang['altcha_hmac_key'] = 'HMAC Ključ';
$lang['altcha_hmac_key_hint'] = 'Tajni ključ koji se koristi za potpisivanje i verifikaciju ALTCHA izazova. Kliknite Generiši za kreiranje novog sigurnog ključa.';
$lang['altcha_max_number'] = 'Maksimalni Broj';
$lang['altcha_max_number_hint'] = 'Maksimalni broj za izazov dokaza rada. Veće vrijednosti povećavaju težinu (zadano: 100000).';
$lang['altcha_expires'] = 'Ističe (Sekunde)';
$lang['altcha_expires_hint'] = 'Koliko dugo izazov ostaje važeći u sekundama (zadano: 300).';
$lang['altcha_key_generated'] = 'Novi HMAC ključ je uspješno generisan.';
$lang['altcha_enabled'] = 'Omogući ALTCHA';
$lang['altcha_captcha_not_active_warning'] = 'Postavka CAPTCHA trenutno nije aktivna. ALTCHA se neće koristiti ako CAPTCHA nije omogućena u';
$lang['generate'] = 'Generiši';
$lang['meeting_link'] = 'Link za Sastanak';
$lang['google_calendar'] = 'Google Kalendar';
$lang['google_calendar_info'] = 'Omogućite sinhronizaciju Google Calendar za sinhronizaciju termina sa Google Calendar računima pružalaca usluga.';
...
$lang['google_calendar_setup_info'] = 'Za omogućavanje sinhronizacije Google Calendar, trebate kreirati projekt u Google Cloud Console, omogućiti Google Calendar API i kreirati OAuth 2.0 akreditive. Posjetite:';
$lang['google_meet_link_generation'] = 'Generiši Google Meet Linkove';
$lang['google_meet_link_generation_info'] = 'Automatski kreirajte Google Meet video konferencijski link za sinhronizovane termine. Link sastanka će biti sačuvan u polju za link sastanka termina.';
$lang['display_add_to_google_calendar'] = 'Prikaži Dugme "Dodaj u Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Prikažite dugme "Dodaj u Google Calendar" na stranici potvrde rezervacije, omogućavajući klijentima da lako dodaju svoj termin u lični Google Calendar.';
$lang['select_all'] = 'Odaberi Sve';
$lang['select_none'] = 'Ne Odaberi Ništa';
$lang['appointment_update'] = 'Ažuriranje Termina';
$lang['notify_users_on_update_question'] = 'Želite li poslati obavijest o ovoj promjeni?';
$lang['yes'] = 'Da';
$lang['no'] = 'Ne';
$lang['latest_blog_posts'] = 'Najnoviji Blog Postovi';
$lang['loading'] = 'Učitavanje';
$lang['blog_posts_load_error'] = 'Nije moguće učitati blog postove. Posjetite službenu web stranicu za ažuriranja.';
...
$lang['would_you_like_to_proceed'] = 'Želite li ipak nastaviti?';
$lang['proceed'] = 'Nastavi';
$lang['no_available_service_providers'] = 'Nema Dostupnih Usluga';
$lang['no_available_service_providers_message'] = 'Trenutno nema dostupnih usluga ili pružalaca za rezervaciju. Molimo provjerite kasnije ili nas kontaktirajte za pomoć.';
$lang['reset_password'] = 'Resetiraj Lozinku';
$lang['new_password'] = 'Nova Lozinka';
$lang['enter_new_password'] = 'Unesite svoju novu lozinku ispod.';
$lang['password_reset_request'] = 'Zahtjev za Resetiranje Lozinke';
$lang['password_reset_email_message'] = 'Zatražili ste resetiranje lozinke. Kliknite na dugme ispod da postavite novu lozinku za svoj račun.';
$lang['password_reset_link_expires'] = 'Ovaj link će isteći za 1 sat.';
$lang['password_reset_ignore_message'] = 'Ako niste zatražili resetiranje lozinke, molimo zanemarite ovaj email.';
$lang['invalid_reset_token'] = 'Link za resetiranje lozinke je nevažeći.';
$lang['invalid_or_expired_token'] = 'Link za resetiranje lozinke je nevažeći ili je istekao. Molimo zatražite novi.';
$lang['password_reset_success'] = 'Vaša lozinka je uspješno resetirana. Bit ćete preusmjereni na stranicu za prijavu.';
$lang['password_reset_failed'] = 'Resetiranje lozinke nije uspjelo. Molimo pokušajte ponovo.';
$lang['no_password_provided'] = 'Molimo unesite lozinku.';
$lang['type_username_and_email_for_reset_link'] = 'Upišite svoje korisničko ime i email adresu da biste dobili link za resetiranje lozinke.';
$lang['send_reset_link'] = 'Pošalji Link za Resetiranje';
$lang['reset_link_sent_with_email'] = 'Ako postoji račun s navedenim podacima, link za resetiranje lozinke je poslan na vašu e-mail adresu.';
...
$lang['remember_me_hint'] = 'Sačuvajte svoje podatke za bržu rezervaciju sljedeći put.';
$lang['legal_notice'] = 'Pravna Napomena';
$lang['legal_notice_url'] = 'URL Pravne Napomene';
$lang['legal_notice_url_hint'] = 'Unesite URL vaše stranice pravne napomene.';
$lang['imprint'] = 'Impresum';
$lang['imprint_url'] = 'URL Impresuma';
$lang['imprint_url_hint'] = 'Unesite URL vaše stranice impresuma.';
$lang['data_retention'] = 'Zadržavanje Podataka';
$lang['data_retention_days'] = 'Dani Zadržavanja Podataka';
$lang['data_retention_days_hint'] = 'Postavite broj dana nakon kojih će podaci o klijentima biti automatski obrisani. Postavite na 0 da onemogućite automatsko brisanje.';
$lang['manage_privacy'] = 'Upravljaj Privatnošću';
$lang['manage_privacy_hint'] = 'Kliknite na link ispod da pregledate, ažurirate ili obrišete vaše lične podatke.';
$lang['personal_information_updated'] = 'Vaši lični podaci su uspješno ažurirani.';
$lang['verify'] = 'Verificiraj';
$lang['verifying'] = 'Verificiranje';
$lang['verified'] = 'Verificirano';
$lang['verification_complete'] = 'Verifikacija završena';
$lang['verification_failed'] = 'Verifikacija nije uspjela. Kliknite za ponovni pokušaj.';
$lang['click_to_verify'] = 'Kliknite za verifikaciju da ste čovjek';
$lang['altcha_verification_failed'] = 'ALTCHA verifikacija nije uspjela. Molimo pokušajte ponovo.';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = 'Nudimo kompletne usluge za samostalno hostovan softver, uključujući prilagođeni razvoj, upravljani hosting, ugovore o podršci, rebrendiranje i kontinuirana poboljšanja — tako da se možete fokusirati na svoj posao dok mi brinemo o ostalom.';
...
$lang['caldav'] = 'CalDAV';
$lang['caldav_info'] = 'Sinhronizirajte termine svojih izvršilaca sa serverom kalendara CalDAV i odredite s kojim se serverima sinhronizacija smije povezati.';
$lang['caldav_allowed_hosts'] = 'Dozvoljene adrese povezivanja';
$lang['caldav_allowed_hosts_info'] = 'Adrese CalDAV koje upućuju na privatnu ili rezervisanu mrežnu adresu se odbijaju, kako adresa unesena u administraciji ne bi mogla doprijeti do unutrašnje mreže ove instalacije. Dodajte jednu adresu povezivanja ili naziv servera po redu ako je ipak želite dozvoliti. Dodajte samo servere kojima sami upravljate.';
$lang['caldav_sync_failed'] = 'Sinhronizacija CalDAV nije uspjela';
$lang['caldav_sync_failed_url'] = 'Sačuvanu adresu povezivanja nije bilo moguće upotrijebiti. Ako vaš CalDAV server radi u lokalnoj mreži, dodajte njegovu adresu u Postavke, Integracije, CalDAV. U suprotnom isključite sinhronizaciju i povežite se ponovo s ispravnom adresom.';
$lang['caldav_sync_failed_credentials'] = 'Server CalDAV je odbio korisničko ime i lozinku. Isključite sinhronizaciju i povežite se ponovo s ispravnim podacima.';
$lang['caldav_sync_failed_unreachable'] = 'Server CalDAV nije bilo moguće kontaktirati. Provjerite radi li i je li adresa povezivanja ispravna.';
$lang['caldav_private_host_warning'] = 'Ovaj server je u privatnoj mreži. Povezivanjem će se njegov naziv dodati u dozvoljene adrese povezivanja.';
$lang['caldav_allow_host_and_connect'] = 'Dozvoli i poveži';
// End
