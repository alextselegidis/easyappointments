...
$lang['appointment_locked_message'] = 'לא ניתן לשנות את התור פחות מ-{$limit} שעות מראש.';
...
$lang['disable_sync_prompt'] = 'האם אתה בטוח שברצונך להשבית את סנכרון היומן?';
$lang['reload'] = 'רענון';
...
$lang['invalid_duration'] = 'משך זמן לא חוקי.';
...
$lang['timeout_minutes'] = 'זמן המתנה (דקות)';
...
$lang['support'] = 'תמיכה';
$lang['about_app_support'] = 'אם נתקלת בבעיות בעת השימוש ב-Easy!Appointments, תוכל לחפש תשובות בקבוצת Google הרשמית. ייתכן שתצטרך גם ליצור דיווח חדש בדף Google Code כדי לסייע בתהליך הפיתוח.';
$lang['official_website'] = 'אתר רשמי';
$lang['google_plus_community'] = 'קהילת Google+';
$lang['support_group'] = 'קבוצת תמיכה';
$lang['project_issues'] = 'בעיות בפרויקט';
$lang['license'] = 'רישיון';
$lang['about_app_license'] = 'Easy!Appointments מורשה תחת רישיון GPLv3. בשימוש בקוד של Easy!Appointments בכל דרך שהיא, אתה מסכים לתנאים המתוארים בכתובת הבאה:';
...
$lang['enter_password_here'] = 'הזן סיסמה כאן ...';
$lang['login'] = 'התחברות';
...
$lang['unexpected_issues_message'] = 'הפעולה לא הסתיימה.';
$lang['close'] = 'סגירה';
...
$lang['enter_captcha_here'] = 'הזן CAPTCHA כאן...';
...
$lang['service_selection_layout'] = 'פריסת בחירת שירות';
$lang['service_selection_layout_hint'] = 'בחר כיצד שירותים מוצגים בשלב ההזמנה הראשון.';
$lang['dropdown'] = 'תפריט נפתח';
$lang['accordion'] = 'אקורדיון';
$lang['hide_single_provider_selection'] = 'הסתר בחירת ספק יחיד';
$lang['hide_single_provider_selection_hint'] = 'מסתיר את שדה הספק כאשר לשירות הנבחר יש רק ספק אחד זמין.';
...
$lang['hide_from_public'] = 'הסתר מהציבור';
$lang['matomo_analytics_site_id'] = 'מזהה אתר Matomo Analytics';
$lang['matomo_analytics_site_id_hint'] = 'הגדר את מזהה האתר שיעקב על ידי Matomo (לאתר ברירת המחדל יש את המזהה "1").';
$lang['default_timezone'] = 'אזור זמן ברירת מחדל';
$lang['default_timezone_hint'] = 'הגדר את ערך אזור הזמן שישמש כברירת מחדל עבור רשומות חדשות.';
$lang['default_language'] = 'שפת ברירת מחדל';
$lang['default_language_hint'] = 'הגדר את ערך השפה שישמש כברירת מחדל עבור רשומות חדשות.';
$lang['sync_method_prompt'] = 'באיזו שיטת סנכרון תרצה להשתמש?';
$lang['caldav_server'] = 'שרת CalDAV';
$lang['caldav_connection_info_prompt'] = 'אנא הזן את פרטי החיבור ליומן CalDAV היעד.';
$lang['connect'] = 'התחבר';
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'אינטגרציה זו מאפשרת לך להתחבר לשרת LDAP קיים ולייבא משתמשים באופן אוטומטי ל-Easy!Appointments ולאפשר להם התחברות חד-פעמית עם סיסמת הספרייה שלהם (שם המשתמש חייב להתאים).';
$lang['host'] = 'שרת';
$lang['port'] = 'פורט';
$lang['user_dn'] = 'User DN';
$lang['base_dn'] = 'Base DN';
$lang['keyword'] = 'מילת מפתח';
$lang['ldap_search_hint'] = 'ספק מילת מפתח לחיפוש בספריית LDAP למשתמשים התואמים לקריטריוני הסינון.';
$lang['ldap_extension_not_loaded'] = 'הרחבת LDAP של PHP אינה טעונה, אך נדרשת כדי שאינטגרציה זו תפעל.';
$lang['field_mapping'] = 'מיפוי שדות';
$lang['content'] = 'תוכן';
$lang['active'] = 'פעיל';
$lang['user_imported'] = 'רשומת המשתמש יובאה בהצלחה.';
$lang['import'] = 'ייבוא';
$lang['ldap_dn'] = 'LDAP DN';
$lang['role'] = 'תפקיד';
$lang['at_least_one_field_required'] = 'לפחות שדה אחד חייב להיות מוגדר כחובה בדף ההזמנה.';
$lang['customer_is_already_booked'] = 'ללקוח זה כבר יש תור בתקופת ההזמנה המבוקשת.';
$lang['fields'] = 'שדות';
$lang['invalid_credentials_provided'] = 'פרטי ההתחברות שסופקו שגויים, אנא נסה שנית.';
$lang['calendar_url'] = 'כתובת יומן';
$lang['please_select'] = 'אנא בחר';
$lang['secret_header'] = 'כותרת סודית';
$lang['search'] = 'חיפוש';
$lang['slot_interval'] = 'מרווח זמן (דקות)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'הפעל יצירה אוטומטית של קישור פגישת Jitsi עבור תורים. כאשר מופעל, קישור ייחודי לשיחת וידאו ב-Jitsi ייווצר ויישמר כקישור הפגישה.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA הוא חלופת CAPTCHA בקוד פתוח המתמקדת בפרטיות ומשתמשת בהוכחת עבודה לאימות משתמשים אנושיים ללא מעקב.';
$lang['altcha_enabled_hint'] = 'כאשר מופעל, ALTCHA ישמש במקום CAPTCHA המסורתי עם תמונות לאימות טפסים.';
$lang['altcha_hmac_key'] = 'מפתח HMAC';
$lang['altcha_hmac_key_hint'] = 'מפתח סודי המשמש לחתימה ואימות אתגרי ALTCHA. לחץ על צור כדי ליצור מפתח מאובטח חדש.';
$lang['altcha_max_number'] = 'מספר מרבי';
$lang['altcha_max_number_hint'] = 'המספר המרבי לאתגר הוכחת העבודה. ערכים גבוהים יותר מגבירים את הקושי (ברירת מחדל: 100000).';
$lang['altcha_expires'] = 'תפוגה (שניות)';
...
$lang['google_calendar_info'] = 'הפעל סנכרון Google Calendar לסנכרון תורים עם חשבונות Google Calendar של ספקי שירות.';
$lang['google_client_id'] = 'מזהה לקוח';
$lang['google_client_id_info'] = 'מזהה הלקוח מפרויקט Google Cloud Console שלך.';
$lang['google_client_secret'] = 'סוד לקוח';
$lang['google_client_secret_info'] = 'סוד הלקוח מפרויקט Google Cloud Console שלך.';
$lang['google_calendar_setup_info'] = 'כדי להפעיל סנכרון Google Calendar, עליך ליצור פרויקט ב-Google Cloud Console, להפעיל את Google Calendar API וליצור אישורי OAuth 2.0. בקר ב:';
$lang['google_meet_link_generation'] = 'יצירת קישורי Google Meet';
$lang['google_meet_link_generation_info'] = 'צור אוטומטית קישור לשיחת ועידה בווידאו ב-Google Meet עבור תורים מסונכרנים. קישור הפגישה יישמר בשדה קישור הפגישה של התור.';
$lang['display_add_to_google_calendar'] = 'הצג כפתור "הוסף ל-Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'הצג את כפתור "הוסף ל-Google Calendar" בדף אישור ההזמנה, ואפשר ללקוחות להוסיף בקלות את התור ליומן Google Calendar האישי שלהם.';
$lang['select_all'] = 'בחר הכל';
$lang['select_none'] = 'בטל בחירה';
$lang['appointment_update'] = 'עדכון פגישה';
$lang['notify_users_on_update_question'] = 'האם ברצונך לשלוח התראה על שינוי זה?';
$lang['yes'] = 'כן';
$lang['no'] = 'לא';
$lang['latest_blog_posts'] = 'פוסטים אחרונים בבלוג';
$lang['loading'] = 'טוען';
$lang['blog_posts_load_error'] = 'לא ניתן לטעון פוסטים מהבלוג. אנא בקר באתר הרשמי לעדכונים.';
$lang['provider_has_conflicting_appointment'] = 'לספק שנבחר כבר יש פגישה אחרת באותו זמן. אנא בחר זמן או ספק אחר.';
$lang['would_you_like_to_proceed'] = 'האם ברצונך להמשיך בכל זאת?';
$lang['proceed'] = 'המשך';
$lang['no_available_service_providers'] = 'אין שירותים זמינים';
$lang['no_available_service_providers_message'] = 'אין כרגע שירותים או נותני שירות זמינים להזמנה. אנא בדוק מאוחר יותר או צור איתנו קשר לקבלת עזרה.';
$lang['reset_password'] = 'איפוס סיסמה';
$lang['new_password'] = 'סיסמה חדשה';
$lang['enter_new_password'] = 'הזן את הסיסמה החדשה שלך למטה.';
$lang['enter_password_here'] = 'הזן סיסמה כאן ...';
$lang['password_reset_request'] = 'בקשה לאיפוס סיסמה';
...
$lang['password_reset_failed'] = 'איפוס הסיסמה נכשל. אנא נסה שוב.';
$lang['no_password_provided'] = 'אנא הזן סיסמה.';
$lang['type_username_and_email_for_reset_link'] = 'הקלד את שם המשתמש וכתובת האימייל שלך כדי לקבל קישור לאיפוס סיסמה.';
$lang['send_reset_link'] = 'שלח קישור איפוס';
$lang['reset_link_sent_with_email'] = 'אם קיים חשבון עם הפרטים שסופקו, קישור לאיפוס סיסמה נשלח לאימייל שלך.';
$lang['working_plan_validation_failed'] = 'נמצאה תצורת תוכנית עבודה לא תקינה.';
$lang['start_date'] = 'תאריך התחלה';
$lang['end_date'] = 'תאריך סיום';
$lang['remember_me'] = 'זכור את המידע שלי';
$lang['remember_me_hint'] = 'שמור את הפרטים שלך להזמנה מהירה יותר בפעם הבאה.';
$lang['legal_notice'] = 'הודעה משפטית';
$lang['legal_notice_url'] = 'כתובת הודעה משפטית';
$lang['legal_notice_url_hint'] = 'הזן את הכתובת לדף ההודעה המשפטית שלך.';
$lang['imprint'] = 'תנאי שימוש';
$lang['imprint_url'] = 'כתובת תנאי שימוש';
$lang['imprint_url_hint'] = 'הזן את הכתובת לדף תנאי השימוש שלך.';
$lang['data_retention'] = 'שמירת נתונים';
$lang['data_retention_days'] = 'ימי שמירת נתונים';
$lang['data_retention_days_hint'] = 'הגדר את מספר הימים שלאחריהם נתוני הלקוחות יימחקו אוטומטית. הגדר ל-0 כדי להשבית מחיקה אוטומטית.';
$lang['manage_privacy'] = 'ניהול פרטיות';
$lang['manage_privacy_hint'] = 'לחץ על הקישור למטה כדי לצפות, לעדכן או למחוק את המידע האישי שלך.';
$lang['personal_information'] = 'מידע אישי';
$lang['personal_information_updated'] = 'המידע האישי שלך עודכן בהצלחה.';
$lang['verify'] = 'אמת';
$lang['verifying'] = 'מאמת';
$lang['verified'] = 'מאומת';
$lang['verification_complete'] = 'האימות הושלם';
$lang['verification_failed'] = 'האימות נכשל. לחץ לניסיון חוזר.';
$lang['click_to_verify'] = 'לחץ לאימות שאתה אנושי';
$lang['altcha_verification_failed'] = 'אימות ALTCHA נכשל. אנא נסה שנית.';
