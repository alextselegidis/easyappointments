...
$lang['require_captcha_hint'] = 'כשהוא מופעל, הלקוחות יצטרכו להתמודד עם אתגר CAPTCHA לפני שהם מזמינים / מעדכנים פגישה כדי להוכיח שהם אינם רובוט.';
$lang['none'] = 'אין';
$lang['recaptcha_server_token'] = 'אסימון שרת reCAPTCHA';
$lang['recaptcha_client_token'] = 'אסימון לקוח reCAPTCHA';
$lang['recaptcha_hint'] = 'היכנס לאתר הניהול של google recaptcha כדי להתקין דומיין reCAPTCHA v2 ולקבל את אסימוני השרת והלקוח שלך.';
$lang['recaptcha_warning'] = 'אתה אחראי לעדכן כראוי את מדיניות הפרטיות שלך כדי לציית לחוקים המקומיים בעת שימוש ב- reCAPTCHA!';
