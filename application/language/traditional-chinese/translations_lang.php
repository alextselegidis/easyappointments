...
$lang['confirm'] = '確認';
$lang['update'] = '更新';
$lang['cancel_appointment_hint'] = '按下「取消預約」按鈕將預約從公司行程中移除。';
$lang['cancel'] = '取消';
...
$lang['enter_password_here'] = '在此輸入密碼 ...';
$lang['login'] = '登入';
...
$lang['unexpected_issues_message'] = '操作無法完成。';
$lang['close'] = '關閉';
...
$lang['enter_captcha_here'] = '在此輸入 CAPTCHA...';
...
$lang['secret_header'] = '密鑰標頭';
$lang['search'] = '搜尋';
$lang['slot_interval'] = '時段間隔（分鐘）';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = '啟用自動產生 Jitsi 會議連結功能。啟用後，系統將自動產生唯一的 Jitsi 視訊通話連結並儲存為會議連結。';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA 是一個注重隱私的開源 CAPTCHA 替代方案，使用工作量證明來驗證真實使用者，無需追蹤。';
$lang['altcha_enabled_hint'] = '啟用後，將使用 ALTCHA 替代傳統的圖片 CAPTCHA 進行表單驗證。';
$lang['altcha_hmac_key'] = 'HMAC 金鑰';
$lang['altcha_hmac_key_hint'] = '用於簽署和驗證 ALTCHA 挑戰的密鑰。點擊產生以建立新的安全金鑰。';
$lang['altcha_max_number'] = '最大數字';
$lang['altcha_max_number_hint'] = '工作量證明挑戰的最大數字。數值越高難度越大（預設值：100000）。';
$lang['altcha_expires'] = '過期時間（秒）';
$lang['altcha_expires_hint'] = '挑戰保持有效的秒數（預設值：300）。';
$lang['altcha_key_generated'] = '新的 HMAC 金鑰已成功產生。';
$lang['altcha_enabled'] = '啟用 ALTCHA';
$lang['altcha_captcha_not_active_warning'] = 'CAPTCHA 設定目前未啟用。除非在以下位置啟用 CAPTCHA，否則 ALTCHA 將不會被使用：';
$lang['generate'] = '產生';
$lang['meeting_link'] = '會議連結';
$lang['google_calendar'] = 'Google 日曆';
$lang['google_calendar_info'] = '啟用 Google Calendar 同步，將預約與服務提供者的 Google Calendar 帳戶同步。';
$lang['google_client_id'] = '用戶端 ID';
$lang['google_client_id_info'] = '來自您的 Google Cloud Console 專案的用戶端 ID。';
$lang['google_client_secret'] = '用戶端密鑰';
$lang['google_client_secret_info'] = '來自您的 Google Cloud Console 專案的用戶端密鑰。';
$lang['google_calendar_setup_info'] = '要啟用 Google Calendar 同步，您需要在 Google Cloud Console 中建立專案、啟用 Google Calendar API 並建立 OAuth 2.0 憑證。請造訪：';
$lang['google_meet_link_generation'] = '產生 Google Meet 連結';
$lang['google_meet_link_generation_info'] = '自動為同步的預約建立 Google Meet 視訊會議連結。會議連結將儲存在預約的會議連結欄位中。';
$lang['display_add_to_google_calendar'] = '顯示"加入 Google Calendar"按鈕';
$lang['display_add_to_google_calendar_info'] = '在預約確認頁面顯示"加入 Google Calendar"按鈕，方便顧客將預約輕鬆加入個人 Google Calendar。';
$lang['select_all'] = '全選';
$lang['select_none'] = '取消全選';
$lang['appointment_update'] = '預約更新';
$lang['notify_users_on_update_question'] = '您想發送關於此更改的通知嗎？';
$lang['yes'] = '是';
$lang['no'] = '否';
$lang['latest_blog_posts'] = '最新部落格文章';
$lang['loading'] = '載入中';
$lang['blog_posts_load_error'] = '無法載入部落格文章。請訪問官方網站獲取更新。';
$lang['provider_has_conflicting_appointment'] = '所選服務提供者在該時間已有其他預約。請選擇其他時間或服務提供者。';
$lang['would_you_like_to_proceed'] = '您確定要繼續嗎？';
$lang['proceed'] = '繼續';
$lang['no_available_service_providers'] = '沒有可用的服務';
$lang['no_available_service_providers_message'] = '目前沒有可供預約的服務或服務提供者。請稍後再查看或聯繫我們獲取幫助。';
$lang['reset_password'] = '重置密碼';
$lang['new_password'] = '新密碼';
$lang['enter_new_password'] = '在下方輸入您的新密碼。';
$lang['password_reset_request'] = '密碼重置請求';
$lang['password_reset_email_message'] = '您已請求重置密碼。點擊下面的按鈕為您的帳戶設置新密碼。';
$lang['password_reset_link_expires'] = '此連結將在1小時後過期。';
$lang['password_reset_ignore_message'] = '如果您沒有請求重置密碼，請忽略此電子郵件。';
$lang['invalid_reset_token'] = '密碼重置連結無效。';
$lang['invalid_or_expired_token'] = '密碼重置連結無效或已過期。請重新申請。';
$lang['password_reset_success'] = '您的密碼已成功重置。您將被重定向到登入頁面。';
$lang['password_reset_failed'] = '密碼重置失敗。請重試。';
$lang['no_password_provided'] = '請輸入密碼。';
$lang['type_username_and_email_for_reset_link'] = '輸入您的使用者名稱和電子郵件地址以接收密碼重置連結。';
$lang['send_reset_link'] = '發送重置連結';
$lang['reset_link_sent_with_email'] = '如果存在與所提供憑據匹配的帳戶，密碼重置連結已發送到您的電子郵件。';
$lang['working_plan_validation_failed'] = '發現無效的工作計畫配置。';
$lang['start_date'] = '開始日期';
$lang['end_date'] = '結束日期';
$lang['remember_me'] = '記住我的資訊';
$lang['remember_me_hint'] = '儲存您的資料以便下次更快預約。';
$lang['legal_notice'] = '法律聲明';
$lang['legal_notice_url'] = '法律聲明 URL';
$lang['legal_notice_url_hint'] = '輸入您的法律聲明頁面的 URL。';
$lang['imprint'] = '出版資訊';
$lang['imprint_url'] = '出版資訊 URL';
$lang['imprint_url_hint'] = '輸入您的出版資訊頁面的 URL。';
$lang['data_retention'] = '資料保留';
$lang['data_retention_days'] = '資料保留天數';
$lang['data_retention_days_hint'] = '設定客戶資料自動刪除的天數。設定為 0 可停用自動刪除。';
$lang['manage_privacy'] = '管理隱私';
$lang['manage_privacy_hint'] = '點擊以下連結查看、更新或刪除您的個人資訊。';
$lang['personal_information_updated'] = '您的個人資訊已成功更新。';
$lang['verify'] = '驗證';
$lang['verifying'] = '驗證中';
$lang['verified'] = '已驗證';
$lang['verification_complete'] = '驗證完成';
$lang['verification_failed'] = '驗證失敗。點擊重試。';
$lang['click_to_verify'] = '點擊驗證您是真人';
$lang['altcha_verification_failed'] = 'ALTCHA 驗證失敗。請重試。';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = '我們為自架軟體提供端到端服務，包括客製開發、託管主機、支援合約、品牌客製化和持續增強——讓您專注於業務，其餘交給我們。';
...
$lang['invalid_price'] = '無效的價格。';
$lang['invalid_slot_interval'] = '無效的時段間隔。';
$lang['invalid_attendants_number'] = '無效的參加人數。';
