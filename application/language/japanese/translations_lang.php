...
$lang['require_captcha_hint'] = '有効にすると、顧客はロボットでないことを証明するために、予約/更新の前にCAPTCHAチャレンジに直面する必要があります。';
$lang['none'] = 'なし';
$lang['recaptcha_server_token'] = 'reCAPTCHAサーバートークン';
$lang['recaptcha_client_token'] = 'reCAPTCHAクライアントトークン';
$lang['recaptcha_hint'] = 'Google recaptcha admin Webサイトにアクセスして、reCAPTCHA v2ドメインをセットアップし、サーバーとクライアントのトークンを取得してください。';
$lang['recaptcha_warning'] = 'reCAPTCHA を使用する場合は、現地の法律に準拠するようにプライバシー ポリシーを適切に更新する責任があります!';
