...
$lang['enter_password_here'] = 'ここにパスワードを入力 ...';
$lang['login'] = 'ログイン';
...
$lang['unexpected_issues_message'] = '操作を完了できませんでした。';
$lang['close'] = '閉じる';
...
$lang['personal_information'] = '個人情報';
...
$lang['enter_captcha_here'] = 'ここに CAPTCHA を入力...';
...
$lang['service_selection_layout'] = 'サービス選択レイアウト';
$lang['service_selection_layout_hint'] = '最初の予約ステップでサービスをどのように表示するかを選択します。';
$lang['dropdown'] = 'ドロップダウン';
$lang['accordion'] = 'アコーディオン';
$lang['hide_single_provider_selection'] = '単一プロバイダー選択を非表示';
$lang['hide_single_provider_selection_hint'] = '選択したサービスに利用可能なプロバイダーが1つしかない場合、プロバイダーフィールドを非表示にします。';
...
$lang['matomo_analytics_url'] = 'Matomo アナリティクス URL';
...
$lang['secret_header'] = 'シークレットヘッダー';
$lang['search'] = '検索';
$lang['slot_interval'] = 'スロット間隔（分）';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = '予約に対する Jitsi ミーティングリンクの自動生成を有効にします。有効にすると、固有の Jitsi ビデオ通話リンクが生成され、ミーティングリンクとして保存されます。';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA はプライバシー重視のオープンソース CAPTCHA 代替手段で、トラッキングなしにプルーフ・オブ・ワークを使用して人間のユーザーを検証します。';
$lang['altcha_enabled_hint'] = '有効にすると、フォーム検証に従来の画像 CAPTCHA の代わりに ALTCHA が使用されます。';
$lang['altcha_hmac_key'] = 'HMAC キー';
$lang['altcha_hmac_key_hint'] = 'ALTCHA チャレンジの署名と検証に使用される秘密キーです。生成をクリックして新しいセキュアキーを作成します。';
$lang['altcha_max_number'] = '最大数';
$lang['altcha_max_number_hint'] = 'プルーフ・オブ・ワークチャレンジの最大数。値が大きいほど難易度が上がります（デフォルト：100000）。';
$lang['altcha_expires'] = '有効期限（秒）';
...
$lang['google_calendar_info'] = 'Google Calendar 同期を有効にして、予約をプロバイダーの Google Calendar アカウントと同期します。';
$lang['google_client_id'] = 'クライアント ID';
$lang['google_client_id_info'] = 'Google Cloud Console プロジェクトのクライアント ID。';
$lang['google_client_secret'] = 'クライアントシークレット';
$lang['google_client_secret_info'] = 'Google Cloud Console プロジェクトのクライアントシークレット。';
$lang['google_calendar_setup_info'] = 'Google Calendar 同期を有効にするには、Google Cloud Console でプロジェクトを作成し、Google Calendar API を有効にし、OAuth 2.0 認証情報を作成する必要があります。以下にアクセスしてください：';
$lang['google_meet_link_generation'] = 'Google Meet リンクを生成';
$lang['google_meet_link_generation_info'] = '同期された予約に対して Google Meet ビデオ会議リンクを自動作成します。ミーティングリンクは予約のミーティングリンクフィールドに保存されます。';
$lang['display_add_to_google_calendar'] = '"Google Calendar に追加"ボタンを表示';
$lang['display_add_to_google_calendar_info'] = '予約確認ページに"Google Calendar に追加"ボタンを表示し、顧客が個人の Google Calendar に予約を簡単に追加できるようにします。';
$lang['select_all'] = 'すべて選択';
$lang['select_none'] = '選択解除';
$lang['appointment_update'] = '予約の更新';
$lang['notify_users_on_update_question'] = 'この変更について通知を送信しますか？';
$lang['yes'] = 'はい';
$lang['no'] = 'いいえ';
$lang['latest_blog_posts'] = '最新のブログ投稿';
$lang['loading'] = '読み込み中';
$lang['blog_posts_load_error'] = 'ブログ投稿を読み込めません。更新については公式ウェブサイトをご覧ください。';
$lang['provider_has_conflicting_appointment'] = '選択されたプロバイダーはその時間に既に別の予約があります。別の時間またはプロバイダーを選択してください。';
$lang['would_you_like_to_proceed'] = '続行してもよろしいですか？';
$lang['proceed'] = '続行';
$lang['no_available_service_providers'] = '利用可能なサービスがありません';
$lang['no_available_service_providers_message'] = '現在、予約可能なサービスまたはプロバイダーはありません。後で確認するか、サポートまでお問い合わせください。';
$lang['reset_password'] = 'パスワードをリセット';
$lang['new_password'] = '新しいパスワード';
$lang['enter_new_password'] = '以下に新しいパスワードを入力してください。';
$lang['enter_password_here'] = 'ここにパスワードを入力 ...';
$lang['password_reset_request'] = 'パスワードリセットリクエスト';
...
$lang['password_reset_failed'] = 'パスワードのリセットに失敗しました。もう一度お試しください。';
$lang['no_password_provided'] = 'パスワードを入力してください。';
$lang['type_username_and_email_for_reset_link'] = 'パスワードリセットリンクを受け取るには、ユーザー名とメールアドレスを入力してください。';
$lang['send_reset_link'] = 'リセットリンクを送信';
$lang['reset_link_sent_with_email'] = '提供された認証情報でアカウントが存在する場合、パスワードリセットリンクがメールに送信されました。';
$lang['working_plan_validation_failed'] = '無効なワーキングプラン設定が見つかりました。';
$lang['start_date'] = '開始日';
$lang['end_date'] = '終了日';
$lang['remember_me'] = '情報を記憶する';
$lang['remember_me_hint'] = '次回の予約を素早くするために情報を保存します。';
$lang['legal_notice'] = '法的通知';
$lang['legal_notice_url'] = '法的通知 URL';
$lang['legal_notice_url_hint'] = '法的通知ページの URL を入力してください。';
$lang['imprint'] = 'インプリント';
$lang['imprint_url'] = 'インプリント URL';
$lang['imprint_url_hint'] = 'インプリントページの URL を入力してください。';
$lang['data_retention'] = 'データ保持';
$lang['data_retention_days'] = 'データ保持日数';
$lang['data_retention_days_hint'] = '顧客データが自動的に削除されるまでの日数を設定します。自動削除を無効にするには 0 に設定してください。';
$lang['manage_privacy'] = 'プライバシー管理';
$lang['manage_privacy_hint'] = '以下のリンクをクリックして、個人情報の閲覧、更新、または削除を行ってください。';
$lang['personal_information'] = '個人情報';
$lang['personal_information_updated'] = '個人情報が正常に更新されました。';
$lang['verify'] = '検証';
$lang['verifying'] = '検証中';
$lang['verified'] = '検証済み';
$lang['verification_complete'] = '検証完了';
$lang['verification_failed'] = '検証に失敗しました。クリックして再試行してください。';
$lang['click_to_verify'] = 'クリックして人間であることを確認';
$lang['altcha_verification_failed'] = 'ALTCHA 検証に失敗しました。もう一度お試しください。';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = 'セルフホスティングソフトウェア向けにカスタム開発、マネージドホスティング、サポート契約、リブランディング、継続的な機能強化を含むエンドツーエンドのサービスを提供しています。お客様はビジネスに集中でき、残りは私たちにお任せください。';
