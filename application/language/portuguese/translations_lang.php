...
$lang['thank_you_for_appointment'] =
    'Obriagado por marcar um compromisso. Abaixo segue os detalhes do evento. Poderá realizar alterações abrindo o link.';
...
$lang['write_appointment_removal_reason'] =
    'Por favor, dedique alguns minutos para escrever a razão que você está apagando o evento:';
...
$lang['add_breaks_during_each_day'] =
    'Adicionar as pausas de trabalho durante cada dia. Durante os intervalos o fornecedor não aceitará quaisquer compromissos.';
$lang['day'] = 'Dia';
$lang['days'] = 'Days';
$lang['actions'] = 'Ações';
...
$lang['edit_breaks_hint'] =
    'Adicione as pausas de trabalho durante cada dia. Estas pausas serão aplicadas para todos os novos fornecedores de serviços.';
$lang['book_advance_timeout'] = 'Tempo esgotado / o tempo acaba';
$lang['book_advance_timeout_hint'] =
    'Definir o limite de tempo (em minutos) antes que os clientes possam reservar ou reorganizar eventos com a empresa.';
...
$lang['about_app_support'] =
    'Se  encontrar algum problema ao usar o Easy!Appointments pode procurar o Grupo oficial do Google para obter respostas. Pode precisar de criar uma nova questão na página do Google Code, a fim de ajudar o progresso do desenvolvimento.';
...
$lang['logout_success'] =
    'Ligação fechada com sucesso! Clique num dos seguintes botões para navegar para uma página diferente.';
...
$lang['type_username_and_email_for_new_password'] =
    'Digite o seu nome de utilizador e email para ser gerado uma nova senha.';
...
$lang['new_password_is'] =
    'A nova senha da conta é $password Por favor, guarde este email para ser possivel recuperar, se necessário. Pode alterar a senha na página de configurações.';
...
$lang['select_google_calendar_prompt'] =
    'Selecione o calendario para sincronizar os seus compromissos. Caso não tenha será selecionado um pre-definido.';
