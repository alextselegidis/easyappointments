...
$lang['cancel_appointment_hint'] = 'Pressione o botão "Cancelar Evento" para remover o compromisso da agenda (da empresa).';
...
$lang['enter_password_here'] = 'Introduza a palavra-passe aqui ...';
$lang['login'] = 'Entrar';
...
$lang['enter_captcha_here'] = 'Introduza o CAPTCHA aqui...';
...
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Ativar a geração automática de links de reunião Jitsi para compromissos. Quando ativado, um link único de videochamada Jitsi será gerado e armazenado como link da reunião.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'ALTCHA é uma alternativa CAPTCHA de código aberto focada na privacidade que utiliza prova de trabalho para verificar utilizadores humanos sem rastreamento.';
$lang['altcha_enabled_hint'] = 'Quando ativado, o ALTCHA será utilizado em vez do CAPTCHA de imagem tradicional para verificação de formulários.';
$lang['altcha_hmac_key'] = 'Chave HMAC';
$lang['altcha_hmac_key_hint'] = 'Uma chave secreta utilizada para assinar e verificar os desafios ALTCHA. Clique em Gerar para criar uma nova chave segura.';
$lang['altcha_max_number'] = 'Número máximo';
$lang['altcha_max_number_hint'] = 'O número máximo para o desafio de prova de trabalho. Valores mais altos aumentam a dificuldade (predefinido: 100000).';
$lang['altcha_expires'] = 'Expiração (Segundos)';
$lang['altcha_expires_hint'] = 'Tempo de validade de um desafio em segundos (predefinido: 300).';
...
$lang['google_calendar_info'] = 'Ativar a sincronização com o Google Calendar para sincronizar compromissos com as contas Google Calendar dos fornecedores.';
...
$lang['google_calendar_setup_info'] = 'Para ativar a sincronização com o Google Calendar, precisa de criar um projeto no Google Cloud Console, ativar a API do Google Calendar e criar credenciais OAuth 2.0. Visite:';
$lang['google_meet_link_generation'] = 'Gerar links do Google Meet';
$lang['google_meet_link_generation_info'] = 'Criar automaticamente um link de videoconferência Google Meet para compromissos sincronizados. O link da reunião será armazenado no campo de link de reunião do compromisso.';
$lang['display_add_to_google_calendar'] = 'Mostrar o botão "Adicionar ao Google Calendar"';
$lang['display_add_to_google_calendar_info'] = 'Mostrar o botão "Adicionar ao Google Calendar" na página de confirmação da reserva, permitindo aos clientes adicionar facilmente o seu compromisso ao seu Google Calendar pessoal.';
$lang['select_all'] = 'Selecionar tudo';
$lang['select_none'] = 'Desmarcar tudo';
$lang['appointment_update'] = 'Atualização de marcação';
$lang['notify_users_on_update_question'] = 'Gostaria de enviar uma notificação sobre esta alteração?';
$lang['yes'] = 'Sim';
$lang['no'] = 'Não';
$lang['latest_blog_posts'] = 'Últimas publicações do blog';
$lang['loading'] = 'A carregar';
$lang['blog_posts_load_error'] = 'Não foi possível carregar as publicações do blog. Visite o site oficial para atualizações.';
...
$lang['no_available_service_providers'] = 'Sem serviços disponíveis';
$lang['no_available_service_providers_message'] = 'Atualmente não há serviços ou prestadores disponíveis para reserva. Por favor, volte mais tarde ou contacte-nos para obter ajuda.';
$lang['reset_password'] = 'Redefinir palavra-passe';
$lang['new_password'] = 'Nova palavra-passe';
$lang['enter_new_password'] = 'Introduza a sua nova palavra-passe abaixo.';
$lang['password_reset_request'] = 'Pedido de redefinição de palavra-passe';
$lang['password_reset_email_message'] = 'Solicitou a redefinição da sua palavra-passe. Clique no botão abaixo para definir uma nova palavra-passe para a sua conta.';
$lang['password_reset_link_expires'] = 'Este link expirará em 1 hora.';
$lang['password_reset_ignore_message'] = 'Se não solicitou a redefinição da palavra-passe, ignore este email.';
...
$lang['password_reset_success'] = 'A sua palavra-passe foi reposta com sucesso. Será redirecionado para a página de início de sessão.';
$lang['password_reset_failed'] = 'Falha ao repor a palavra-passe. Por favor, tente novamente.';
$lang['no_password_provided'] = 'Por favor, introduza uma palavra-passe.';
$lang['type_username_and_email_for_reset_link'] = 'Escreva o seu nome de utilizador e endereço de email para receber um link de redefinição de palavra-passe.';
...
$lang['working_plan_validation_failed'] = 'Configuração do plano de trabalho inválida.';
$lang['start_date'] = 'Data de início';
$lang['end_date'] = 'Data de fim';
$lang['remember_me'] = 'Lembrar as minhas informações';
$lang['remember_me_hint'] = 'Guarde os seus dados para uma reserva mais rápida da próxima vez.';
$lang['legal_notice'] = 'Aviso legal';
$lang['legal_notice_url'] = 'URL do aviso legal';
$lang['legal_notice_url_hint'] = 'Introduza o URL da sua página de aviso legal.';
$lang['imprint'] = 'Impressum';
$lang['imprint_url'] = 'URL do impressum';
$lang['imprint_url_hint'] = 'Introduza o URL da sua página de impressum.';
$lang['data_retention'] = 'Retenção de dados';
$lang['data_retention_days'] = 'Dias de retenção de dados';
$lang['data_retention_days_hint'] = 'Defina o número de dias após os quais os dados dos clientes serão automaticamente eliminados. Defina 0 para desativar a eliminação automática.';
$lang['manage_privacy'] = 'Gerir privacidade';
$lang['manage_privacy_hint'] = 'Clique no link abaixo para visualizar, atualizar ou eliminar as suas informações pessoais.';
$lang['personal_information_updated'] = 'As suas informações pessoais foram atualizadas com sucesso.';
$lang['verify'] = 'Verificar';
$lang['verifying'] = 'A verificar';
$lang['verified'] = 'Verificado';
$lang['verification_complete'] = 'Verificação concluída';
$lang['verification_failed'] = 'A verificação falhou. Clique para tentar novamente.';
$lang['click_to_verify'] = 'Clique para verificar que é humano';
$lang['altcha_verification_failed'] = 'A verificação ALTCHA falhou. Por favor, tente novamente.';
...
$lang['invalid_price'] = 'Preço inválido.';
$lang['invalid_slot_interval'] = 'Intervalo de horário inválido.';
$lang['invalid_attendants_number'] = 'Número de participantes inválido.';
$lang['scheduling_conflict'] = 'Conflito de agendamento';
$lang['invalid_time'] = 'Hora inválida.';
$lang['service_and_provider_missing'] = 'Por favor, selecione um serviço e um fornecedor antes de continuar.';
$lang['caldav'] = 'CalDAV';
$lang['caldav_info'] = 'Sincronize as marcações dos seus prestadores com um servidor de calendário CalDAV e controle a que anfitriões a sincronização se pode ligar.';
$lang['caldav_allowed_hosts'] = 'URL de ligação permitidos';
$lang['caldav_allowed_hosts_info'] = 'Os URL CalDAV que apontam para um endereço de rede privado ou reservado são rejeitados, para que um URL introduzido na administração não consiga alcançar a rede interna desta instalação. Adicione um URL de ligação ou um nome de anfitrião por linha para o permitir mesmo assim. Adicione apenas servidores que sejam geridos por si.';
$lang['caldav_sync_failed'] = 'A sincronização CalDAV falhou';
$lang['caldav_sync_failed_url'] = 'Não foi possível utilizar o URL de ligação guardado. Se o seu servidor CalDAV estiver na sua rede local, adicione o respetivo URL em Definições, Integrações, CalDAV. Caso contrário, desative a sincronização e volte a ligar-se com um URL correto.';
$lang['caldav_sync_failed_credentials'] = 'O servidor CalDAV rejeitou o nome de utilizador e a palavra-passe. Desative a sincronização e volte a ligar-se com as credenciais corretas.';
$lang['caldav_sync_failed_unreachable'] = 'Não foi possível contactar o servidor CalDAV. Certifique-se de que está em funcionamento e de que o URL de ligação está correto.';
$lang['caldav_private_host_warning'] = 'Este servidor está numa rede privada. Ao ligar, o respetivo anfitrião será adicionado aos URL de ligação permitidos.';
$lang['caldav_allow_host_and_connect'] = 'Permitir e ligar';
// End
