...
$lang['require_captcha_hint'] = 'Quando habilitado, os clientes terão que enfrentar um desafio CAPTCHA antes de reservar / atualizar um compromisso para provar que eles não são um robô.';
$lang['none'] = 'Nenhum';
$lang['recaptcha_server_token'] = 'reCAPTCHA Server Token';
$lang['recaptcha_client_token'] = 'reCAPTCHA Client Token';
$lang['recaptcha_hint'] = 'Por favor, vá para o site google recaptcha admin para configurar um domínio reCAPTCHA v2 e obter seus tokens de servidor e cliente.';
$lang['recaptcha_warning'] = 'Você é responsável por atualizar adequadamente sua política de privacidade para cumprir as leis locais ao usar o reCAPTCHA!';
