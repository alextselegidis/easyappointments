...
$lang['appointment_locked_message'] = 'A consulta não pode ser alterada com menos de {$limit} horas de antecedência.';
...
$lang['require_captcha'] = 'Exigir CAPTCHA';
...
$lang['captcha_is_wrong'] = 'A verificação CAPTCHA falhou, por favor, tente novamente.';
$lang['any_provider'] = 'Qualquer Prestador';
$lang['requested_hour_is_unavailable'] = 'O compromisso solicitado infelizmente não está disponível. Por favor, selecione uma hora diferente para o seu compromisso.';
$lang['customer_notifications'] = 'Notificações para Clientes';
$lang['customer_notifications_hint'] = 'Define se o cliente receberá notificações por e-mail sempre que houver uma alteração na programação de um de seus compromissos.';
$lang['date_format'] = 'Formato da Data';
$lang['date_format_hint'] = 'Altere o formato de exibição da data (D - Data, M - Mês, Y - Ano).';
$lang['time_format'] = 'Formato do Tempo';
$lang['time_format_hint'] = 'Altere o formato de exibição do tempo (H - Horas, M - Minutos).';
...
$lang['read_and_agree_to_terms_and_conditions'] = 'Li e concordo com os {$link}Termos e Condições{/$link}.';
$lang['read_and_agree_to_privacy_policy'] = 'Li e concordo com a {$link}Política de Privacidade{/$link}.';
...
$lang['new_working_plan_exception_title'] = 'Nova Exceção do Plano de Trabalho';
...
$lang['require_phone_number_hint'] = 'Quando ativado, clientes e usuários precisarão inserir o número de telefone do cliente ao agendar um compromisso.';
$lang['check_spam_folder'] = 'Por favor, verifique a pasta de spam se o e-mail não chegar dentro de alguns minutos.';
...
$lang['overwrite_existing_working_plans'] = 'Isso substituirá os planos de trabalho existentes dos prestadores. Você tem certeza de que deseja continuar?';
$lang['working_plans_got_updated'] = 'Todos os planos de trabalho foram atualizados.';
$lang['apply_to_all_providers'] = 'Aplicar a Todos os Prestadores';
$lang['display_any_provider'] = 'Exibir Opção Qualquer Prestador';
$lang['display_any_provider_hint'] = 'A página de agendamento terá uma opção adicional que permite aos clientes agendar sem especificar um prestador.';
...
$lang['company_logo_hint'] = 'O logo da empresa será exibido em muitos lugares do aplicativo, incluindo a página de agendamento e os e-mails de notificação (arquivo de imagem, max 2MB).';
$lang['company_color'] = 'Cor da Empresa';
$lang['company_color_hint'] = 'A cor da empresa será aplicada em todo o aplicativo para que o aplicativo use sua marca.';
...
$lang['limit_customer_access_hint'] = 'Se ativado, prestadores e secretárias só poderão acessar clientes com os quais têm um compromisso.';
$lang['url'] = 'URL';
...
$lang['provider_save'] = 'Salvar Prestador';
$lang['provider_delete'] = 'Excluir Prestador';
...
$lang['webhooks_info'] = 'Webhooks permitem que você envie notificações HTTP para aplicativos web externos em resposta a vários eventos da aplicação, como a criação de um compromisso ou a remoção de um cliente.';
$lang['integrations_info'] = 'Integrações permitem que você faça conexões com aplicativos e APIs externos.';
$lang['configure'] = 'Configurar';
$lang['google_analytics'] = 'Google Analytics';
$lang['google_analytics_info'] = 'Google Analytics permite adicionar automaticamente o código de rastreamento e a marcação HTML na página pública e rastrear todas as sessões de agendamento públicas.';
$lang['matomo_analytics'] = 'Matomo Analytics';
$lang['matomo_analytics_info'] = 'Matomo Analytics permite adicionar automaticamente o código de rastreamento e a marcação HTML na página pública e rastrear todas as sessões de agendamento públicas.';
$lang['api'] = 'API';
$lang['api_info'] = 'A API permite interagir com todos os dados do Easy!Appointments via o protocolo HTTP e os endpoints da API disponíveis e criar suas próprias integrações.';
...
$lang['year'] = 'Ano';
$lang['make_non_working_day'] = 'Este prestador não estará disponível para trabalhar no dia selecionado.';
...
$lang['blocked_periods_hint'] = 'Defina períodos de tempo onde os agendamentos públicos estarão desativados para todos os prestadores (ex.: datas de fechamento, feriados, etc.).';
...
$lang['default_timezone_hint'] = 'Defina o valor de fuso horário padrão que será usado para novos registros.';
$lang['default_language'] = 'Idioma Padrão';
$lang['default_language_hint'] = 'Defina o valor do idioma padrão que será usado para novos registros.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'Esta integração permite conectar-se a um servidor LDAP existente e importar automaticamente usuários para o Easy!Appointments e permitir que eles usem SSO com sua senha de diretório (nome de usuário deve corresponder).';
$lang['host'] = 'Host';
$lang['port'] = 'Porta';
...
$lang['ldap_extension_not_loaded'] = 'A extensão LDAP do PHP não está carregada, mas é necessária para que esta integração funcione.';
