...
$lang['nõud_captcha_hint'] = 'Ha engedélyezve van, az ügyfeleknek CAPTCHA kihívással kell megküzdeniük, mielőtt foglalnának / frissítenének egy találkozót, hogy bebizonyítsák, hogy nem robotok.';
$lang['none'] = 'Nincs';
$lang['recaptcha_server_token'] = 'reCAPTCHA kiszolgáló token';
$lang['recaptcha_client_token'] = 'reCAPTCHA kliens token';
$lang['recaptcha_hint'] = 'Látogasson el a google recaptcha rendszergazdai webhelyére egy reCAPTCHA v2 domain beállításához, és szerezze be a szerver és az ügyfél tokenjeit.';
$lang['recaptcha_warning'] = 'Ön a felelős az adatvédelmi irányelvek megfelelő frissítéséért, hogy megfeleljen a helyi törvényeknek a reCAPTCHA használatakor!';
