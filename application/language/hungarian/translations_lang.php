...
$lang['appointment_locked_message'] = 'Az időpont nem módosítható kevesebb mint {$limit} órával előre.';
...
$lang['disable_sync_prompt'] = 'Biztosan le szeretné tiltani a naptár-szinkronizálást?';
$lang['reload'] = 'Frissít';
...
$lang['invalid_duration'] = 'Érvénytelen időtartam.';
...
$lang['hidden'] = 'Rejtett';
$lang['business_logic'] = 'Üzleti logika';
...
$lang['enter_password_here'] = 'Írja be a jelszót ide ...';
...
$lang['unexpected_issues_message'] = 'A művelet nem fejeződött be.';
$lang['close'] = 'Bezár';
...
$lang['enter_captcha_here'] = 'Írja be a CAPTCHA-t ide...';
...
$lang['service_selection_layout'] = 'Szolgáltatásválasztási elrendezés';
$lang['service_selection_layout_hint'] = 'Válassza ki, hogyan jelenjenek meg a szolgáltatások az első foglalási lépésben.';
$lang['dropdown'] = 'Lenyíló lista';
$lang['accordion'] = 'Harmonika';
$lang['hide_single_provider_selection'] = 'Egyetlen szolgáltató kiválasztásának elrejtése';
$lang['hide_single_provider_selection_hint'] = 'Elrejti a szolgáltató mezőt, ha a kiválasztott szolgáltatásnak csak egy elérhető szolgáltatója van.';
...
$lang['secret_header'] = 'Titkos fejléc';
$lang['search'] = 'Keresés';
$lang['slot_interval'] = 'Időrés intervallum (perc)';
$lang['jitsi'] = 'Jitsi';
$lang['jitsi_info'] = 'Automatikus Jitsi találkozó link generálás engedélyezése az időpontokhoz. Ha engedélyezve van, egyedi Jitsi videohívás link jön létre és tárolódik találkozó linkként.';
$lang['altcha'] = 'ALTCHA';
$lang['altcha_info'] = 'Az ALTCHA egy adatvédelmi fókuszú, nyílt forráskódú CAPTCHA alternatíva, amely munka-bizonyítékot használ az emberi felhasználók hitelesítésére nyomkövetés nélkül.';
$lang['altcha_enabled_hint'] = 'Ha engedélyezve van, az ALTCHA lesz használva a hagyományos képes CAPTCHA helyett az űrlap-ellenőrzéshez.';
$lang['altcha_hmac_key'] = 'HMAC kulcs';
$lang['altcha_hmac_key_hint'] = 'Titkos kulcs az ALTCHA kihívások aláírásához és ellenőrzéséhez. Kattintson a Generálás gombra egy új biztonságos kulcs létrehozásához.';
$lang['altcha_max_number'] = 'Maximális szám';
$lang['altcha_max_number_hint'] = 'A munka-bizonyíték kihívás maximális száma. A magasabb értékek növelik a nehézséget (alapértelmezett: 100000).';
$lang['altcha_expires'] = 'Lejárat (másodperc)';
...
$lang['google_calendar_info'] = 'A Google Calendar szinkronizáció engedélyezése az időpontok szinkronizálásához a szolgáltatók Google Calendar fiókjaival.';
$lang['google_client_id'] = 'Ügyfél-azonosító';
$lang['google_client_id_info'] = 'Az Ügyfél-azonosító a Google Cloud Console projektjéből.';
$lang['google_client_secret'] = 'Ügyféltitek';
$lang['google_client_secret_info'] = 'Az Ügyféltitek a Google Cloud Console projektjéből.';
$lang['google_calendar_setup_info'] = 'A Google Calendar szinkronizáció engedélyezéséhez létre kell hoznia egy projektet a Google Cloud Console-ban, engedélyeznie kell a Google Calendar API-t, és OAuth 2.0 hitelesítő adatokat kell létrehoznia. Látogasson el:';
$lang['google_meet_link_generation'] = 'Google Meet linkek generálása';
$lang['google_meet_link_generation_info'] = 'Automatikusan hozzon létre Google Meet videokonferencia linket a szinkronizált időpontokhoz. A találkozó link az időpont találkozó link mezőjében lesz tárolva.';
$lang['display_add_to_google_calendar'] = '"Hozzáadás a Google Calendar-hoz" gomb megjelenítése';
$lang['display_add_to_google_calendar_info'] = 'Jelenítse meg a "Hozzáadás a Google Calendar-hoz" gombot a foglalás megerősítő oldalon, lehetővé téve az ügyfeleknek, hogy egyszerűen hozzáadják időpontjukat személyes Google Calendar-jukhoz.';
$lang['select_all'] = 'Összes kijelölése';
$lang['select_none'] = 'Kijelölés megszüntetése';
$lang['appointment_update'] = 'Időpont frissítése';
$lang['notify_users_on_update_question'] = 'Szeretne értesítést küldeni erről a változásról?';
$lang['yes'] = 'Igen';
$lang['no'] = 'Nem';
$lang['latest_blog_posts'] = 'Legújabb blogbejegyzések';
$lang['loading'] = 'Betöltés';
$lang['blog_posts_load_error'] = 'Nem sikerült betölteni a blogbejegyzéseket. Kérjük, látogassa meg a hivatalos weboldalt a frissítésekért.';
...
$lang['would_you_like_to_proceed'] = 'Szeretné mindenképpen folytatni?';
$lang['proceed'] = 'Tovább';
$lang['no_available_service_providers'] = 'Nincs elérhető szolgáltatás';
$lang['no_available_service_providers_message'] = 'Jelenleg nincs elérhető szolgáltatás vagy szolgáltató foglaláshoz. Kérjük, nézzen vissza később, vagy lépjen kapcsolatba velünk segítségért.';
$lang['reset_password'] = 'Jelszó visszaállítása';
$lang['new_password'] = 'Új jelszó';
$lang['enter_new_password'] = 'Adja meg új jelszavát alább.';
$lang['enter_password_here'] = 'Írja be a jelszót ide ...';
$lang['password_reset_request'] = 'Jelszó-visszaállítási kérelem';
$lang['password_reset_email_message'] = 'Ön kérte a jelszava visszaállítását. Kattintson az alábbi gombra, hogy új jelszót állítson be a fiókjához.';
$lang['password_reset_link_expires'] = 'Ez a link 1 óra múlva lejár.';
$lang['password_reset_ignore_message'] = 'Ha nem kért jelszó-visszaállítást, kérjük, hagyja figyelmen kívül ezt az e-mailt.';
$lang['invalid_reset_token'] = 'A jelszó-visszaállító link érvénytelen.';
$lang['invalid_or_expired_token'] = 'A jelszó-visszaállító link érvénytelen vagy lejárt. Kérjen újat.';
$lang['password_reset_success'] = 'A jelszava sikeresen visszaállítva. Átirányítjuk a bejelentkezési oldalra.';
$lang['password_reset_failed'] = 'A jelszó visszaállítása sikertelen. Kérjük, próbálja újra.';
$lang['no_password_provided'] = 'Kérjük, adjon meg egy jelszót.';
$lang['type_username_and_email_for_reset_link'] = 'Írja be felhasználónevét és e-mail címét a jelszó-visszaállító link fogadásához.';
$lang['send_reset_link'] = 'Visszaállító link küldése';
...
$lang['working_plan_validation_failed'] = 'Érvénytelen munkaterv-konfiguráció található.';
$lang['start_date'] = 'Kezdő dátum';
$lang['end_date'] = 'Záró dátum';
$lang['remember_me'] = 'Adataim megjegyzése';
$lang['remember_me_hint'] = 'Mentse el adatait a gyorsabb foglaláshoz legközelebb.';
$lang['legal_notice'] = 'Jogi nyilatkozat';
$lang['legal_notice_url'] = 'Jogi nyilatkozat URL';
$lang['legal_notice_url_hint'] = 'Adja meg a jogi nyilatkozat oldalának URL-jét.';
$lang['imprint'] = 'Impresszum';
$lang['imprint_url'] = 'Impresszum URL';
$lang['imprint_url_hint'] = 'Adja meg az impresszum oldalának URL-jét.';
$lang['data_retention'] = 'Adatmegőrzés';
$lang['data_retention_days'] = 'Adatmegőrzési napok';
$lang['data_retention_days_hint'] = 'Állítsa be, hány nap elteltével törlődjenek automatikusan az ügyféladatok. Állítsa 0-ra az automatikus törlés letiltásához.';
$lang['manage_privacy'] = 'Adatvédelem kezelése';
$lang['manage_privacy_hint'] = 'Kattintson az alábbi linkre személyes adatai megtekintéséhez, frissítéséhez vagy törléséhez.';
$lang['personal_information'] = 'Személyes adatok';
$lang['personal_information_updated'] = 'Személyes adatai sikeresen frissültek.';
$lang['verify'] = 'Ellenőrzés';
$lang['verifying'] = 'Ellenőrzés folyamatban';
$lang['verified'] = 'Ellenőrizve';
$lang['verification_complete'] = 'Ellenőrzés kész';
$lang['verification_failed'] = 'Az ellenőrzés sikertelen. Kattintson az újrapróbálkozáshoz.';
$lang['click_to_verify'] = 'Kattintson az igazoláshoz, hogy Ön ember';
$lang['altcha_verification_failed'] = 'Az ALTCHA ellenőrzés sikertelen. Kérjük, próbálja újra.';
$lang['premium'] = 'Premium';
$lang['about_app_premium'] = 'Átfogó szolgáltatásokat kínálunk saját üzemeltetésű szoftverekhez, beleértve az egyedi fejlesztést, felügyelt tárhelyet, támogatási szerződéseket, márkaváltást és folyamatos fejlesztéseket — így Ön a vállalkozására koncentrálhat, míg mi a többiről gondoskodunk.';
