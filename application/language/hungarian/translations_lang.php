...
$lang['about_app_info'] = 'Car2dude egy könnyen testreszabható webes alkalmazás mely lehetővé teszi, hogy ügyfelek weben keresztül időpontokat foglalhassanak. Ezen felül lehetővé teszi, hogy szinkronizáljuk a foglalások adatait a Google naptárunkkal, így más szolgáltatásokkal is használható.';
$lang['current_version'] = 'Jelenlegi verzió';
$lang['support'] = 'Támogatás';
$lang['about_app_support'] = 'Amennyiben problémákba ütközöl az Car2dude használata közben, úgy a hivatalos Google Group-ban tudsz válaszokat keresni. Előfordulhat, hogy egy új lapot kell nyitnod a Google Code-on, hogy segítsd a további fejlesztést.';
...
$lang['about_app_license'] = 'Car2dude a GPLv3 licensz alatt áll. Az Car2dude forráskódját bármilyen módon használva beleegyezel az alábbi linken található felhasználási feltételekbe:';
