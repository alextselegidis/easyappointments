...
<head>
    ...
    <style>
        ...
        a.app-link{ color: <?= $settings['company_color'] ?? '#429a82' ?>; word-break:break-all; text-decoration:none; }
...
<body>
    ...
    <div class="email-container">
        ...
        <div id="content" class="email-content" style="min-height:400px;">
            ...
            <a href="<?= e($appointment_link) ?>" class="app-link">
                <?= e($appointment_link) ?>
            </a>
        </div>
