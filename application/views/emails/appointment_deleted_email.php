                      ...
                      <td style="vertical-align:top;padding-bottom:0px;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation" style width="100%">
                          <tbody>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Inform, Helvetica, sans-serif;font-weight:400;font-size:30px;line-height:1.3;text-align:left;color:#000000;"><?= lang('appointment_cancelled_title') ?></div>
                                <div style="font-family:Inform, Helvetica, sans-serif;font-size:16px;line-height:1.3;text-align:left;color:#666666; "><p><?= lang('appointment_removed_from_schedule') ?></p></div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;"> 
                                ...
                                <tr>
                                    <td class="label" style="padding: 3px 0px; width: 50%;">
                                      <div style="font-family:Inform, Helvetica, sans-serif;font-size:16px;line-height:1.3;text-align:left;color:#666666;"><?= lang('reason') ?></div>
                                    </td>
                                    <td style="padding: 3px 0px; width: 50%;">
                                      <div style="font-family:Inform, Helvetica, sans-serif;font-size:16px;line-height:1.3;text-align:left;color:#000000;">
                                        <?= e($reason) ?>
