...
- Added CalDAV SSRF-check toggling via `Config::ENABLE_CALDAV_SSRF_CHECK` (default: enabled) at the CalDAV library load path, and always allow `http://baikal` for local Docker CalDAV testing while keeping normal host validation for other URLs
