...
<p>Unfortunately you cannot just load this on top of my previous builds. Easy!Appointments 1.3.2 incorporates some of what was included in my older builds but using different methods. So you will need to start over again. What I did was quit the sync to google calendar and backed up the fallowing tables:</p>
<ul>
