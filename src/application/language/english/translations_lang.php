...
$lang['about_app'] = 'About JustInClicks.com';
...
$lang['about_app_info'] = 'JustInClicks.com is a highly customizable web application that allows your customers to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using JustInClicks.com you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'JustInClicks.com is licensed under the GPLv3 license. By using the code of JustInClicks.com in any way you are agreeing to the terms described in the following url:';
...
$lang['ea_update_success'] = 'JustInClicks.com has been successfully updated!';
