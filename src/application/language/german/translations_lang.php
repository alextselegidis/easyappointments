...
$lang['about_app'] = 'Über JustInClicks.com';
...
$lang['about_app_info'] = 'JustInClicks.com ist eine extrem anpassungsfähige Internet-Applikation die es Ihren Kunden ermöglicht, einen Termin mit Ihnen über des Internet zu schließen. Darüberhinaus gibt es Ihnen die Möglichkeit Ihre Daten mit dem Google Kalender zu synchronisieren, so dass Sie diese mit anderen Dienstleistungsprogrammen nutzen können.';
$lang['current_version'] = 'Laufende Version';
$lang['support'] = 'Unterstützung';
$lang['about_app_support'] = 'Falls Sie irgendein Problem bei der Nutzung von JustInClicks.com haben sollten können Sie die offizielle Google Gruppe nach Lösungen durchsuchen. Sie können auch ein neues Thema in Google Code beginnen, damit Sie die Findung von Lösungen unterstützen. ';
...
$lang['about_app_license'] = 'Easy!Appointment ist lizensiert under der GPLv3-Lizenz. Bei Benutzung des Codes für JustInClicks.com auf irgendeine Weise stimmen Sie mit den Nutzungsbedingungen zu wie sie in folgender url aufgeführt sind:';
...
$lang['ea_update_success'] = 'JustInClicks.com wurde erfolgreich aktualisiert!';
