...
$lang['require_captcha'] = 'CAPTCHA requis';
$lang['require_captcha_hint'] = 'Lorsque cette option est activé, les clients devront réécrire un CAPTCHA de vérification pour ajouter/modifier un rendez-vous.';
$lang['captcha_is_wrong'] = 'CAPTCHA incorrect, veuillez réessayer.';
$lang['any_provider'] = 'N\'importe quel exécutant';
$lang['requested_hour_is_unavailable'] = 'L\'horaire du rendez-vous n\'est plus disponible. SVP sélectionnez une horaire différente.';
$lang['customer_notifications'] = 'Notifications du client';
$lang['customer_notifications_hint'] = 'Définit si le client recevra des notifications par email chaque fois qu\'il ya un changement d\'horaire sur l\'un de ses rendez-vous.';
$lang['date_format'] = 'Format de Date';
$lang['date_format_hint'] = 'Changer le format d\'affichage de la date (D - Jour, M - Mois, Y - Année).';
$lang['google_analytics_code_hint'] = 'Ajoutez votre ID Google Analytics à inclure dans la page de réservation.';
