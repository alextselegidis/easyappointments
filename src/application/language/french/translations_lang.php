...
$lang['customer_details_title'] = 'Détails du client';
...
$lang['appointment_added_to_your_plan'] = 'Un nouveau rendez-vous a été ajouté à votre plan.';
...
$lang['company_link_hint'] = 'Lien d\'entreprise doit pointer vers le site officiel de l\'entreprise (obligatoire).';
...
$lang['fixed'] = 'Statique';
$lang['attendants_number'] = 'Nombre de préposés'; 
//Craig Tucker Mods start
$lang['apointent_cancelation'] = 'Annuler le rendez-vous';
$lang['cell_carrier'] = 'Pour les rappels de texte, sélectionnez votre fournisseur mobile:';
$lang['waitinglist_registered'] = 'Liste d\'attente';
$lang['waitinglist_details'] = 'Vous avez été ajouté à la liste d\'attente pour les 30 prochains jours. Pour vous désabonner, utilisez le lien de désinscription inclus dans vos notifications par courriel.	';
$lang['return_to_book'] = 'Retour à Réservation';
$lang['waitinglist_canceled_title'] = 'Liste d\'attente annulée';
$lang['waitinglist_cancelled'] = 'Vous avez été retiré avec succès de la liste d\'attente.';
$lang['new_apt'] = 'Ajouter un nouveau rendez-vous';
$lang['change_apt'] = 'Modifier le rendez-vous actuel pour:';
$lang['wp_id'] = 'Wordpress ID';
$lang['Q15'] = 'Au quart';
$lang['Q30'] = 'Au demi';
$lang['waiting_list'] = 'Liste d\'attente';
$lang['waiting_list_msg_top1'] = 'En vous inscrivant ici, vous recevrez un courriel quotidien ou un courriel et des avis de texte pendant 30 jours concernant toute disponibilité que j\'ai au cours des ';
$lang['waiting_list_msg_top2'] = 'prochains jours. Vous pouvez renouveler votre place sur la liste d\'attente aussi souvent que vous le souhaitez. Pour être supprimé de la liste, cliquez sur le lien de votre message électronique / texte pour le supprimer.';
$lang['waiting_list_msg_bottom_header'] = 'En ce qui concerne la notification de texte:';
$lang['waiting_list_msg_bottom'] = 'Si vous choisissez d\'être averti par message texte, sachez que ces messages peuvent être longs si le calendrier dispose de plusieurs jours de disponibilité.';
...
$lang['edit_reschedule_cancel_appointment'] = 'Cliquez ici pour modifier, replanifier ou annuler le rendez-vous';
$lang['what_to_do'] = 'Qu\'aimeriez-vous faire?';
$lang['waiting_list_update'] = 'Mise à jour de la liste d\'attente de';
$lang['waiting_list_update1'] = 'Mise à jour:'; 
$lang['waiting_list_no_avail'] = 'n\'a pas de disponibilité pour le moment:';
$lang['view_current_sched'] = 'Pour consulter le calendrier actuel, cliquez ici:';
$lang['remove_from_wl'] = 'Pour vous retirer de la liste d\'attente, cliquez sur le lien suivant:';
$lang['waiting_list_has_avail'] = 'a la disponibilité aux dates et heures suivantes:';
$lang['make_appointment'] = 'Pour prendre un rendez-vous cliquez ici:';
$lang['select_language'] = 'Choisir la langue';
$lang['user_lang']= 'french';
$lang['notice_reminder']= 'Un jour de plus jusqu\'à votre rendez-vous.';
$lang['notice_reminder_days']= 'jours de plus jusqu\'à votre rendez-vous.';
$lang['reminder_your_appt_with']= 'RAPPEL: Votre rendez-vous avec';
$lang['is_on']= 'est à'; 
$lang['msg_line1']= 'Si vous avez eu une bonne expérience, faites savoir aux autres! S\'il vous plaît me donner des commentaires à:'; 
$lang['msg_line2']= 'www.healthgrades.com/review/XGVRC:'; 
$lang['msg_line3']= 'Pour modifier, replanifier ou annuler le rendez-vous s\'il vous plaît cliquer sur le lien suivant:';
$lang['msg_line4']= 'Pour assister à votre session en ligne, connectez-vous à www.craigtuckerlcsw.com et allez à "My Appointments"';
$lang['powered_by']= 'Alimenté par';
$lang['operation_failed']= 'L\'opération a échoué! Veuillez saisir un nom d\'utilisateur et une adresse e-mail valides pour obtenir un nouveau mot de passe.';
$lang['max_date']= 'Maximum de jours';
$lang['max_date_hint']= 'Ce paramètre vous permet de vous assurer que les personnes ne passent pas des rendez-vous trop de jours dans l\'avenir';
$lang['time_format'] = 'Format de l\'heure';
$lang['time_format_hint'] = 'Changez le format d\'affichage de l\'heure (AM / PM ou 24h).';
$lang['interval_time'] = 'Intervalle de temps pour les rendez-vous fixes';
$lang['interval_time_hint'] = 'Si vos rendez-vous sont généralement 1 heure, entrez 60 ici';
$lang['week_starts_on'] = 'La semaine commence le:';
$lang['week_starts_on_hint'] = 'La semaine débute le lundi ou la semaine commence le dimanche';
$lang['show_free_price_currency'] = 'Afficher le prix du service défini à 0';
$lang['show_free_price_currency_hint'] = 'Si vous avez des services que vous ne facturez pas ou qu\'ils sont gratuits, vous pouvez décider de ne pas l\'afficher la devise dans l\'écran initial';
$lang['show_any_provider'] = 'Afficher la liste déroulante "Tous fournisseurs"';
$lang['show_any_provider_hint'] = 'Si vous êtes un fournisseur unique dans votre entreprise, sélectionnez NO';
$lang['yes'] = 'Oui';
$lang['no'] = 'Non';
$lang['reminder_days_out'] = 'Rappels de rendez-vous';
$lang['reminder_days_out_hint'] = 'Il s\'agit d\'une liste délimitée par des virgules des entiers en jours sur lesquels vous souhaitez envoyer des rappels. Exemple: 1,3 signifie qu\'à 1 jour et 3 jours avant le rendez-vous, le participant recevra le rappel.';
$lang['sms'] = 'SMS';
$lang['preferred_language'] = 'Langue Préférée';
$lang['theme_color'] = 'Choisissez une couleur de thème';
$lang['theme_color_hint'] = 'Cela modifiera le schéma de couleur global de l\'application';
$lang['green'] = 'Vert';
$lang['blue'] = 'Bleu';
$lang['red'] = 'Rouge';
$lang['waiting_list_details_title'] = 'Détails de la liste d\'attente';
