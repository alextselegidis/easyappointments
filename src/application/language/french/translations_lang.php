...
$lang['about_app'] = 'Au sujet d\'JustInClicks.com';
...
$lang['about_app_info'] = 'JustInClicks.com est une application Web hautement personnalisable qui permet à vos clients de prendre rendez-vous avec vous via le web. En outre, elle offre la possibilité de synchroniser vos données avec un calendrier Google afin que vous puissiez les utiliser avec d\'autres services. JustInClicks.com est un projet open source et vous pouvez le télécharger et l\'installer même pour un usage commercial. JustInClicks.com fonctionnera sans problème avec votre site web existant car il peut être installé dans un dossier spécifique du serveur et bien sûr, les deux sites peuvent partager la même base de données.';
...
$lang['about_app_license'] = 'JustInClicks.com est enregistré sous licence GPLv3. En utilisant le code d\'JustInClicks.com, quelqu\'en soit l\'usage, vous êtes tenu d\'accepter les termes décrits dans l\'URL suivante:';
...
$lang['ea_update_success'] = 'JustInClicks.com à été mis à jour avec succès !';
