...
$lang['about_app'] = 'О приложении JustInClicks.com';
...
$lang['about_app_info'] = 'JustInClicks.com хорошо настраиваемое веб приложение которое позволяет вашим заказчикам оформлять время предоставления услуг через интернет. Кроме того, имеется возможность синхронизации с вашими Google-календарями так что вы сможете использовать план заказанных мероприятий.';
$lang['current_version'] = 'Текущая версия';
$lang['support'] = 'Поддержка';
$lang['about_app_support'] = 'Если произошли проблемы с использованием JustInClicks.com вы можете использовать официальную Google группу для поиска ответа. Вы можете также создать новый запрос на странице проекта в Google Code вопрос на странице Google Code для того, чтобы помочь проекту развиватся.';
...
$lang['about_app_license'] = 'JustInClicks.com обладает лицензией GPLv3. При использовании кода приложения в любом случае вы соглашаетесь с условиями, описанными в следующей URL:';
