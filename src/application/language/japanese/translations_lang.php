...
$lang['about_app'] = 'JustInClicks.comとは。';
...
$lang['about_app_info'] = 'JustInClicks.comは、カスタマイズ可能な予約受付ウエッブアップリケーションです。さら、Googleカレンダーとの連携ができるので、このシステムのスケジュールを他のシステムのスケジュールとまとめてみることができます。';
$lang['current_version'] = 'バージョン番号';
$lang['support'] = 'サポート';
$lang['about_app_support'] = ' JustInClicks.com を利用する上で もし何か 問題がありましたら 、是非　公式 Google Groupを検索して 解決方法を見つけてください。もしかしたら 開発をさらに良いものにするために 新しい課題を Google Code に 登録することもできます。';
...
$lang['license'] = 'ライセンス';
$lang['about_app_license'] = 'JustInClicks.com は　GPLv3 ライセンス に従います。 JustInClicks.com　のプログラムコードを使用するということは、あるあらゆる面で 次のURLのサイトにある条件に同意したこととなります。:';
...
$lang['ea_update_success'] = 'JustInClicks.com の　アップデートが成功しました。';
