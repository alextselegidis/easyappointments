...
$lang['about_app'] = 'Σχετικά με το JustInClicks.com';
...
$lang['about_app_info'] = 'Το JustInClicks.com είναι μια εξαιρετικά προσαρμόσιμη διαδικτυακή εφαρμογή η οποία επιτρέπει στους πελάτες σας να κλείνουν ραντεβού με εσάς μέσω του διαδικτύου. Επιπλέον παρέχει την δυνατότητα να συγχρονίσετε τα δεδομένα σας με το Google Calendar έτσι ώστε να μπορέσετε να τα χρησιμοποιήσετε με άλλες υπηρεσίες.';
$lang['current_version'] = 'Τρέχουσα Έκδοση';
$lang['support'] = 'Υποστήριξη';
$lang['about_app_support'] = 'Αν αντιμετωπίσετε προβλήματα κατά την χρήση του JustInClicks.com μπορείτε να ψάξετε το επίσημο Google Group για απαντήσεις. Μπορείτε επίσης να δημιουργήσετε ένα νέο θέμα στην σελίδα Google Code έτσι ώστε να βοηθήσετε την πρόοδο της ανάπτυξης.';
...
$lang['about_app_license'] = 'Το JustInClicks.com έχει αδειοδοτηθεί υπό την άδεια χρήσης GPLv3. Χρησιμοποιώντας τον κώδικα του Easy!Appointents με οποιονδήποτε τρόπο συμφωνείτε με τους όρους που περιγράφονται στον ακόλουθο σύνδεσμο:';
...
$lang['ea_update_success'] = 'Το JustInClicks.com ενημερώθηκε με επιτυχία!';
