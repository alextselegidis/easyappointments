...
class Backend extends CI_Controller {
    ...
    public function index($appointment_hash = '') {
        ...
        $view['first_day_of_week'] = $this->settings_model->get_setting('first_day_of_week');
        $view['day_start_time'] = $this->settings_model->get_setting('day_start_time');
        $view['day_end_time'] = $this->settings_model->get_setting('day_end_time');
        $view['time_slot_interval'] = $this->settings_model->get_setting('time_slot_interval');
