...
exports.compile = gulp.series(clean, vendor, scripts, styles, images);
exports.dev = gulp.series(clean, vendor, scripts, styles, images, watch);
exports.build = gulp.series(clean, vendor, scripts, styles, images, archive);
