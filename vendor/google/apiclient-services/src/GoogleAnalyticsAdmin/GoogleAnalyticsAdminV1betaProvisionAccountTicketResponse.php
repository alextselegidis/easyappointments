...
class_alias(GoogleAnalyticsAdminV1betaProvisionAccountTicketResponse::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaProvisionAccountTicketResponse');
