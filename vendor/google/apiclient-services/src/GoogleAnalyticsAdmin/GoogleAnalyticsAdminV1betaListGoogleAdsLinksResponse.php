...
class_alias(GoogleAnalyticsAdminV1betaListGoogleAdsLinksResponse::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaListGoogleAdsLinksResponse');
