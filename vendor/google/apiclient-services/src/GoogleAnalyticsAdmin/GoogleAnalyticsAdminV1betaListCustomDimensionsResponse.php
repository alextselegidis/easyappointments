...
class_alias(GoogleAnalyticsAdminV1betaListCustomDimensionsResponse::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaListCustomDimensionsResponse');
