...
class_alias(GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsResponse::class, 'Google_Service_GoogleAnalyticsAdmin_GoogleAnalyticsAdminV1betaSearchChangeHistoryEventsResponse');
