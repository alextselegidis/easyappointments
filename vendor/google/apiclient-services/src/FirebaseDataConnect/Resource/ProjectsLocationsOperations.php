 ...
 *   $operations = $firebasedataconnectService->projects_locations_operations;
 *  </code>
 */
class ProjectsLocationsOperations extends \Google\Service\Resource
{
   ...
   * @return FirebasedataconnectEmpty
  ...
  public function cancel($name, CancelOperationRequest $postBody, $optParams = [])
  {
    ...
    return $this->call('cancel', [$params], FirebasedataconnectEmpty::class);
  }
  /**
  ...
  public function delete($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
    return $this->call('delete', [$params], FirebasedataconnectEmpty::class);
  }
  /**
...
class_alias(ProjectsLocationsOperations::class, 'Google_Service_FirebaseDataConnect_Resource_ProjectsLocationsOperations');
