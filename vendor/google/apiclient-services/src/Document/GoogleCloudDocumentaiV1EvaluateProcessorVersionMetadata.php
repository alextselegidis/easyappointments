...
class GoogleCloudDocumentaiV1EvaluateProcessorVersionMetadata extends \Google\Model
{
...
class_alias(GoogleCloudDocumentaiV1EvaluateProcessorVersionMetadata::class, 'Google_Service_Document_GoogleCloudDocumentaiV1EvaluateProcessorVersionMetadata');
