...
class ListAnalyticsAccountLinksResponse extends \Google\Collection
{
  ...
  {
    $this->analyticsAccountLinks = $analyticsAccountLinks;
  }
  /**
...
class_alias(ListAnalyticsAccountLinksResponse::class, 'Google_Service_GoogleMarketingPlatformAdminAPI_ListAnalyticsAccountLinksResponse');
