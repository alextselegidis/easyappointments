...
class ProjectsLocationsTableDataProfiles extends \Google\Service\Resource
{
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsLocationsTableDataProfiles($parent, $optParams = [])
  {
...
class_alias(ProjectsLocationsTableDataProfiles::class, 'Google_Service_DLP_Resource_ProjectsLocationsTableDataProfiles');
