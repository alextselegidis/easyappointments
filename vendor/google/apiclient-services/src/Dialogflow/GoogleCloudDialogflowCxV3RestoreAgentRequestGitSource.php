...
class_alias(GoogleCloudDialogflowCxV3RestoreAgentRequestGitSource::class, 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3RestoreAgentRequestGitSource');
