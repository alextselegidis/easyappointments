...
class GoogleCloudDialogflowV2beta1ResponseMessageMixedAudio extends \Google\Collection
{
  ...
  /**
   * @param GoogleCloudDialogflowV2beta1ResponseMessageMixedAudioSegment[]
   */
...
class_alias(GoogleCloudDialogflowV2beta1ResponseMessageMixedAudio::class, 'Google_Service_Dialogflow_GoogleCloudDialogflowV2beta1ResponseMessageMixedAudio');
