...
class GoogleCloudDialogflowCxV3ImportEntityTypesResponseConflictingResources extends \Google\Collection
{
...
class_alias(GoogleCloudDialogflowCxV3ImportEntityTypesResponseConflictingResources::class, 'Google_Service_Dialogflow_GoogleCloudDialogflowCxV3ImportEntityTypesResponseConflictingResources');
