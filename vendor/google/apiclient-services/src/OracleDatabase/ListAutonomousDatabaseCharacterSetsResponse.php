...
class ListAutonomousDatabaseCharacterSetsResponse extends \Google\Collection
{
  protected $collection_key = 'autonomousDatabaseCharacterSets';
...
class_alias(ListAutonomousDatabaseCharacterSetsResponse::class, 'Google_Service_OracleDatabase_ListAutonomousDatabaseCharacterSetsResponse');
