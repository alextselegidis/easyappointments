 ...
 *   $operations = $retailService->projects_locations_catalogs_operations;
 *  </code>
 */
...
class_alias(ProjectsLocationsCatalogsOperations::class, 'Google_Service_CloudRetail_Resource_ProjectsLocationsCatalogsOperations');
