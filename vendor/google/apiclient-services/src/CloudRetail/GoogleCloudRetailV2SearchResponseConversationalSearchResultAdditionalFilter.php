...
class GoogleCloudRetailV2SearchResponseConversationalSearchResultAdditionalFilter extends \Google\Model
{
...
class_alias(GoogleCloudRetailV2SearchResponseConversationalSearchResultAdditionalFilter::class, 'Google_Service_CloudRetail_GoogleCloudRetailV2SearchResponseConversationalSearchResultAdditionalFilter');
