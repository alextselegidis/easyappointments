...
class GoogleCloudRetailV2SearchResponseConversationalSearchResultSuggestedAnswer extends \Google\Model
{
...
class_alias(GoogleCloudRetailV2SearchResponseConversationalSearchResultSuggestedAnswer::class, 'Google_Service_CloudRetail_GoogleCloudRetailV2SearchResponseConversationalSearchResultSuggestedAnswer');
