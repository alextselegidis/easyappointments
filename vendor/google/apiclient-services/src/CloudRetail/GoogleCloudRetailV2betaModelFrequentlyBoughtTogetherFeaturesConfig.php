...
class_alias(GoogleCloudRetailV2betaModelFrequentlyBoughtTogetherFeaturesConfig::class, 'Google_Service_CloudRetail_GoogleCloudRetailV2betaModelFrequentlyBoughtTogetherFeaturesConfig');
