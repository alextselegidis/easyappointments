...
class_alias(GoogleCloudDocumentaiV1DocumentChunkedDocumentChunkChunkPageFooter::class, 'Google_Service_Contentwarehouse_GoogleCloudDocumentaiV1DocumentChunkedDocumentChunkChunkPageFooter');
