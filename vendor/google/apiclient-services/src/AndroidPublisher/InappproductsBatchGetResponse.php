...
class InappproductsBatchGetResponse extends \Google\Collection
{
...
class_alias(InappproductsBatchGetResponse::class, 'Google_Service_AndroidPublisher_InappproductsBatchGetResponse');
