...
class BatchGetSubscriptionOffersResponse extends \Google\Collection
{
...
class_alias(BatchGetSubscriptionOffersResponse::class, 'Google_Service_AndroidPublisher_BatchGetSubscriptionOffersResponse');
