...
class BatchUpdateSubscriptionOffersResponse extends \Google\Collection
{
...
class_alias(BatchUpdateSubscriptionOffersResponse::class, 'Google_Service_AndroidPublisher_BatchUpdateSubscriptionOffersResponse');
