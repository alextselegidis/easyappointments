 ...
 *   $operations = $beyondcorpService->organizations_locations_operations;
 *  </code>
 */
class OrganizationsLocationsOperations extends \Google\Service\Resource
{
  ...
  public function cancel($name, GoogleLongrunningCancelOperationRequest $postBody, $optParams = [])
  {
    ...
    return $this->call('cancel', [$params], BeyondcorpEmpty::class);
  }
  /**
  ...
  public function delete($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
    return $this->call('delete', [$params], BeyondcorpEmpty::class);
  }
  /**
...
class_alias(OrganizationsLocationsOperations::class, 'Google_Service_BeyondCorp_Resource_OrganizationsLocationsOperations');
