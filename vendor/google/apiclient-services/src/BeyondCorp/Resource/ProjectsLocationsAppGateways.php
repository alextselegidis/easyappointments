...
class ProjectsLocationsAppGateways extends \Google\Service\Resource
{
   ...
   * `PERMISSION_DENIED` errors. (appGateways.setIamPolicy)
   *
   * @param string $resource REQUIRED: The resource for which the policy is being
   ...
   * (appGateways.testIamPermissions)
   *
...
class_alias(ProjectsLocationsAppGateways::class, 'Google_Service_BeyondCorp_Resource_ProjectsLocationsAppGateways');
