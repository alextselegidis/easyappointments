...
class SearchSparkApplicationSqlQueriesResponse extends \Google\Collection
{
...
class_alias(SearchSparkApplicationSqlQueriesResponse::class, 'Google_Service_Dataproc_SearchSparkApplicationSqlQueriesResponse');
