...
class SearchSparkApplicationExecutorsResponse extends \Google\Collection
{
...
class_alias(SearchSparkApplicationExecutorsResponse::class, 'Google_Service_Dataproc_SearchSparkApplicationExecutorsResponse');
