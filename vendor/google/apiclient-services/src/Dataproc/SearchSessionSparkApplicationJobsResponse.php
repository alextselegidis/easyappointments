...
class SearchSessionSparkApplicationJobsResponse extends \Google\Collection
{
...
class_alias(SearchSessionSparkApplicationJobsResponse::class, 'Google_Service_Dataproc_SearchSessionSparkApplicationJobsResponse');
