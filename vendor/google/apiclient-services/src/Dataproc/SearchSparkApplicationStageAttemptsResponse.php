...
class SearchSparkApplicationStageAttemptsResponse extends \Google\Collection
{
...
class_alias(SearchSparkApplicationStageAttemptsResponse::class, 'Google_Service_Dataproc_SearchSparkApplicationStageAttemptsResponse');
