...
class SearchSparkApplicationStageAttemptTasksResponse extends \Google\Collection
{
...
class_alias(SearchSparkApplicationStageAttemptTasksResponse::class, 'Google_Service_Dataproc_SearchSparkApplicationStageAttemptTasksResponse');
