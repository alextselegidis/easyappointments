...
class_alias(EnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents::class, 'Google_Service_CloudSearch_EnterpriseTopazSidekickGetAndKeepAheadCardProtoDeclinedEvents');
