...
class GoogleCloudContactcenterinsightsV1ListAllFeedbackLabelsResponse extends \Google\Collection
{
...
class_alias(GoogleCloudContactcenterinsightsV1ListAllFeedbackLabelsResponse::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1ListAllFeedbackLabelsResponse');
