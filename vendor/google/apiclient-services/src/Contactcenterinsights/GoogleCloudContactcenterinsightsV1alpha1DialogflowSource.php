...
class_alias(GoogleCloudContactcenterinsightsV1alpha1DialogflowSource::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1DialogflowSource');
