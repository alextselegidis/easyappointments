...
class_alias(GoogleCloudContactcenterinsightsV1ListQaScorecardRevisionsResponse::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1ListQaScorecardRevisionsResponse');
