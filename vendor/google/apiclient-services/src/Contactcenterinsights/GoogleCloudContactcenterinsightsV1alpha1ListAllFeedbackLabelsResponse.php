...
class GoogleCloudContactcenterinsightsV1alpha1ListAllFeedbackLabelsResponse extends \Google\Collection
{
...
class_alias(GoogleCloudContactcenterinsightsV1alpha1ListAllFeedbackLabelsResponse::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1ListAllFeedbackLabelsResponse');
