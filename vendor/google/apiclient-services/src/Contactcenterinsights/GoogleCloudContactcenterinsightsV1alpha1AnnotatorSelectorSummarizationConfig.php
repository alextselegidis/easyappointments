...
class_alias(GoogleCloudContactcenterinsightsV1alpha1AnnotatorSelectorSummarizationConfig::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1AnnotatorSelectorSummarizationConfig');
