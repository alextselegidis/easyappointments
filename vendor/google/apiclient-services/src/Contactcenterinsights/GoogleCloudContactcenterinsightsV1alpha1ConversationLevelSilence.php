...
class GoogleCloudContactcenterinsightsV1alpha1ConversationLevelSilence extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(GoogleCloudContactcenterinsightsV1alpha1ConversationLevelSilence::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1alpha1ConversationLevelSilence');
