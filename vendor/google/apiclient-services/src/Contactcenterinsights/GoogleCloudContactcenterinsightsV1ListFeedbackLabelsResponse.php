...
class_alias(GoogleCloudContactcenterinsightsV1ListFeedbackLabelsResponse::class, 'Google_Service_Contactcenterinsights_GoogleCloudContactcenterinsightsV1ListFeedbackLabelsResponse');
