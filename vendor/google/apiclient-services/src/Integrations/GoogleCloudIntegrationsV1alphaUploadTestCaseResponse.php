...
class_alias(GoogleCloudIntegrationsV1alphaUploadTestCaseResponse::class, 'Google_Service_Integrations_GoogleCloudIntegrationsV1alphaUploadTestCaseResponse');
