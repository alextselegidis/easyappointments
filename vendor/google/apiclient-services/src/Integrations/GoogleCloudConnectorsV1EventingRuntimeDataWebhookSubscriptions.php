...
class_alias(GoogleCloudConnectorsV1EventingRuntimeDataWebhookSubscriptions::class, 'Google_Service_Integrations_GoogleCloudConnectorsV1EventingRuntimeDataWebhookSubscriptions');
