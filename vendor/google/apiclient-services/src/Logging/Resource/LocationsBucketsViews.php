 ...
 *  </code>
 */
class LocationsBucketsViews extends \Google\Service\Resource
{
  /**
...
class_alias(LocationsBucketsViews::class, 'Google_Service_Logging_Resource_LocationsBucketsViews');
