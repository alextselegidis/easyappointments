...
class ProjectsInstanceConfigsOperations extends \Google\Service\Resource
{
   ...
   * (operations.listProjectsInstanceConfigsOperations)
   *
   ...
   * @throws \Google\Service\Exception
   */
  public function listProjectsInstanceConfigsOperations($name, $optParams = [])
  {
    $params = ['name' => $name];
    $params = array_merge($params, $optParams);
...
class_alias(ProjectsInstanceConfigsOperations::class, 'Google_Service_Spanner_Resource_ProjectsInstanceConfigsOperations');
