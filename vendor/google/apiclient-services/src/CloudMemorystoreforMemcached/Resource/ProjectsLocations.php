 ...
 *   $locations = $memcacheService->projects_locations;
 *  </code>
 */
...
class_alias(ProjectsLocations::class, 'Google_Service_CloudMemorystoreforMemcached_Resource_ProjectsLocations');
