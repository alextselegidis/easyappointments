...
class_alias(GoogleCloudDiscoveryengineV1RecommendResponseRecommendationResult::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1RecommendResponseRecommendationResult');
