...
class_alias(GoogleCloudDiscoveryengineV1alphaCrawlRateTimeSeries::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaCrawlRateTimeSeries');
