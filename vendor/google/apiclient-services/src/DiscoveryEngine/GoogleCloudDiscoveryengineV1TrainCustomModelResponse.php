...
class GoogleCloudDiscoveryengineV1TrainCustomModelResponse extends \Google\Collection
{
...
class_alias(GoogleCloudDiscoveryengineV1TrainCustomModelResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1TrainCustomModelResponse');
