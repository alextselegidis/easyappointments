...
class_alias(GoogleCloudDiscoveryengineV1alphaIdpConfigExternalIdpConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaIdpConfigExternalIdpConfig');
