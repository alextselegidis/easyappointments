...
class_alias(GoogleCloudDiscoveryengineV1AnswerReferenceUnstructuredDocumentInfo::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1AnswerReferenceUnstructuredDocumentInfo');
