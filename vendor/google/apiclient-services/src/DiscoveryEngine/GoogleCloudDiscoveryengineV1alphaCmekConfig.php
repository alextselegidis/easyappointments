...
class GoogleCloudDiscoveryengineV1alphaCmekConfig extends \Google\Model
{
  /**
   * @var bool
   */
...
class_alias(GoogleCloudDiscoveryengineV1alphaCmekConfig::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaCmekConfig');
