...
class_alias(GoogleCloudDiscoveryengineV1betaPurgeSuggestionDenyListEntriesResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaPurgeSuggestionDenyListEntriesResponse');
