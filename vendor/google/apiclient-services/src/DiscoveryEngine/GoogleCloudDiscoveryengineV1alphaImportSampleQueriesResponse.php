...
class GoogleCloudDiscoveryengineV1alphaImportSampleQueriesResponse extends \Google\Collection
{
...
class_alias(GoogleCloudDiscoveryengineV1alphaImportSampleQueriesResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaImportSampleQueriesResponse');
