...
class_alias(GoogleCloudDiscoveryengineV1CompleteQueryResponseQuerySuggestion::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1CompleteQueryResponseQuerySuggestion');
