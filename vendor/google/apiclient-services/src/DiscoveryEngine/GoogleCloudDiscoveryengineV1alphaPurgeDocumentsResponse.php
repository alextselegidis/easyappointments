...
class GoogleCloudDiscoveryengineV1alphaPurgeDocumentsResponse extends \Google\Collection
{
...
class_alias(GoogleCloudDiscoveryengineV1alphaPurgeDocumentsResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaPurgeDocumentsResponse');
