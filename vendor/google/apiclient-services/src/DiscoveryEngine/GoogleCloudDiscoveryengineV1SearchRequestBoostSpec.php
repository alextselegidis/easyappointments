...
class GoogleCloudDiscoveryengineV1SearchRequestBoostSpec extends \Google\Collection
{
  ...
  /**
   * @param GoogleCloudDiscoveryengineV1SearchRequestBoostSpecConditionBoostSpec[]
   */
...
class_alias(GoogleCloudDiscoveryengineV1SearchRequestBoostSpec::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1SearchRequestBoostSpec');
