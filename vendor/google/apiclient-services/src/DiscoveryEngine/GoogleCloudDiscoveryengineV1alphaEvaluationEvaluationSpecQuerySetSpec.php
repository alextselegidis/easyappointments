...
class_alias(GoogleCloudDiscoveryengineV1alphaEvaluationEvaluationSpecQuerySetSpec::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaEvaluationEvaluationSpecQuerySetSpec');
