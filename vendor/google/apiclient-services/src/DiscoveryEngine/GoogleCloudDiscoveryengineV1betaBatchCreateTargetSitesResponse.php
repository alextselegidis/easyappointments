...
class_alias(GoogleCloudDiscoveryengineV1betaBatchCreateTargetSitesResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaBatchCreateTargetSitesResponse');
