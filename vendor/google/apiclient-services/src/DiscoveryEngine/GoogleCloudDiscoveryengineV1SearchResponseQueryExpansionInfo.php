...
class_alias(GoogleCloudDiscoveryengineV1SearchResponseQueryExpansionInfo::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1SearchResponseQueryExpansionInfo');
