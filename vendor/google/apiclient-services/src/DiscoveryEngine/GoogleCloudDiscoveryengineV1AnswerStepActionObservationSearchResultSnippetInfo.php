...
class_alias(GoogleCloudDiscoveryengineV1AnswerStepActionObservationSearchResultSnippetInfo::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1AnswerStepActionObservationSearchResultSnippetInfo');
