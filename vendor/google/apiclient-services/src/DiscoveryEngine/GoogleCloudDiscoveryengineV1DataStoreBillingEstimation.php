...
class_alias(GoogleCloudDiscoveryengineV1DataStoreBillingEstimation::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1DataStoreBillingEstimation');
