...
class GoogleCloudDiscoveryengineV1AnswerReferenceChunkInfo extends \Google\Model
{
  ...
  /**
   * @return GoogleCloudDiscoveryengineV1AnswerReferenceChunkInfoDocumentMetadata
   */
...
class_alias(GoogleCloudDiscoveryengineV1AnswerReferenceChunkInfo::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1AnswerReferenceChunkInfo');
