...
class_alias(GoogleCloudDiscoveryengineV1ImportDocumentsRequestInlineSource::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1ImportDocumentsRequestInlineSource');
