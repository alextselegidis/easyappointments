...
class GoogleCloudDiscoveryengineV1betaImportSampleQueriesResponse extends \Google\Collection
{
...
class_alias(GoogleCloudDiscoveryengineV1betaImportSampleQueriesResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaImportSampleQueriesResponse');
