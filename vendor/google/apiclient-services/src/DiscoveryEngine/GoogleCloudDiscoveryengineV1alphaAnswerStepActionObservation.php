...
class GoogleCloudDiscoveryengineV1alphaAnswerStepActionObservation extends \Google\Collection
{
  ...
  /**
   * @param GoogleCloudDiscoveryengineV1alphaAnswerStepActionObservationSearchResult[]
   */
...
class_alias(GoogleCloudDiscoveryengineV1alphaAnswerStepActionObservation::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1alphaAnswerStepActionObservation');
