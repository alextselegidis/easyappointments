...
class GoogleCloudDiscoveryengineV1ListDataStoresResponse extends \Google\Collection
{
...
class_alias(GoogleCloudDiscoveryengineV1ListDataStoresResponse::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1ListDataStoresResponse');
