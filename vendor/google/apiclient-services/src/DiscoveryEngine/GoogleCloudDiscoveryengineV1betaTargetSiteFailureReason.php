...
class GoogleCloudDiscoveryengineV1betaTargetSiteFailureReason extends \Google\Model
{
  ...
  /**
   * @param GoogleCloudDiscoveryengineV1betaTargetSiteFailureReasonQuotaFailure
   */
...
class_alias(GoogleCloudDiscoveryengineV1betaTargetSiteFailureReason::class, 'Google_Service_DiscoveryEngine_GoogleCloudDiscoveryengineV1betaTargetSiteFailureReason');
