 ...
 *   $operations = $parallelstoreService->projects_locations_operations;
 *  </code>
 */
...
class_alias(ProjectsLocationsOperations::class, 'Google_Service_Parallelstore_Resource_ProjectsLocationsOperations');
