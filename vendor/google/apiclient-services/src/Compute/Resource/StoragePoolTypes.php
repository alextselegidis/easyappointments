 ...
 *  </code>
 */
class StoragePoolTypes extends \Google\Service\Resource
{
  /**
  ...
  public function aggregatedList($project, $optParams = [])
  {
    ...
    return $this->call('aggregatedList', [$params], StoragePoolTypeAggregatedList::class);
  }
  /**
   ...
   * @throws \Google\Service\Exception
   */
  public function get($project, $zone, $storagePoolType, $optParams = [])
  {
    $params = ['project' => $project, 'zone' => $zone, 'storagePoolType' => $storagePoolType];
    $params = array_merge($params, $optParams);
    return $this->call('get', [$params], StoragePoolType::class);
  }
  /**
   ...
   * for a single zone scope either returns all resources in the zone or no
   * resources, with an error code.
   * @return StoragePoolTypeList
   * @throws \Google\Service\Exception
   */
  public function listStoragePoolTypes($project, $zone, $optParams = [])
  {
    $params = ['project' => $project, 'zone' => $zone];
    $params = array_merge($params, $optParams);
    return $this->call('list', [$params], StoragePoolTypeList::class);
  }
}

// Adding a class alias for backwards compatibility with the previous class name.
class_alias(StoragePoolTypes::class, 'Google_Service_Compute_Resource_StoragePoolTypes');
