 ...
 *  </code>
 */
class RegionZones extends \Google\Service\Resource
{
  /**
   * Retrieves the list of Zone resources under the specific region available to
   * the specified project. (regionZones.listRegionZones)
   *
...
class_alias(RegionZones::class, 'Google_Service_Compute_Resource_RegionZones');
