...
class DisksStartAsyncReplicationRequest extends \Google\Model
{
  /**
   * @var string
   */
...
class_alias(DisksStartAsyncReplicationRequest::class, 'Google_Service_Compute_DisksStartAsyncReplicationRequest');
