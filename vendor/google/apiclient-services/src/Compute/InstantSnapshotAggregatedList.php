...
class InstantSnapshotAggregatedList extends \Google\Collection
{
   ...
   */
  public $unreachables;
  protected $warningType = InstantSnapshotAggregatedListWarning::class;
...
class_alias(InstantSnapshotAggregatedList::class, 'Google_Service_Compute_InstantSnapshotAggregatedList');
