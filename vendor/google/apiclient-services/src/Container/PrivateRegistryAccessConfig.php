...
class PrivateRegistryAccessConfig extends \Google\Collection
{
  ...
  {
    $this->certificateAuthorityDomainConfig = $certificateAuthorityDomainConfig;
  }
  /**
...
class_alias(PrivateRegistryAccessConfig::class, 'Google_Service_Container_PrivateRegistryAccessConfig');
